...
## Stampa di report ed esecuzione di processi batch
...
## Modifica dell'aspetto dei documenti
...
## Utilizzo di Flow con Business Central
...
## Comunicazione con i clienti mediante Dynamics 365 for Sales
...
#### [Procedura: Importare ed esportare situazioni contabili](LocalFunctionality/Russia/How-to-Import-and-Export-Account-Schedules.md)
#### [Procedura: Definire un'estensione della situazione contabile](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Extension.md)
#### [Procedura: Definire una costante della situazione contabile](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Constant.md)
#### [Procedura: Utilizzare le situazioni contabili](LocalFunctionality/Russia/How-to-Work-with-Account-Schedules.md)
...
#### [Procedura: Impostare impiegati responsabili e dichiarazioni avanzate](LocalFunctionality/Russia/How-to-Set-Up-Responsible-Employees-and-Advance-Statements.md)
#### [Debiti e crediti](LocalFunctionality/Russia/Payables-and-Receivables.md)
### Cespiti
#### [Cespiti](LocalFunctionality/Russia/fixed-assets.md)
#### [Procedura: Calcolare l'imposta accertata](LocalFunctionality/Russia/How-to-Calculate-Assessed-Tax.md)
...
#### [Procedura: Creare giornali di registrazione spese future](LocalFunctionality/Russia/How-to-Create-Future-Expense-Journals.md)
#### [Procedura: Creare un addebito cespite](LocalFunctionality/Russia/How-to-Create-a-Fixed-Asset-Charge.md)
#### [Procedura: Creare una nota di credito per un addebito cespite](LocalFunctionality/Russia/How-to-Create-a-Credit-Memo-for-a-Fixed-Asset-Charge.md)
#### [Vendita di cespiti](LocalFunctionality/Russia/Sale-of-fixed-assets.md)
#### [Procedura: Rilasciare, tenere traccia ed eliminare cespiti](LocalFunctionality/Russia/How-to-Release-Track-Write-Off-Fixed-Assets.md)
#### [Procedura: Visualizzare movimenti registrati su un addebito cespiti](LocalFunctionality/Russia/How-to-View-Posted-Entries-on-a-Fixed-Asset-Charge.md)
#### [Procedura: Impostare un account di cespiti immateriali](LocalFunctionality/Russia/How-to-Set-Up-an-Intangible-Assets-Account.md)
#### [Procedura: Conto per il costo di cessione di un cespite](LocalFunctionality/Russia/How-to-Account-for-the-Cost-to-Dispose-a-Fixed-Asset.md) 
...
#### [Procedura: Impostare movimenti contabili IVA](LocalFunctionality/Russia/How-to-Set-Up-VAT-Ledgers.md)  
#### [Procedura: Preparare movimenti IVA per la registrazione](LocalFunctionality/Russia/How-to-Prepare-VAT-Entries-for-Posting.md)  
#### [IVA liquidazione](LocalFunctionality/Russia/Settlement-VAT.md)  
...
#### [Procedura: Impostare la contabilità fiscale](LocalFunctionality/Russia/How-to-Set-Up-Tax-Accounting.md)  
#### [Registri fiscali](LocalFunctionality/Russia/Tax-Registers.md)  
#### [Procedura: Creare registri fiscali](LocalFunctionality/Russia/How-to-Create-Tax-Registers.md)  
#### [Procedura: Impostare sezioni dei registri fiscali](LocalFunctionality/Russia/How-to-Set-Up-Tax-Register-Sections.md) #### [Differenze fiscali](LocalFunctionality/Russia/Tax-Differences.md)  
...
### Inventario
#### [Magazzino](LocalFunctionality/Russia/Inventory.md)
...
#### [Procedura: Creare il report TORG-29](LocalFunctionality/Russia/How-to-Create-the-TORG-29-Goods-Report.md)
### Risorse umane
#### [Gestione del personale](LocalFunctionality/Russia/Human-Resources.md)
...
#### [Creare e modificare Ordine elenco personale e Disposizione personale](LocalFunctionality/Russia/Forming-and-changing-Staff-List-Order-Staff-Arrangement.md)
#### [Pianificazione delle vacanze](LocalFunctionality/Russia/Vacation-planning.md)
