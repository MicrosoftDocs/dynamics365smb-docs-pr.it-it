...
## [Diventare un rivenditore di Dynamics 365 Business Central](product-sell.md)
...
### [Estensioni per Microsoft Business Central fornite da altri provider](ui-extensions-other.md)
...
## [Informazioni su ricerca e filtro in Business Central](ui-search-filter-faq.md)
## [Immissione di dati](ui-enter-data.md)
## [Notifiche smart](ui-smart-notifications.md)
...
## [Aggiungere e visualizzare note nei record](ui-work-with-notes.md)
...
#### [Impostare le procedure ottimali: metodi di riordino](reports-saving-reusing-settings.md)
#### [Impostare le procedure ottimali: Pianificazione dei parametri](setup-best-practices-planning-parameters.md)
#### [Impostare le procedure ottimali: Setup di pianificazione globale](setup-best-practices-global-planning-setup.md)
...
### [Riconciliare manualmente i pagamenti dei clienti](receivables-how-apply-sales-transactions-manually.md)
...
## [Inviare avvisi normativi](LocalFunctionality/submit-regulatory-alerts.md)
