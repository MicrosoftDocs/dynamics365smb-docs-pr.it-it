...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts"></a><a name="understanding-the-general-ledger-and-chart-of-accounts"></a>Informazioni sulla contabilità generale e sul piano dei conti
...
## <a name="general-ledger-setup-and-general-posting-setup"></a><a name="general-ledger-setup-and-general-posting-setup"></a>Setup contabilità generale e setup registrazioni COGE
...
## <a name="the-chart-of-accounts"></a><a name="the-chart-of-accounts"></a>Il piano dei conti
...
## <a name="account-categories"></a><a name="account-categories"></a>Categorie di conti
...
## <a name="get-a-quick-overview"></a><a name="get-a-quick-overview"></a>Ottenere una rapida visione d'insieme
...
## <a name="access-to-create-and-edit-accounts-and-account-categories"></a><a name="access-to-create-and-edit-accounts-and-account-categories"></a>Accesso per creare e modificare conti e categorie di conti
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/business-central-configure-general-ledger-setup/)
