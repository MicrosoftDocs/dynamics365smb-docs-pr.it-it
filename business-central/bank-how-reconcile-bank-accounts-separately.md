...
* Quando si riconciliano i pagamenti nella pagina  **Giornale di riconciliazione dei pagamenti** .
...
2. Nella pagina **Trans. ric. banc. in reg. gen.** specificare quali registrazioni COGE utilizzare, quindi scegliere **OK**.
    ...
    La pagina  **Giornali generali** si apre con nuove righe di giornale per tutte le righe dell'estratto conto bancario in cui mancano registrazioni contabili.
...
Quando esegui il report Estratto conto bancario dalla pagina  **Elenco estratti conto bancari**, puoi attivare l'opzione  **Voci in sospeso**  e il report includerà una sezione che elenca le voci in sospeso.
...
Se trovi un errore in una riconciliazione bancaria registrata, puoi utilizzare l'azione **Annulla** nella pagina **Lista dich. C/C bancari** per correggerlo. Quando si annulla una riconciliazione bancaria registrata, le voci vengono spostate nella pagina  **Riconciliazioni conti bancari** e contrassegnate come  **Aperte**, il che significa che non vengono riconciliate. Puoi quindi possibile correggere la riconciliazione bancaria e registrarla di nuovo.
...
Hai effettuato riconciliazioni bancarie per gennaio, febbraio e marzo. Il numero dell'estratto conto bancario era 100 per marzo. Successivamente, scopri che marzo include solo movimenti fino al 30, il che significa che mancano quelli del 31. Quindi, devi ripetere la riconciliazione bancaria per marzo. In questo caso, apriremo la pagina  **Elenco estratti conto bancari**, sceglieremo l'estratto conto di marzo e poi sceglieremo  **Annulla**. 
...
[Riconciliazione dei conti bancari](bank-manage-bank-accounts.md)    
...
[Applicazione automatica dei pagamenti e riconciliazione dei conti bancari](receivables-apply-payments-auto-reconcile-bank-accounts.md)    
[Impostazione dell'attività bancaria](bank-setup-banking.md)    
[Imposta regole per l'applicazione automatica dei pagamenti](receivables-how-set-up-payment-application-rules.md)    
