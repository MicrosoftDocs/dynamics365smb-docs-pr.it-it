...
ms.author: jswymer
---
# <a name="create-sales-opportunities"></a><a name="create-sales-opportunities"></a><a name="create-sales-opportunities"></a>Creare opportunità di vendita
...
## <a name="to-create-an-opportunity-from-a-salesperson"></a><a name="to-create-an-opportunity-from-a-salesperson"></a><a name="to-create-an-opportunity-from-a-salesperson"></a>Per creare un'opportunità da un agente
...
## <a name="to-create-an-opportunity-from-a-contact"></a><a name="to-create-an-opportunity-from-a-contact"></a><a name="to-create-an-opportunity-from-a-contact"></a>Per creare un'opportunità da un contatto
