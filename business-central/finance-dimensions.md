...
---
# <a name="work-with-dimensions"></a><a name="work-with-dimensions"></a>Utilizzare le dimensioni
...
## <a name="analyzing-by-dimensions"></a><a name="analyzing-by-dimensions"></a>Analisi per dimensioni
...
## <a name="setting-up-dimensions"></a><a name="setting-up-dimensions"></a>Impostazione delle dimensioni
...
### <a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts"></a><a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts"></a>Per impostare le dimensioni di default per clienti, fornitori e altri conti
...
### <a name="to-set-up-default-dimension-priorities"></a><a name="to-set-up-default-dimension-priorities"></a>Per impostare priorità nelle dimensioni di default
...
### <a name="to-set-up-dimension-combinations"></a><a name="to-set-up-dimension-combinations"></a>Per impostare combinazioni dimensioni
...
### <a name="to-set-up-global-and-shortcut-dimensions"></a><a name="to-set-up-global-and-shortcut-dimensions"></a>Per impostare dimensioni globali e a collegamento rapido
...
#### <a name="to-change-global-dimensions"></a><a name="to-change-global-dimensions"></a>Per cambiare le dimensioni globali
...
### <a name="example-of-dimension-setup"></a><a name="example-of-dimension-setup"></a>Esempio di setup dimensioni
...
## <a name="getting-an-overview-of-dimensions-used-multiple-times"></a><a name="getting-an-overview-of-dimensions-used-multiple-times"></a>Sintesi delle dimensioni utilizzate più volte
...
## <a name="use-dimensions"></a><a name="use-dimensions"></a>Usare le dimensioni
...
### <a name="to-view-global-dimensions-in-ledger-entry-pages"></a><a name="to-view-global-dimensions-in-ledger-entry-pages"></a>Per visualizzare le dimensioni globali nelle pagine dei movimenti contabili:
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/dimensions-dynamics-365-business-central/index)
