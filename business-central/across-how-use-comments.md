...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Aggiungere commenti a schede o documenti
...
## <a name="to-add-a-comments-to-an-item-card" />Per aggiungere dei commenti alla scheda articolo
