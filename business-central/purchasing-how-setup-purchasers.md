...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Impostare gli addetti agli acquisti
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Per impostare gli addetti agli acquisti
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Per assegnare gli addetti agli acquisti ai fornitori
