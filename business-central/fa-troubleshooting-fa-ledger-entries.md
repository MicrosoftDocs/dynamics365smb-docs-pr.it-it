...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension" />Estensione Risoluzione dei problemi relativi a movimenti contabili dei cespiti
...
## <a name="troubleshooting-fixed-asset-ledger-entries" />Risoluzione dei problemi relativi a movimenti contabili dei cespiti
