...
ms.author: edupont
---
# <a name="make-check-payments"></a><a name="make-check-payments"></a>Effettuare pagamenti tramite assegno
...
## <a name="to-pay-a-vendor-invoice-with-a-computer-check"></a><a name="to-pay-a-vendor-invoice-with-a-computer-check"></a>Per pagare una fattura fornitore con un assegno automatico
...
## <a name="to-cancel-printed-checks-that-are-not-posted"></a><a name="to-cancel-printed-checks-that-are-not-posted"></a>Per annullare assegni stampati che non sono registrati
...
## <a name="to-void-checks"></a><a name="to-void-checks"></a>Per annullare gli assegni
...
## <a name="to-view-a-summary-of-posted-checks"></a><a name="to-view-a-summary-of-posted-checks"></a>Per visualizzare un riepilogo degli assegni registrati
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/use-checks-dynamics-365-business-central/)
