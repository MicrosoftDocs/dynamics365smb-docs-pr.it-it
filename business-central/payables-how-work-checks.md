...
ms.author: edupont
---
# <a name="make-check-payments" />Effettuare pagamenti tramite assegno
...
## <a name="to-pay-a-vendor-invoice-with-a-computer-check" />Per pagare una fattura fornitore con un assegno automatico
...
## <a name="to-cancel-printed-checks-that-are-not-posted" />Per annullare assegni stampati che non sono registrati
...
## <a name="to-void-checks" />Per annullare gli assegni
...
## <a name="to-view-a-summary-of-posted-checks" />Per visualizzare un riepilogo degli assegni registrati
...
## <a name="see-related-microsoft-training" />Vedi il relativo [training Microsoft](/training/modules/use-checks-dynamics-365-business-central/)
