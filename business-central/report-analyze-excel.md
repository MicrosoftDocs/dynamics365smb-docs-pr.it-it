...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml" />Analisi dei dati del report con Excel e XML
...
## <a name="more-about-excel-data-only" />Maggiori informazioni su Excel (solo dati)
...
## <a name="for-administrators" />Per gli amministratori
...
## <a name="for-developers-and-advanced-users" />Per gli sviluppatori e gli utenti avanzati
