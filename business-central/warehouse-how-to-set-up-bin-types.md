...
ms.author: edupont
---
# <a name="set-up-bin-types" />Impostare i tipi di collocazioni
...
## <a name="to-set-up-the-bin-types-you-want-to-use" />Per impostare i tipi di collocazione da utilizzare
