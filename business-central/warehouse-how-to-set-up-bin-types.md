...
ms.author: edupont
---
# <a name="set-up-bin-types"></a><a name="set-up-bin-types"></a>Impostare i tipi di collocazioni
...
## <a name="to-set-up-the-bin-types-you-want-to-use"></a><a name="to-set-up-the-bin-types-you-want-to-use"></a>Per impostare i tipi di collocazione da utilizzare
