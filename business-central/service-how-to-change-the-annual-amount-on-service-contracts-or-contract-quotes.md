...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Modificare l'importo annuo dei contratti di assistenza o delle offerte di contratto
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />Per modificare l'importo annuo del contratto di assistenza o dell'offerta di contratto
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts" />Differenze di distribuzione tra gli importi annui nuovo e calcolato
...
### <a name="even-distribution" />Ripartizione livellata
...
### <a name="distribution-based-on-line-amount" />Ripartizione basata sull'importo riga
...
### <a name="distribution-based-on-profit" />Ripartizione basata sul margine
