...
## <a name="to-post-appreciation-from-the-fixed-asset-gl-journal"></a>Per registrare una rivalutazione tramite Registrazioni Cespiti in C/G
...
## <a name="to-post-other-acquisition-costs"></a>Per registrare i costi di acquisto aggiuntivi
...
### <a name="example---posting-other-acquisition-costs"></a>Esempio: registrazione di costi di acquisto aggiuntivi
