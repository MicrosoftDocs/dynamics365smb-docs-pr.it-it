...
ms.author: edupont
---
# <a name="revalue-fixed-assets" />Rivalutazione dei cespiti
...
## <a name="to-post-an-appreciation-from-the-fixed-asset-gl-journal" />Per registrare una rivalutazione tramite Registrazioni Cespiti in C/G
...
## <a name="to-post-a-write-down-from-the-fixed-asset-gl-journal" />Per registrare una svalutazione tramite Registrazioni Cespiti in C/G
...
## <a name="to-perform-general-revaluation-of-fixed-assets" />Per eseguire la rivalutazione generali dei cespiti
...
## <a name="to-post-additional-acquisition-costs" />Per registrare i costi di acquisto aggiuntivi
...
### <a name="example---posting-additional-acquisition-costs" />Esempio: registrazione di costi di acquisto aggiuntivi
...
## <a name="see-related-microsoft-trainingtrainingpathsmanage-advanced-fixed-assets-transactions" />Vedi il relativo [training Microsoft](/training/paths/manage-advanced-fixed-assets-transactions/)
