...
# <a name="set-up-unrealized-vat-for-cash-based-accounting" />Setup dell'IVA ad esigibilità differita per la contabilità basata su contanti
...
## <a name="to-use-general-ledger-accounts-for-unrealized-vat" />Per utilizzare conti C/G per l'IVA ad esigibilità differita
