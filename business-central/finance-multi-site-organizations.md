...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central per organizzazioni multisito e internazionali
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Integrazione della sede centrale e dei siti
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Soddisfare le esigenze dei siti nazionali e internazionali
...
## <a name="consolidate-financial-data" />Consolidare i dati finanziari
...
## <a name="share-business-insight-with-integrated-analytics" />Condividere le informazioni aziendali con l'analisi integrata
...
## <a name="exchange-data-using-apis-and-xmlports" />Scambiare dati utilizzando API e XMLports
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Promuovere una catena di approvvigionamento interaziendale efficiente
...
## <a name="respond-quickly-to-new-business-conditions" />Rispondere rapidamente alle nuove condizioni commerciali
