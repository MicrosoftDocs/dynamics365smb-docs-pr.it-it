...
## <a name="general-keyboard-shortcuts"></a><a name="general-keyboard-shortcuts"></a><a name="general-keyboard-shortcuts"></a><a name="Keyboard"></a> Tasti di scelta rapida generali
...
## <a name="keyboard-shortcuts-in-lists"></a><a name="keyboard-shortcuts-in-lists"></a><a name="keyboard-shortcuts-in-lists"></a>Tasti di scelta rapida negli elenchi
...
-->
### <a name="general"></a><a name="general"></a><a name="general"></a>Generale
...
### <a name="navigating-between-rows-and-columns"></a><a name="navigating-between-rows-and-columns"></a><a name="navigating-between-rows-and-columns"></a><a name="navigateshortcuts"></a>Spostarsi tra righe e colonne
...
### <a name="selecting-copying-and-pasting"></a><a name="selecting-copying-and-pasting"></a><a name="selecting-copying-and-pasting"></a><a name="CopyRows"></a>Selezionare, copiare e incollare
...
### <a name="searching-and-filtering-lists"></a><a name="searching-and-filtering-lists"></a><a name="searching-and-filtering-lists"></a><a name="KeyboardFilter"></a>Cercare e filtrare elenchi
...
## <a name="keyboard-shortcuts-in-cards-and-documents"></a><a name="keyboard-shortcuts-in-cards-and-documents"></a><a name="keyboard-shortcuts-in-cards-and-documents"></a>Tasti di scelta rapida in schede e documenti
...
## <a name="quick-entry-shortcuts-for-fields"></a><a name="quick-entry-shortcuts-for-fields"></a><a name="quick-entry-shortcuts-for-fields"></a><a name="QuickEntry"></a>Scelte rapide di Accesso rapido per campi
...
## <a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="calendarshortcuts"></a> Tasti di scelta rapida nel calendario (selezione data)
...
## <a name="keyboard-shortcuts-in-date-fields"></a><a name="keyboard-shortcuts-in-date-fields"></a><a name="keyboard-shortcuts-in-date-fields"></a>Tasti di scelta rapida nei campi Data
...
## <a name="keyboard-shortcuts-in-the-report-preview"></a><a name="keyboard-shortcuts-in-the-report-preview"></a><a name="keyboard-shortcuts-in-the-report-preview"></a><a name="reportpreviewshortcuts"></a>Tasti di scelta rapida nell'anteprima report
...
## <a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="zoomshortcuts"></a>Tasti di scelta rapida per ingrandire e ridurre
...
## <a name="keyboard-shortcuts-for-role-explorer"></a><a name="keyboard-shortcuts-for-role-explorer"></a><a name="keyboard-shortcuts-for-role-explorer"></a><a name="roleexplorer"></a>Tasti di scelta rapida per Esplora ruoli
...
## <a name="numeric-keypad-shortcuts"></a><a name="numeric-keypad-shortcuts"></a><a name="numeric-keypad-shortcuts"></a><a name="keypad"></a> Tasti di scelta rapida della tastierna numerica
...
## <a name="access-keys-for-action-bar-and-navigation-menu"></a><a name="access-keys-for-action-bar-and-navigation-menu"></a><a name="access-keys-for-action-bar-and-navigation-menu"></a>Tasti di accesso per la barra delle azioni e il menu di navigazione
