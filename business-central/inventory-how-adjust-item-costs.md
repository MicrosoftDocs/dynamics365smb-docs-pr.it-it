...
ms.author: edupont
---
# <a name="adjust-item-costs"></a><a name="adjust-item-costs"></a><a name="adjust-item-costs"></a>Rettifica costi articolo
...
## <a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a>Per rettificare i costi degli articoli manualmente
...
## <a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a>Per apportare modifiche generali nel costo diretto unitario
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Informazioni sul calcolo costo unitario
...
## <a name="unit-cost-calculation-for-purchases"></a><a name="unit-cost-calculation-for-purchases"></a><a name="unit-cost-calculation-for-purchases"></a>Calcolo del costo unitario per gli acquisti
...
### <a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a>Metodo di costing FIFO, LIFO, Specifico o Medio
...
### <a name="costing-method-standard"></a><a name="costing-method-standard"></a><a name="costing-method-standard"></a>Metodo di costing standard
...
### <a name="all-costing-methods"></a><a name="all-costing-methods"></a><a name="all-costing-methods"></a>Tutti i metodi di costing
...
## <a name="unit-cost-calculation-for-sales"></a><a name="unit-cost-calculation-for-sales"></a><a name="unit-cost-calculation-for-sales"></a>Calcolo del costo unitario per le vendite
