...
---
# <a name="design-details-planning-parameters" />Dettagli di progettazione: parametri di pianificazione
...
## <a name="define-whether-the-item-is-planned" />Definire se l'articolo è pianificato
...
## <a name="define-when-to-reorder" />Definire quando riordinare
...
## <a name="define-how-much-to-reorder" />Definire la quantità da riordinare
...
## <a name="optimize-when-and-how-much-to-reorder" />Ottimizzare il momento e la quantità di riordino
...
## <a name="modify-the-supply-orders" />Modificare gli ordini di approvvigionamento
...
## <a name="delimit-the-item" />Delimitare l'articolo
...
## <a name="use-low-level-codes-to-manage-derived-demand" />Usare codici di ultimo livello per gestire la domanda derivata
