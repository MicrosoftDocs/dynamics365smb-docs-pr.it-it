...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data" />Gestire l'archiviazione eliminando documenti o comprimendo i dati
...
## <a name="delete-documents" />Eliminare documenti.
...
## <a name="compress-data-with-date-compression" />Comprimere i dati con la compressione della data
...
## <a name="posting-compressed-entries" />Registrazione dei movimenti compressi
...
### <a name="to-run-a-date-compression" />Per eseguire una compressione data
