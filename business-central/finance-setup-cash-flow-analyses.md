...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis" />Impostazione di un'analisi di un flusso di cassa
...
## <a name="the-cash-cycle-and-income--expense-charts" />Grafici Ciclo di cassa ed Entrate e uscite
...
## <a name="set-up-the-cash-flow-chart" />Impostare il grafico Flusso di cassa
...
## <a name="set-up-cash-flow-forecasts" />Impostare le previsioni flusso di cassa
...
#### <a name="receivables" />Contabilità clienti
...
#### <a name="payables" />Contabilità fornitori
