...
# <a name="use-profile-questionnaires-to-classify-business-contacts" />Utilizzare i questionari profilo per classificare i contatti business
...
## <a name="to-add-a-profile-questionnaire" />Per aggiungere un questionario profilo
...
## <a name="to-add-questions-to-a-profile-questionnaire" />Per aggiungere domande a un questionario profilo
...
## <a name="apply-questionnaires-to-contacts" />Applicare i questionari ai contatti
...
## <a name="the-automatic-classification-of-contacts" />Classificazione automatica dei contatti
