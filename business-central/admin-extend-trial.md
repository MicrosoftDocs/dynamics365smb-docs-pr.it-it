...
# <a name="need-more-time-to-decide-whether-to-subscribe"></a><a name="need-more-time-to-decide-whether-to-subscribe"></a>Hai bisogno di più tempo per decidere se effettuare una sottoscrizione?
...
## <a name="to-extend-your-trial-period"></a><a name="to-extend-your-trial-period"></a>Per estendere il periodo di valutazione
...
## <a name="what-happens-if-my-trial-period-is-expired"></a><a name="what-happens-if-my-trial-period-is-expired"></a>Che succede se il periodo di valutazione è scaduto?
