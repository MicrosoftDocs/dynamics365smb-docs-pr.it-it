...
# <a name="need-more-time-to-decide-whether-to-subscribe" />Hai bisogno di più tempo per decidere se effettuare una sottoscrizione?
...
## <a name="to-extend-your-trial-period" />Per estendere il periodo di valutazione
...
## <a name="what-happens-if-my-trial-period-is-expired" />Che succede se il periodo di valutazione è scaduto?
