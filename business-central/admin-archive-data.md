...
# <a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a>L'estensione dell'archivio dati
...
## <a name="start-archiving-data"></a><a name="start-archiving-data"></a>Iniziare l'archiviazione dei dati
...
## <a name="storage-considerations"></a><a name="storage-considerations"></a>Considerazioni sullo stoccaggio
