...
# <a name="the-data-archive-extension" />L'estensione dell'archivio dati
...
## <a name="start-archiving-data" />Iniziare l'archiviazione dei dati
...
## <a name="storage-considerations" />Considerazioni sullo stoccaggio
