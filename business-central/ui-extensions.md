...
ms.author: edupont
---
# <a name="customizing-business-central-online-with-apps"></a><a name="customizing-business-central-online-with-apps"></a>Personalizzazione di Business Central Online con le app
...
## <a name="manage-apps"></a><a name="manage-apps"></a>Gestire le app
...
## <a name="apps-and-data-transfer"></a><a name="apps-and-data-transfer"></a>App e trasferimento dati
...
## <a name="connect-your-business"></a><a name="connect-your-business"></a>Collega l'azienda
...
## <a name="recommended-apps"></a><a name="recommended-apps"></a>App raccomandate
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/customize-dynamics-365-business-central/)
