...
ms.author: bholtorf
---
# <a name="set-up-a-sequence-of-workflow-users" />Impostare una sequenza di utenti del workflow
...
## <a name="to-set-up-a-workflow-user-group" />Per impostare un gruppo del workflow
