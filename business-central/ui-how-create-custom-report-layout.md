...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts" />(Legacy) Creare e modificare layout di report personalizzati
...
## <a name="create-a-custom-layout" />Creare un layout personalizzato
...
## <a name="a-namemodifycustomlayoutamodifying-a-custom-layout" /><a name="ModifyCustomLayout"></a>Modifica di un layout personalizzato
...
### <a name="modify-a-custom-layout" />Modificare un layout personalizzato
