...
ms.author: edupont
---
# <a name="about-cost-accounting" />Informazioni sulla contabilità industriale
...
## <a name="workflow-in-cost-accounting" />Flusso di lavoro nella contabilità industriale
...
## <a name="cost-types-cost-centers-and-cost-objects" />Tipi di costo, centri di costo e oggetti di costo
...
## <a name="cost-entries-and-cost-journals" />Movimenti di costi e registrazioni costi
...
## <a name="cost-allocations" />Allocazioni costi
...
## <a name="cost-budgets" />Budget costi
...
## <a name="cost-reporting" />Reporting dei costi
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-cost-accounting-dynamics--business-central" />Vedi il relativo [training Microsoft](/training/paths/use-cost-accounting-dynamics-365-business-central/)
