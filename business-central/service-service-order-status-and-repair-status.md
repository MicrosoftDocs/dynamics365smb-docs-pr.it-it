...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status" />Stato ordine assistenza e stato riparazione
...
## <a name="specifying-service-order-status-for-repair-status" />Indicazione dello stato dell'ordine assistenza per lo stato di riparazione
...
## <a name="assigning-priority-to-service-order-status" />Assegnazione di priorità allo stato dell'ordine assistenza
