...
ms.author: edupont
---
# <a name="enter-external-document-numbers"></a><a name="enter-external-document-numbers"></a>Immettere numeri di documento esterni
...
## <a name="to-enter-external-document-numbers-in-a-sales-order"></a><a name="to-enter-external-document-numbers-in-a-sales-order"></a>Per immettere numeri di documento esterno in un ordine di vendita
