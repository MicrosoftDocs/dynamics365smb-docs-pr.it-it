...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub" />Risoluzione dei problemi dell'hub aziendale
...
## <a name="check-errors" />Controlla errori
...
## <a name="connection-failed" />Connessione non riuscita
...
## <a name="data-does-not-refresh" />I dati non vengono aggiornati
