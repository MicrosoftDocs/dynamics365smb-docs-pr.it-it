...
ms.author: jswymer
---
# <a name="overview-of-tasks-to-close-accounting-periods"></a><a name="overview-of-tasks-to-close-accounting-periods"></a>Panoramica delle attività per la chiusura dei periodi contabili
...
## <a name="general-ledger"></a><a name="general-ledger"></a>Contabilità generale
...
## <a name="sales-and-receivables"></a><a name="sales-and-receivables"></a>Contabilità clienti
...
## <a name="purchases-and-payables"></a><a name="purchases-and-payables"></a>Contabilità fornitori
...
## <a name="fixed-assets"></a><a name="fixed-assets"></a>Cespiti
...
## <a name="intercompany"></a><a name="intercompany"></a>Interaziendale

* Elabora le transazioni Intercompany.

## <a name="calculate-and-process-sales-tax"></a><a name="calculate-and-process-sales-tax"></a>Calcolare ed elaborare l'IVA

* Completa le dichiarazioni fiscali.  

## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/close-fiscal-year-dynamics-365-business-central/)
