...
ms.author: edupont
---
# <a name="manage-many-incoming-document-records" />Gestire più record di documenti in entrata
...
## <a name="to-remove-incoming-document-records-from-the-default-view" />Per rimuovere i record del documento in entrata dalla visualizzazione predefinita
...
## <a name="to-view-all-incoming-document-records" />Per visualizzare tutti i record dei documenti in entrata
...
## <a name="to-add-incoming-document-records-to-the-default-view" />Per aggiungere i record del documento in entrata alla visualizzazione predefinita
