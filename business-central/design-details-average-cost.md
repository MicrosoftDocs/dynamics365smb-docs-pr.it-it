...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Dettagli di progettazione: costo medio
...
## <a name="setting-up-average-cost-calculation" />Impostazione del calcolo del costo medio
...
## <a name="calculating-average-cost" />Calcolo costo medio
...
### <a name="example-average-cost-period--day" />Esempio: Costo medio del periodo = Giorno
...
### <a name="example-average-cost-period--month" />Esempio: Costo medio del periodo = Mese
...
## <a name="setting-the-valuation-date" />Impostazione della data di valutazione
...
## <a name="recalculating-average-cost" />Ricalcolo costo medio
...
### <a name="example-of-recalculated-average-cost" />Esempio di costo medio ricalcolato
