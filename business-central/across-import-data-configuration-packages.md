...
ms.author: edupont
---
# <a name="import-business-data-from-other-finance-systems"></a><a name="import-business-data-from-other-finance-systems"></a>Importare dati aziendali da altri sistemi finanziari
...
## <a name="work-with-data-in-excel"></a><a name="work-with-data-in-excel"></a>Utilizzare i dati in Excel
...
## <a name="import-data-from-configuration-packages"></a><a name="import-data-from-configuration-packages"></a>Importare di dati dei pacchetti di configurazione
...
### <a name="tables-in-the-default-configuration-package"></a><a name="tables-in-the-default-configuration-package"></a>Tabelle nel pacchetto di configurazione di default
