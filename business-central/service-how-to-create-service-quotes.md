...
ms.author: edupont
---
# <a name="create-service-quotes"></a><a name="create-service-quotes"></a><a name="create-service-quotes"></a>Creare offerte di assistenza
...
## <a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a>Per creare un'offerta di assistenza
