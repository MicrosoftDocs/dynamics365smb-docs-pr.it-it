...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting" />Dettagli di progettazione: Registrazione dell'ordine di assemblaggio
...
## <a name="posting-sequence" />Sequenza di registrazione
...
## <a name="cost-adjustment" />Rettifica costo
...
### <a name="performing-the-adjustment" />Esecuzione della rettifica
...
## <a name="assembly-costs-are-always-actual" />I costi di assemblaggio sono sempre effettivi
...
### <a name="posting-dates" />Date di registrazione
