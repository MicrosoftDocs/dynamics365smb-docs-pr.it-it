...
ms.author: edupont
---
# <a name="post-transactions-directly-to-the-general-ledger" />Registrare le transazioni direttamente nella contabilità generale
...
## <a name="to-post-a-transaction-directly-to-a-general-ledger-account" />Per registrare una transazione direttamente in un conto di contabilità generale
