...
---
# <a name="monitor-job-progress-and-performance" />Monitorare lo stato di avanzamento e le prestazioni delle commesse
...
## <a name="create-a-job-wip-method" />Creare un metodo WIP commessa
...
## <a name="define-a-wip-method-for-a-job" />Definire un metodo WIP per una commessa
...
### <a name="define-a-wip-method-for-a-job-task" />Definire un metodo WIP per una commessa
...
## <a name="calculate-wip" />Calcola WIP
...
## <a name="calculate-and-post-job-completion-entries" />Calcolare e registrare i movimenti di completamento della commessa
...
## <a name="view-job-ledger-entries" />Visualizzare i movimenti contabili commesse
