...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Monitorare lo stato di avanzamento e le prestazioni delle commesse
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>Creare un metodo WIP commessa
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Definire un metodo WIP per una commessa
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Definire un metodo WIP per una commessa
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a><a name="calculate-wip"></a>Calcola WIP
...
## <a name="post-wip"></a><a name="post-wip"></a><a name="post-wip"></a>Registra WIP
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Calcolare e registrare i movimenti di completamento della commessa
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Visualizzare i movimenti contabili commesse
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Trova il relativo [training Microsoft](/training/paths/calculate-post-job-wip/)
