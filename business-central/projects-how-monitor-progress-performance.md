...
---
# <a name="monitor-project-progress-and-performance"></a>Monitorare lo stato di avanzamento e le prestazioni delle commesse
...
## <a name="create-a-project-wip-method"></a>Creare un metodo WIP commessa
...
## <a name="define-a-wip-method-for-a-project"></a>Definire un metodo WIP per una commessa
...
### <a name="define-a-wip-method-for-a-project-task"></a>Definire un metodo WIP per una commessa
...
## <a name="calculate-and-post-project-completion-entries"></a>Calcolare e registrare i movimenti di completamento della commessa
...
## <a name="view-project-ledger-entries"></a>Visualizzare i movimenti contabili commesse
