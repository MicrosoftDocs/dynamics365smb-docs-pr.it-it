...
description: Descrive come creare un metodo WIP (Work in Process) e calcolare il WIP per stimare il valore finanziario dei progetti mentre sono in corso.
author: brentholtorf
ms.author: bholtorf
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Dimmi cosa vuoi fare") Icona, immettere **Metodi WIP del progetto**, quindi selezionare il relativo collegare.  
...
4. Per rendere predefinito questo nuovo metodo, scegli l'icona a forma di ![lampadina che consente di aprire la funzionalità delle informazioni.](media/ui-search/search_small.png "Dimmi cosa vuoi fare") Icona, immettere **Impostazione progetti**, quindi scegliere il relativo collegare.  
...
3. Nella pagina  **Progetto scheda**, nel campo  **Metodo WIP** della scheda rapida  **Pubblicazione**, Seleziona un metodo WIP dall'elenco. Se è stato definito un metodo di default, è possibile selezionare un'altra opzione, se necessario.  
...
* *Da 1000* a *1299*: il WIP viene calcolato separatamente per questo gruppo di attività di progetto. Nota tuttavia che due delle attività, 1010 e 1110, sono escluse dal calcolo WIP perché il loro tipo di attività di progetto è **Registrazione**.

* *1300* fino a *1399*: il WIP viene calcolato separatamente per questo gruppo di attività di progetto.
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") Icona, immettere **Progetto Calcola WIP**, quindi selezionare il relativo collegare.  
...
3. Nella scheda rapida **Pubblicazione**, nel campo **Stato**, Seleziona **Completato**.
...
6. Nella pagina **Progetto - Calcola WIP** compilare i campi in base alle esigenze.  
     ...
     Le voci WIP del progetto create eseguendo il batch job avranno la casella di controllo  **Progetto completato** selezionata per indicare che si tratta di voci di completamento.  
7. Scegliere l'azione **Registra WIP in C/G**.
8. Nella pagina **Progetto - Registra WIP in C/G** compilare i campi come necessario.  

     Le voci del progetto WIP contabilità generale create eseguendo il progetto batch avranno la casella di controllo  **Progetto completato** selezionata per mostrare che si tratta di voci di completamento.
...
[Guida dettagliata - Calcolo del lavoro in corso per un progetto](walkthrough-calculating-work-in-process-for-a-job.md)    
