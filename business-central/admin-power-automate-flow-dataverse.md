...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes"></a><a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes"></a>Usare un flusso Power Automate per gli avvisi in caso di modifiche alle entità Dataverse
...
## <a name="import-the-flow-template"></a><a name="import-the-flow-template"></a>Importare il modello del flusso
...
## <a name="define-the-flow-trigger"></a><a name="define-the-flow-trigger"></a>Definire l'attivazione del flusso
...
## <a name="define-the-flow-condition"></a><a name="define-the-flow-condition"></a>Definire la condizione del flusso
...
## <a name="notify-business-central-about-a-change"></a><a name="notify-business-central-about-a-change"></a>Informare Business Central di una modifica
