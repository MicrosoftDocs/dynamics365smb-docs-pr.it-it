...
ms.author: bholtorf
---
# <a name="set-up-posting-groups" />Configurazione delle categorie di registrazione
...
## <a name="general-posting-groups" />Categorie di registrazione generali
...
## <a name="specific-posting-groups" />Categorie di registrazione specifiche
...
### <a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents" />Consentire categorie registrazione di clienti o fornitori sostitutivi nei documenti
...
## <a name="tax-posting-groups" />Categorie di registrazione IVA
...
## <a name="example-of-linking-posting-groups" />Esempio di collegamento di categorie di registrazione
...
## <a name="copying-posting-setup-lines" />Copia di righe di setup registrazione
...
## <a name="set-up-posting-groups-on-the-go" />Impostare le categorie di registrazione ovunque ci si trovi
...
## <a name="troubleshooting-posting-group-errors" />Risoluzione degli errori del gruppo di posting
...
## <a name="see-related-microsoft-trainingtrainingmodulesposting-groups-dynamics-365-business-central" />Vedi il relativo [training Microsoft](/training/modules/posting-groups-dynamics-365-business-central/)
