...
## <a name="access-all-fields-and-accounts-when-you-set-up-a-posting-group"></a>Accesso a tutti i campi e agli account quando imposti una categoria di registrazione
