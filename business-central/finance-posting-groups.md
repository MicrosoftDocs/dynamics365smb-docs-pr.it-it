...
ms.author: bholtorf
---
# <a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a>Configurazione delle categorie di registrazione
...
## <a name="general-posting-groups"></a><a name="general-posting-groups"></a><a name="general-posting-groups"></a>Categorie di registrazione generali
...
## <a name="specific-posting-groups"></a><a name="specific-posting-groups"></a><a name="specific-posting-groups"></a>Categorie di registrazione specifiche
...
## <a name="tax-posting-groups"></a><a name="tax-posting-groups"></a><a name="tax-posting-groups"></a>Categorie di registrazione IVA
...
## <a name="example-of-linking-posting-groups"></a><a name="example-of-linking-posting-groups"></a><a name="example-of-linking-posting-groups"></a>Esempio di collegamento di categorie di registrazione
...
## <a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a>Copia di righe di setup registrazione
...
## <a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a>Impostare le categorie di registrazione ovunque ci si trovi
...
## <a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a>Risoluzione degli errori del gruppo di posting
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/posting-groups-dynamics-365-business-central/)
