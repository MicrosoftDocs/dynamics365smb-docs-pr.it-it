...
ms.author: edupont
---
# <a name="batch-post-production-consumption" />Registrare il consumo produzione tramite processo batch
...
## <a name="to-post-consumption-for-one-or-more-production-order-lines" />Per registrare il consumo per una o più righe dell'ordine di produzione
