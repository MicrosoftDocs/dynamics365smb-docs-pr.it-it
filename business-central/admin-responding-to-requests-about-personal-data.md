...
# <a name="responding-to-requests-about-users-personal-data" />Rispondere a richieste relative a dati personali degli utenti
...
## <a name="types-of-requests" />Tipi di richieste
...
## <a name="restrict-data-processing-for-a-data-subject" />Limitazione dell'elaborazione dei dati per un oggetto dati
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Gestione delle richieste per un oggetto dati in una versione di valutazione
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Esportazione dei dati da tabelle non classificate dagli oggetti dati
...
## <a name="handling-data-about-minors" />Gestione dei dati relativi ai minori
