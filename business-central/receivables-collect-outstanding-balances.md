...
ms.author: edupont
---
# <a name="collect-outstanding-balances" />Riscuotere i saldi inevasi
...
## <a name="statements" />Estratti conto
...
### <a name="to-send-the-customer-statement-report" />Per inviare il report estratto conto cliente
...
## <a name="reminders" />Solleciti

[!INCLUDE [receivables-reminders](includes/receivables-reminders.md)]

## <a name="finance-charges" />Spese finanziarie
...
### <a name="to-create-a-finance-charge-memo-manually" />Per creare una nota di addebito di interessi manualmente
...
### <a name="to-update-finance-charge-memo-texts" />Per aggiornare i testi delle note di addebito di interessi
...
### <a name="to-issue-finance-charge-memos" />Per emettere note di addebito interessi
...
### <a name="to-cancel-an-issued-finance-charge-memo" />Per annullare una nota di addebito degli interessi emessa
...
### <a name="to-view-reminder-and-finance-charge-entries" />Per visualizzare i movimenti di sollecito e di addebito di interessi
...
## <a name="multiple-interest-rates" />Tassi d'interesse multipli
...
## <a name="see-related-microsoft-training" />Vedi il relativo [training Microsoft](/training/paths/process-financial-periodic-activities-dynamics-365-business-central/)
