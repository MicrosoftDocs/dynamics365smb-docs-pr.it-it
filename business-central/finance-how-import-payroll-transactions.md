...
ms.author: edupont
---
# <a name="importing-payroll-transactions" />Importazione delle transazioni retribuzioni
...
## <a name="to-import-a-payroll-file" />Per importare un file delle retribuzioni
