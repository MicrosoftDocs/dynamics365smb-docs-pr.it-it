...
# <a name="review-amounts-in-general-ledger-accounts"></a><a name="review-amounts-in-general-ledger-accounts"></a>Esaminare gli importi nei conti di contabilità generale
...
## <a name="set-up-accounts-for-reviews"></a><a name="set-up-accounts-for-reviews"></a>Impostare i conti per la revisione
...
## <a name="mark-entries-as-reviewed"></a><a name="mark-entries-as-reviewed"></a>Contrassegnare i movimenti come revisionati
...
## <a name="review-accounts-that-have-old-entries"></a><a name="review-accounts-that-have-old-entries"></a>Esaminare i conti con movimenti precedenti
...
## <a name="filter-entries"></a><a name="filter-entries"></a>Filtrare i movimenti
...
## <a name="analyze-entries"></a><a name="analyze-entries"></a>Analizzare i movimenti
