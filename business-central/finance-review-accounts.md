---
title: Rivedi gli account contabilità generale
...
# <a name="review-amounts-in-general-ledger-accounts"></a>Controlla gli importi nei conti contabilità generale
...
> [!TIP]
> Un modo veloce per scegliere più movimenti è tenere premuto Ctrl o Maiusc mentre selezioni. *Ctrl* consente di selezionare voci specifiche, mentre *Maiusc* seleziona tutte le voci comprese tra la prima e l'ultima voce che hai Seleziona.
...
[Comprendere contabilità generale e il piano dei conti](finance-general-ledger.md)    
