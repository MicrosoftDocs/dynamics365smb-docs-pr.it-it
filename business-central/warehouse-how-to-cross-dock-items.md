...
---
# <a name="cross-dock-items" />Sottoporre gli articoli a cross-dock
...
## <a name="cross-dock-bins-and-zones" />Zone e collocazioni cross-dock
...
## <a name="cross-dock-select-lines-for-a-receipt" />Righe cross-dock selezionate per una ricevuta
...
## <a name="about-the-put-away-worksheet-page" />Pagina Informazioni sul prospetto stoccaggi
...
## <a name="to-set-up-the-warehouse-for-cross-docking" />Per impostare la warehouse per il cross-docking
...
## <a name="to-cross-dock-items-without-viewing-the-opportunities" />Per sottoporre a cross-dock gli articoli senza visualizzare le opportunità
...
## <a name="to-cross-dock-items-after-viewing-the-opportunities" />Per sottoporre a cross-dock gli articoli dopo la visualizzazione delle opportunità
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet" />Per visualizzare gli articoli sottoposti a cross-dock in una spedizione o in un prospetto prelievi
