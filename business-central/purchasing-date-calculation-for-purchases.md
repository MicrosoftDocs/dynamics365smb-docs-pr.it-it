...
ms.author: bholtorf
---
# <a name="calculate-dates-for-purchases" />Calcolare le date per gli acquisti
...
## <a name="calculating-with-a-requested-receipt-date" />Calcolo con una data di carico richiesta
...
## <a name="calculating-without-a-requested-receipt-date" />Calcolo senza una data di carico richiesta
...
## <a name="default-values-for-lead-time-calculation" />Valori predefiniti per il calcolo del lead time
...
## <a name="see-related-microsoft-training" />Vedi il relativo [training Microsoft](/training/modules/estimate-receipt-dates-dynamics-365-business-central/)
