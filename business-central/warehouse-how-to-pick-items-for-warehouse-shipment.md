...
---
# <a name="pick-items-for-warehouse-shipment" />Prelevare articoli per la spedizione warehouse
...
## <a name="to-pick-items-for-a-warehouse-shipment" />Per prelevare articoli per una spedizione warehouse
