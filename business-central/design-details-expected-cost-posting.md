...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Dettagli di progettazione: Registrazione del costo previsto
...
## <a name="prerequisites-for-posting-expected-costs" />Prerequisiti per la registrazione dei costi previsti
