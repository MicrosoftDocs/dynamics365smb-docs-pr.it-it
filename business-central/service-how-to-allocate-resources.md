...
# <a name="allocate-resources" />Assegnare risorse
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes" />Per visualizzare una sintesi degli ordini e delle offerte di assistenza
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability" />Per assegnare una risorsa usando la disponibilità della risorsa o del gruppo di risorse
1. Scegli l'icona a forma di ![lampadina che consente di aprire la funzionalità delle informazioni.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Quadro attività**, quindi scegli il collegamento correlato.  
...
## <a name="to-allocate-a-resource-using-a-service-order" />Per assegnare una risorsa tramite un ordine di assistenza
...
## <a name="to-reallocate-resources-on-a-service-order" />Per riassegnare le risorse su un ordine di assistenza
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board" />Per riassegnare una risorsa tramite la finestra Quadro attività
...
## <a name="to-register-resource-hours" />Per registrare le ore di risorse
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order" />Per assegnare una risorsa a tutti gli articoli in assistenza in un ordine
...
## <a name="to-cancel-an-allocation" />Per eliminare un assegnazione
