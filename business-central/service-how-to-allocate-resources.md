...
# <a name="allocate-resources"></a><a name="allocate-resources"></a>Assegnare risorse
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes"></a><a name="to-see-an-overview-of-service-orders-and-service-quotes"></a>Per visualizzare una sintesi degli ordini e delle offerte di assistenza
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability"></a><a name="to-allocate-a-resource-using-resource-or-resource-group-availability"></a>Per assegnare una risorsa usando la disponibilità della risorsa o del gruppo di risorse
1. Scegli l'icona a forma di ![lampadina che consente di aprire la funzionalità delle informazioni.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Quadro attività**, quindi scegli il collegamento correlato.  
...
## <a name="to-allocate-a-resource-using-a-service-order"></a><a name="to-allocate-a-resource-using-a-service-order"></a>Per assegnare una risorsa tramite un ordine di assistenza
...
## <a name="to-reallocate-resources-on-a-service-order"></a><a name="to-reallocate-resources-on-a-service-order"></a>Per riassegnare le risorse su un ordine di assistenza
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board"></a><a name="to-reallocate-a-resource-using-the-dispatch-board"></a>Per riassegnare una risorsa tramite la finestra Quadro attività
...
## <a name="to-register-resource-hours"></a><a name="to-register-resource-hours"></a>Per registrare le ore di risorse
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order"></a><a name="to-assign-a-resource-to-all-service-items-in-an-order"></a>Per assegnare una risorsa a tutti gli articoli in assistenza in un ordine
...
## <a name="to-cancel-an-allocation"></a><a name="to-cancel-an-allocation"></a>Per eliminare un assegnazione
