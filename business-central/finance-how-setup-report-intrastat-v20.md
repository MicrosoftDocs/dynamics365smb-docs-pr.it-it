...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat"></a><a name="set-up-and-report-intrastat"></a><a name="set-up-and-report-intrastat"></a>Impostare e registrare report Intrastat
...
## <a name="required-and-optional-setups"></a><a name="required-and-optional-setups"></a><a name="required-and-optional-setups"></a>Configurazioni obbligatorie e facoltative
...
### <a name="to-set-up-intrastat-templates-and-batches"></a><a name="to-set-up-intrastat-templates-and-batches"></a><a name="to-set-up-intrastat-templates-and-batches"></a>Per impostare le definizioni e i batch di registrazioni Intrastat
...
### <a name="to-set-up-transport-methods"></a><a name="to-set-up-transport-methods"></a><a name="to-set-up-transport-methods"></a>Per impostare i metodi di trasporto
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a><a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a><a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a>Per impostare quali campi del report Intrastat sono obbligatori
...
### <a name="czechia"></a><a name="czechia"></a><a name="czechia"></a>Repubblica Ceca

In particolare per le aziende ceche, devi anche impostare codici merce e codici natura transazione.  

#### <a name="to-set-up-commodity-codes"></a><a name="to-set-up-commodity-codes"></a><a name="to-set-up-commodity-codes"></a>Per impostare i codici di voci doganali
...
#### <a name="to-set-up-transaction-nature-codes"></a><a name="to-set-up-transaction-nature-codes"></a><a name="to-set-up-transaction-nature-codes"></a>Per impostare il codici della natura delle transazioni
...
## <a name="to-report-intrastat"></a><a name="to-report-intrastat"></a><a name="to-report-intrastat"></a>Per creare un report Intrastat
...
### <a name="to-fill-in-intrastat-journals"></a><a name="to-fill-in-intrastat-journals"></a><a name="to-fill-in-intrastat-journals"></a>Per compilare le registrazioni Intrastat
...
### <a name="to-modify-intrastat-journals-lines"></a><a name="to-modify-intrastat-journals-lines"></a><a name="to-modify-intrastat-journals-lines"></a>Per modificare le righe dei giornali di registrazione Intrastat
...
### <a name="report-intrastat-on-a-form-or-a-file"></a><a name="report-intrastat-on-a-form-or-a-file"></a><a name="report-intrastat-on-a-form-or-a-file"></a>Creare report Intrastat come form o come file
...
### <a name="report-intrastat-in-a-file"></a><a name="report-intrastat-in-a-file"></a><a name="report-intrastat-in-a-file"></a>Creare un report Intrastat in un file
...
## <a name="reorganize-intrastat-journals"></a><a name="reorganize-intrastat-journals"></a><a name="reorganize-intrastat-journals"></a>Riorganizzare registrazioni Intrastat
...
## <a name="tariff-numbers"></a><a name="tariff-numbers"></a><a name="tariff-numbers"></a>Nomenclatura combinata
