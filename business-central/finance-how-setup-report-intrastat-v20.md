...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat" />Impostare e registrare report Intrastat
...
## <a name="required-and-optional-setups" />Configurazioni obbligatorie e facoltative
...
### <a name="to-set-up-intrastat-templates-and-batches" />Per impostare le definizioni e i batch di registrazioni Intrastat
...
### <a name="to-set-up-transport-methods" />Per impostare i metodi di trasporto
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory" />Per impostare quali campi del report Intrastat sono obbligatori
...
### <a name="czechia" />Repubblica Ceca

In particolare per le aziende ceche, devi anche impostare codici merce e codici natura transazione.  

#### <a name="to-set-up-commodity-codes" />Per impostare i codici di voci doganali
...
#### <a name="to-set-up-transaction-nature-codes" />Per impostare il codici della natura delle transazioni
...
## <a name="to-report-intrastat" />Per creare un report Intrastat
...
### <a name="to-fill-in-intrastat-journals" />Per compilare le registrazioni Intrastat
...
### <a name="to-modify-intrastat-journals-lines" />Per modificare le righe dei giornali di registrazione Intrastat
...
### <a name="report-intrastat-on-a-form-or-a-file" />Creare report Intrastat come form o come file
...
### <a name="report-intrastat-in-a-file" />Creare un report Intrastat in un file
...
## <a name="reorganize-intrastat-journals" />Riorganizzare registrazioni Intrastat
...
## <a name="tariff-numbers" />Nomenclatura combinata
