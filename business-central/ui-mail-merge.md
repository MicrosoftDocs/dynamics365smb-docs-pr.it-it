...
# <a name="use-word-templates-for-bulk-communication" />Utilizzare modelli Word per comunicazioni in blocco
...
## <a name="set-up-the-source-of-data" />Configurare l'origine dei dati
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity" />Aggiungere voci correlate o non correlate all'entità di origine
...
### <a name="select-the-fields-to-include" />Selezionare i campi da includere
...
## <a name="to-create-a-word-template-in-business-central" />Per creare un modello Word in Business Central
...
## <a name="set-up-the-template-in-word" />Impostare il modello in Word
...
## <a name="apply-a-template" />Collegare un modello
...
## <a name="use-word-templates-with-email" />Usare i modelli di Word con la posta elettronica
...
## <a name="edit-a-word-template" />Modificare un modello di Word
