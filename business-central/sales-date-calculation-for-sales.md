...
ms.author: edupont
---
# <a name="delivery-date-calculation-for-sales" />Calcolo della data di consegna per le vendite
...
## <a name="calculating-a-requested-delivery-date" />Calcolo di una data di consegna richiesta
...
## <a name="calculating-the-earliest-possible-delivery-date" />Calcolo della prima data utile per la consegna
