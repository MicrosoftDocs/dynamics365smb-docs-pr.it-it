...
ms.author: edupont
---
# <a name="work-with-"></a><a name="work-with-"></a><a name="work-with-"></a>Utilizzare [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="cheatsheet"></a>Suggerimenti e trucchi
...
## <a name="links-to-learn-more"></a><a name="links-to-learn-more"></a><a name="links-to-learn-more"></a>Collegamenti per ulteriori informazioni
...
## <a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a>Esplorazione di Business Central
Di seguito un breve video su come esplorare [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a>Scelta di un browser desktop
...
## <a name="action-bars"></a><a name="action-bars"></a><a name="action-bars"></a>Barre delle azioni
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/paths/work-pro-data-dynamics-365-business-central/)
