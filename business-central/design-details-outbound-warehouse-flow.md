...
### 1: Rilasciare un documento di origine
...
### 2: Creare un prelievo di magazzino

Nella pagina **Prelievo magazzino** l'addetto al warehouse recupera, in modalità pull, le righe del documento di origine. In alternativa, le righe di prelievo magazzino sono già create, in modalità push, dall'utente responsabile del documento di origine.  

### 3: Registrare un prelievo di magazzino
...
### 2: Creare una spedizione warehouse
...
### 3: Creare un prelievo warehouse
...
### 4: Registrare un prelievo warehouse
...
[Gestione warehouse](design-details-warehouse-management.md)  
