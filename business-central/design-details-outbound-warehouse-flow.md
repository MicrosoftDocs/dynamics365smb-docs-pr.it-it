...
### <a name="2-create-an-inventory-pick" />2: Creare un prelievo di magazzino
...
### <a name="3-post-an-inventory-pick" />3: Registrare un prelievo di magazzino
...
### <a name="2-create-a-warehouse-shipment" />2: Creare una spedizione warehouse
...
### <a name="3-create-a-warehouse-pick" />3: Creare un prelievo warehouse
...
### <a name="4-register-a-warehouse-pick" />4: Registrare un prelievo warehouse
...
### <a name="5-post-the-warehouse-shipment" />5: Registrare la spedizione warehouse
