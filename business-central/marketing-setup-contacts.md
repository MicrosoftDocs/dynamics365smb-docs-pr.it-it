...
ms.author: edupont
---
# <a name="set-up-contacts" />Setup contatti
...
## <a name="to-assign-industry-groups-to-a-contact" />Per assegnare settori industriali a un contatto
...
## <a name="to-assign-mailing-groups-to-a-contact" />Per assegnare gruppi di mailing a un contatto
...
## <a name="to-define-a-contacts-alternate-address" />Per definire l'indirizzo alternativo di un contatto
...
## <a name="to-assign-job-responsibilities-to-a-contact" />Per assegnare ruoli professionali a un contatto
...
## <a name="to-assign-organizational-levels-to-a-contact" />Per assegnare livelli organizzativi a un contatto
...
## <a name="to-assign-web-sources-to-a-contact" />Per assegnare origini Web a un contatto
...
## <a name="to-assign-business-relations-to-a-contact" />Per assegnare relazioni d'affari a un contatto
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons" />Copiare automaticamente informazioni specifiche da Società contatto a Persone contatto
...
## <a name="use-predefined-defaults-on-new-contacts" />Utilizzare le impostazioni predefinite nei nuovi contatti
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts" />Sincronizzazione di contatti con clienti, fornitori e conti correnti bancari
...
## <a name="searching-for-duplicate-contacts" />Ricerca di contatti duplicati
