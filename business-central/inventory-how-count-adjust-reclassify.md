...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals" />Conteggio, rettifica e riclassificazione dell'inventario utilizzando registrazioni
...
## <a name="to-count-physical-inventory" />Per contare l'inventario fisico
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations" />Per calcolare le giacenze previste nelle configurazioni warehouse di base
...
### <a name="to-print-the-report-to-be-used-when-counting" />Per stampare il report da utilizzare nel conteggio
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations" />Per immettere e registrare le giacenze effettive conteggiate nelle configurazioni di warehouse di base
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations" />Per calcolare le giacenze previste nelle configurazioni di warehouse avanzate
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations" />Per immettere e registrare le giacenze effettive conteggiate nelle configurazioni di warehouse avanzate
...
## <a name="to-do-cycle-counting" />Per eseguire un conteggio ciclico
...
### <a name="to-set-up-counting-periods" />Per impostare i periodi di conteggio
...
### <a name="to-assign-a-counting-period-to-an-item" />Per assegnare un periodo di conteggio a un articolo
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations" />Per iniziare un conteggio basato sui periodi di conteggio nelle configurazioni warehouse di base
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations" />Per iniziare un conteggio basato sui periodi di conteggio nelle configurazioni warehouse avanzate
...
## <a name="to-adjust-the-quantity-of-one-item" />Per rettificare la quantità di un articolo
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations" />Per rettificare le quantità di più articoli nelle configurazioni warehouse di base
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations" />Per rettificare le quantità di collocazioni nelle configurazioni di warehouse avanzate
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries" />Per sincronizzare i movimenti warehouse rettificati con i movimenti contabili articoli correlati
