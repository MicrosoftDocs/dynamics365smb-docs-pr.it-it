---
title: Pagamenti anticipati corretti
...
# <a name="correct-prepayments"></a>Pagamenti anticipati corretti

È possibile apportare una correzione a un ordine dopo aver registrato una fattura pagamento anticipato per l'ordine stesso. È possibile aggiungere nuove righe a un ordine dopo aver emesso un pagamento anticipato e quindi registrare un'altra fattura di pagamento anticipato, ma non è possibile eliminare una riga da un ordine dopo che è stato fatturato un pagamento anticipato per la riga.  
