...
---
# <a name="archive-documents" />Archiviare documenti
...
## <a name="to-set-up-automatic-document-archiving" />Per impostare l'archiviazione automatica dei documenti
...
## <a name="to-manually-archive-a-sales-order" />Per archiviare manualmente un ordine di vendita
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive" />Per ripristinare un ordine di vendita non registrato dall'archivio
...
## <a name="to-delete-archived-sales-orders" />Per eliminare ordini di vendita archiviati
