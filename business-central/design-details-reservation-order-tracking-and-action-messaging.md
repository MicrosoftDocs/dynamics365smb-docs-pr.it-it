...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a>Dettagli di progettazione: Impegno, tracciabilità dell'ordine e messaggistica di azioni
...
## <a name="reservation"></a><a name="reservation"></a>Impegno
...
### <a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a>Compensazione negli impegni
...
### <a name="manual-reservation"></a><a name="manual-reservation"></a>Prenotazione manuale
...
### <a name="automatic-reservations"></a><a name="automatic-reservations"></a>Prenotazioni automatiche
...
## <a name="order-tracking"></a><a name="order-tracking"></a>Tracciabilità ordine
...
### <a name="the-order-network"></a><a name="the-order-network"></a>Rete di ordini
...
### <a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a>Compensazione nella tracciabilità ordine
...
### <a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a>Esempio: Tracciabilità ordine nelle vendite, nella produzione e nei trasferimenti
...
### <a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a>Numeri di movimento 8 e 9
...
### <a name="entry-numbers-10"></a><a name="entry-numbers-10"></a>Numeri di movimento 10
...
### <a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a>Numeri di movimento 8 e 9
...
### <a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a>Numeri di movimento da 12 a 16
...
### <a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a>Numeri di movimento 21 e 22
...
## <a name="action-messaging"></a><a name="action-messaging"></a>Messaggistica di azione
...
## <a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a>Tracciabilità e pianificazione ordini
...
### <a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a>Sistema di pianificazione contro tracciabilità ordini e messaggistica di azione
