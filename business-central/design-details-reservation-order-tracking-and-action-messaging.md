...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging" />Dettagli di progettazione: Impegno, tracciabilità dell'ordine e messaggistica di azioni
...
### <a name="offsetting-in-reservations" />Compensazione negli impegni
...
### <a name="manual-reservation" />Prenotazione manuale
...
### <a name="automatic-reservations" />Prenotazioni automatiche
...
## <a name="order-tracking" />Tracciabilità ordine
...
### <a name="the-order-network" />Rete di ordini
...
### <a name="offsetting-in-order-tracking" />Compensazione nella tracciabilità ordine
...
### <a name="example-order-tracking-in-sales-production-and-transfers" />Esempio: Tracciabilità ordine nelle vendite, nella produzione e nei trasferimenti
...
### <a name="entry-numbers--and-" />Numeri di movimento 8 e 9
...
### <a name="entry-numbers-" />Numeri di movimento 10
...
### <a name="entry-numbers--to-" />Numeri di movimento da 12 a 16
...
### <a name="entry-numbers--and-" />Numeri di movimento 21 e 22
...
## <a name="action-messaging" />Messaggistica di azione
...
## <a name="order-tracking-and-planning" />Tracciabilità e pianificazione ordini
...
### <a name="planning-system-versus-order-tracking-and-action-messaging" />Sistema di pianificazione contro tracciabilità ordini e messaggistica di azione
