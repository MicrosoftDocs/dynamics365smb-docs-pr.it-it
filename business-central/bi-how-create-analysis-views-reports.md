...
ms.author: edupont
---
# <a name="create-analysis-reports"></a><a name="create-analysis-reports"></a>Creare report di analisi
...
## <a name="setting-up-line-and-column-layouts"></a><a name="setting-up-line-and-column-layouts"></a>Impostazione dei layout di riga e di colonna
...
## <a name="set-up-analysis-column-templates"></a><a name="set-up-analysis-column-templates"></a>Impostare modelli colonne analisi
...
## <a name="set-up-analysis-line-templates"></a><a name="set-up-analysis-line-templates"></a>Impostare modelli di righe di analisi
...
## <a name="create-a-new-sales-analysis-report"></a><a name="create-a-new-sales-analysis-report"></a>Creare un nuovo report di analisi delle vendite
