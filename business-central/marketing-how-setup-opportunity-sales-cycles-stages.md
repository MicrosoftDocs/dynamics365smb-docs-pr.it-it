...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages" />Impostare cicli e fasi di vendita dalle opportunità
...
## <a name="to-set-up-opportunity-sales-cycle-codes" />Per impostare codici ciclo di vendita delle opportunità
...
## <a name="to-define-opportunity-sales-cycle-stages" />Per definire le fasi ciclo di vendita delle opportunità
...
## <a name="to-assign-stage-cycles-to-opportunities" />Per assegnare cicli della fase alle opportunità
...
## <a name="to-set-up-activities-with-tasks" />Per impostare attività con task
...
## <a name="to-assign-tasks-or-activities-of-tasks-to-opportunities" />Per assegnare task o attività di task a opportunità
