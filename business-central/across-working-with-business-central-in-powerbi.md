...
ms.author: jswymer
---
# <a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a>Utilizzare i dati di [!INCLUDE [prod_short](includes/prod_short.md)] in Power BI
...
## <a name="get-the-latest-data"></a><a name="get-the-latest-data"></a>Ottenere i dati più recenti
...
### <a name="refresh-manually"></a><a name="refresh-manually"></a>Aggiornare manualmente
...
### <a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a>Pianificare un aggiornamento
...
## <a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload"></a>Caricare report da file
...
## <a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share"></a>Condividere i report con altri
