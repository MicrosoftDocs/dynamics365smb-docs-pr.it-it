...
ms.author: edupont
---
# <a name="create-service-orders" />Creare ordini di assistenza
...
## <a name="to-create-a-service-order" />Per creare un ordine di assistenza
...
## <a name="to-create-a-service-order-from-a-contract" />Per creare un ordine di assistenza da un contratto
...
## <a name="to-convert-a-service-quote-to-a-service-order" />Per convertire un'offerta di assistenza in un ordine di assistenza
...
## <a name="to-check-item-availability-for-one-or-more-orders" />Per verificare la disponibilità di un articolo per uno o più ordini
...
## <a name="to-reserve-an-item-for-a-service-order" />Per impegnare un articolo per un ordine di assistenza
...
## <a name="to-insert-lines-based-on-standard-service-codes" />Per inserire righe in base a codici di assistenza standard
...
## <a name="to-register-internal-or-public-comments" />Per registrare i commenti interni o pubblici
...
## <a name="to-delete-invoiced-service-orders" />Per eliminare ordini di assistenza fatturati
