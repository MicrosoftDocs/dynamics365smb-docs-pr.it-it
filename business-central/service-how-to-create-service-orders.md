...
ms.author: edupont
---
# <a name="create-service-orders"></a><a name="create-service-orders"></a>Creare ordini di assistenza
...
## <a name="to-create-a-service-order"></a><a name="to-create-a-service-order"></a>Per creare un ordine di assistenza
...
## <a name="to-create-a-service-order-from-a-contract"></a><a name="to-create-a-service-order-from-a-contract"></a>Per creare un ordine di assistenza da un contratto
...
## <a name="to-convert-a-service-quote-to-a-service-order"></a><a name="to-convert-a-service-quote-to-a-service-order"></a>Per convertire un'offerta di assistenza in un ordine di assistenza
...
## <a name="to-check-item-availability-for-one-or-more-orders"></a><a name="to-check-item-availability-for-one-or-more-orders"></a>Per verificare la disponibilità di un articolo per uno o più ordini
...
## <a name="to-reserve-an-item-for-a-service-order"></a><a name="to-reserve-an-item-for-a-service-order"></a>Per impegnare un articolo per un ordine di assistenza
...
## <a name="to-insert-lines-based-on-standard-service-codes"></a><a name="to-insert-lines-based-on-standard-service-codes"></a>Per inserire righe in base a codici di assistenza standard
...
## <a name="to-register-internal-or-public-comments"></a><a name="to-register-internal-or-public-comments"></a>Per registrare i commenti interni o pubblici
...
## <a name="to-delete-invoiced-service-orders"></a><a name="to-delete-invoiced-service-orders"></a>Per eliminare ordini di assistenza fatturati
