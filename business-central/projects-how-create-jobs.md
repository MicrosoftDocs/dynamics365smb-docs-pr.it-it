...
ms.author: edupont
---
# <a name="create-jobs"></a><a name="create-jobs"></a>Creare commesse
...
## <a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a>Per creare una scheda commessa
...
## <a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a>Per creare i task di una commessa
...
## <a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a>Per creare le righe di pianificazione per una commessa
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/create-new-job/)
