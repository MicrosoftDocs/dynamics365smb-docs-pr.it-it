...
# <a name="business-central-and-onedrive-for-business-integration" />Business Central e OneDrive per l'integrazione del business
...
## <a name="get-started-with-onedrive-features" />Introduzione alle funzionalità di OneDrive
...
### <a name="open-and-share-in-onedrive" />Aprire e condividere in OneDrive
...
### <a name="save-excel-workbooks-and-report-files-in-onedrive" />Salvare le cartelle di lavoro di Excel e i file di report in OneDrive
