...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a>Ricerca, filtro e ordinamento
...
## <a name="sorting"></a><a name="sorting"></a>Ordinamento
...
## <a name="searching"></a><a name="searching"></a>Ricerca
...
### <a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a>Perfezionamento della ricerca con criteri di filtro
...
## <a name="filtering"></a><a name="filtering"></a><a name="filtering"></a>Filtro
...
### <a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a>Filtro con campi di tipo opzione
...
### <a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a>Impostazione di filtri negli elenchi
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a>Impostazione di filtri in report, processi batch e XMLport
...
## <a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a>Immissione di criteri di filtro
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Criteri e operatori di filtro
...
#### <a name="-interval"></a><a name="-interval"></a>(..) Intervallo
...
#### <a name="124-eitheror"></a><a name="124-eitheror"></a>(&#124;) Oppure

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`1200|1300`|Numeri con 1200 o 1300|  

#### <a name="-not-equal-to"></a><a name="-not-equal-to"></a>(<>) Diverso da
...
#### <a name="-greater-than"></a><a name="-greater-than"></a>(>) Maggiore di

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`>1200`|Numeri maggiori di 1200|  

#### <a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a>(>=) Maggiore di o uguale a

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`>=1200`|Numeri maggiori o uguali a 1200|  

#### <a name="-less-than"></a><a name="-less-than"></a>(<) Minore di

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`<1200`|Numeri minori di 1200|  

#### <a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a>(<=) Minore di o uguale a

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`<=1200`|Numeri minori o uguali a 1200|  

#### <a name="-and"></a><a name="-and"></a>(&) E

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`>200&<1200`|Numeri maggiori di 200 e minori di 1200.|  

#### <a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a>('') Una corrispondenza esatta di carattere
...
#### <a name="-case-insensitive"></a><a name="-case-insensitive"></a>(@) Senza distinzione tra maiuscole e minuscole

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`@man*`|Testo che inizia con **man** e senza distinzione tra maiuscole e minuscole.|  

#### <a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a>(*) Un numero indefinito di caratteri non noti
...
#### <a name="-one-unknown-character"></a><a name="-one-unknown-character"></a>(?) Un carattere non noto

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`Hans?n`|Testo come **Marco** o **Mario**|  

#### <a name="combined-format-expressions"></a><a name="combined-format-expressions"></a>Espressioni di formato combinate
...
### <a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="symbols"></a>Filtrare in base a valori che contengono simboli
...
### <a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="FilterTokens"> </a>Token di filtro
...
#### <a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a>(%me or %userid) Record assegnati all'utente
...
#### <a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a>(%mycustomers) clienti in Clienti personali
...
#### <a name="myitems-items-in-my-items"></a><a name="myitems-items-in-my-items"></a>(%myitems) Articoli in Articoli personali
...
#### <a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a>(%myvendors) Fornitori in Fornitori personali
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/search-filter-sort-data-dynamics-365-business-central/)
