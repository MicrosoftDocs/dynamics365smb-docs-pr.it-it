...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering" />Ricerca, filtro e ordinamento
...
### <a name="fine-tuning-the-search-with-filter-criteria" />Perfezionamento della ricerca con criteri di filtro
...
### <a name="filtering-with-option-fields" />Filtro con campi di tipo opzione
...
### <a name="setting-filters-on-lists" />Impostazione di filtri negli elenchi
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports" />Impostazione di filtri in report, processi batch e XMLport
...
## <a name="entering-filter-criteria" />Immissione di criteri di filtro
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators" /><a name="FilterCriteria"> </a>Criteri e operatori di filtro
...
#### <a name="-not-equal-to" />(<>) Diverso da
...
#### <a name="-greater-than" />(>) Maggiore di

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`>1200`|Numeri maggiori di 1200|  

#### <a name="-greater-than-or-equal-to" />(>=) Maggiore di o uguale a

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`>=1200`|Numeri maggiori o uguali a 1200|  

#### <a name="-less-than" />(<) Minore di

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`<1200`|Numeri minori di 1200|  

#### <a name="-less-than-or-equal-to" />(<=) Minore di o uguale a
...
#### <a name="-an-exact-character-match" />('') Una corrispondenza esatta di carattere
...
#### <a name="-case-insensitive" />(@) Senza distinzione tra maiuscole e minuscole

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`@man*`|Testo che inizia con **man** e senza distinzione tra maiuscole e minuscole.|  

#### <a name="-an-indefinite-number-of-unknown-characters" />(*) Un numero indefinito di caratteri non noti
...
#### <a name="-one-unknown-character" />(?) Un carattere non noto

|espressione di esempio|Record visualizzati|  
|-----------------------|-----------------------|  
|`Hans?n`|Testo come **Marco** o **Mario**|  

#### <a name="combined-format-expressions" />Espressioni di formato combinate
...
### <a name="a-namefiltertokens-afilter-tokens" /><a name="FilterTokens"> </a>Token di filtro
...
#### <a name="me-or-userid-records-assigned-to-you" />(%me or %userid) Record assegnati all'utente
...
#### <a name="mycustomers-customers-in-my-customers" />(%mycustomers) clienti in Clienti personali
...
#### <a name="myitems-items-in-my-items" />(%myitems) Articoli in Articoli personali
...
#### <a name="myvendors-vendors-in-my-vendors" />(%myvendors) Fornitori in Fornitori personali
