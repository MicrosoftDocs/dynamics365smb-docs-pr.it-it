...
ms.author: edupont
---
# <a name="set-up-incoming-documents"></a><a name="set-up-incoming-documents"></a>Impostare documenti in entrata
...
## <a name="to-set-up-the-incoming-documents-feature"></a><a name="to-set-up-the-incoming-documents-feature"></a>Per impostare la funzione Documenti in entrata
...
## <a name="to-set-up-approvers-of-incoming-document-records"></a><a name="to-set-up-approvers-of-incoming-document-records"></a>Per impostare i responsabili dell'approvazione dei record di documenti in entrata
...
## <a name="to-set-up-an-ocr-service"></a><a name="to-set-up-an-ocr-service"></a>Per impostare un servizio OCR
