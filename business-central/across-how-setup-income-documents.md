...
ms.author: edupont
---
# <a name="set-up-incoming-documents" />Impostare documenti in entrata
...
## <a name="to-set-up-the-incoming-documents-feature" />Per impostare la funzione Documenti in entrata
...
## <a name="to-set-up-approvers-of-incoming-document-records" />Per impostare i responsabili dell'approvazione dei record di documenti in entrata
...
## <a name="to-set-up-an-ocr-service" />Per impostare un servizio OCR
