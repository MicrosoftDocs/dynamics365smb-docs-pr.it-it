...
ms.author: edupont
---
# <a name="set-up-cash-customers" />Impostare i clienti per vendite in contanti
...
## <a name="to-set-up-a-cash-customer" />Per impostare un cliente per vendite in contanti
