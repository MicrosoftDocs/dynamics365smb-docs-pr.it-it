...
ms.author: bholtorf
---
# <a name="specify-when-and-how-to-receive-workflow-notifications"></a><a name="specify-when-and-how-to-receive-workflow-notifications"></a>Specificare come e quando ricevere le notifiche del flusso di lavoro
...
## <a name="steps-in-workflows"></a><a name="steps-in-workflows"></a>Passaggi nei flussi di lavoro
...
## <a name="specify-when-and-how-approval-users-receive-notifications"></a><a name="specify-when-and-how-approval-users-receive-notifications"></a>Specificare come e quando gli utenti per l'approvazione ricevono le notifiche
...
## <a name="change-when-and-how-you-receive-notifications"></a><a name="change-when-and-how-you-receive-notifications"></a>Modificare come e quando si ricevono le notifiche
