...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Metodi ammortamento per cespiti
...
## <a name="straight-line-depreciation" />Ammortamento a quote costanti
...
### <a name="depreciation-period" />Periodo di ammortamento
...
### <a name="fixed-yearly-percentage" />Percentuale annuale fissa
...
### <a name="fixed-yearly-amount" />Importo annuale fisso
...
### <a name="example---straight-line-depreciation" />Esempio: ammortamento a quote costanti
...
## <a name="half-year-convention-depreciation" />Ammortamento di convenzione semestrale
...
### <a name="example---half-year-convention-depreciation" />Esempio: ammortamento di convenzione semestrale
...
## <a name="duplicating-entries-to-more-depreciation-books" />Duplicazione di movimenti in più registri beni ammortizzabili
