...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets"></a><a name="depreciation-methods-for-fixed-assets"></a>Metodi ammortamento per cespiti
...
## <a name="straight-line-depreciation"></a><a name="straight-line-depreciation"></a>Ammortamento a quote costanti
...
### <a name="depreciation-period"></a><a name="depreciation-period"></a>Periodo di ammortamento
...
### <a name="fixed-yearly-percentage"></a><a name="fixed-yearly-percentage"></a>Percentuale annuale fissa
...
### <a name="fixed-yearly-amount"></a><a name="fixed-yearly-amount"></a>Importo annuale fisso
...
### <a name="example---straight-line-depreciation"></a><a name="example---straight-line-depreciation"></a>Esempio: ammortamento a quote costanti
...
## <a name="declining-balance-1-depreciation"></a><a name="declining-balance-1-depreciation"></a>Metodo di ammortamento a quote decrescenti 1
...
### <a name="example---declining-balance-1-depreciation"></a><a name="example---declining-balance-1-depreciation"></a>Esempio: metodo di ammortamento a quote decrescenti 1
...
## <a name="declining-balance-2-depreciation"></a><a name="declining-balance-2-depreciation"></a>Metodo di ammortamento a quote decrescenti 2
...
### <a name="example---declining-balance-2-depreciation"></a><a name="example---declining-balance-2-depreciation"></a>Esempio: metodo di ammortamento a quote decrescenti 2
...
## <a name="db1sl-depreciation"></a><a name="db1sl-depreciation"></a>Ammortamento Decr. 1/Cost.
...
### <a name="example---db1-sl-depreciation"></a><a name="example---db1-sl-depreciation"></a>Esempio: ammortamento Decrescente 1-Quote Costanti
...
## <a name="half-year-convention-depreciation"></a><a name="half-year-convention-depreciation"></a>Ammortamento di convenzione semestrale
...
### <a name="example---half-year-convention-depreciation"></a><a name="example---half-year-convention-depreciation"></a>Esempio: ammortamento di convenzione semestrale
...
## <a name="example---db1sl-depreciation-using-half-year-convention"></a><a name="example---db1sl-depreciation-using-half-year-convention"></a>Esempio: ammortamento Decrescente 1/Quote Costanti utilizzando il metodo di convenzione semestrale
...
## <a name="duplicating-entries-to-more-depreciation-books"></a><a name="duplicating-entries-to-more-depreciation-books"></a>Duplicazione di movimenti in più registri beni ammortizzabili
