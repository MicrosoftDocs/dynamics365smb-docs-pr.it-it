...
ms.author: edupont
---
# <a name="restrict-and-allow-usage-of-a-record" />Limitare e consentire l'utilizzo di un record
...
## <a name="create-a-workflow-step-that-restricts-posting-of-unapproved-purchase-orders" />Creare una fase del flusso di lavoro che limiti la registrazione degli ordini di acquisto non approvati
