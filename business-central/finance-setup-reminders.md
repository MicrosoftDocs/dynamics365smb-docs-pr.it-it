...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a>Impostare i termini e i livelli di sollecito
...
## <a name="reminder-terms"></a><a name="reminder-terms"></a><a name="reminder-terms"></a>Termini di sollecito
...
### <a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a>Per impostare i termini di sollecito
...
## <a name="reminder-levels"></a><a name="reminder-levels"></a><a name="reminder-levels"></a>Livelli di sollecito
...
### <a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a>Per impostare i livelli di sollecito
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/send-reminders-dynamics-365-business-central/)
