...
---
# <a name="use-job-queues-to-schedule-tasks"></a><a name="use-job-queues-to-schedule-tasks"></a><a name="use-job-queues-to-schedule-tasks"></a>Utilizzare le code processi per programmare i task
...
## <a name="monitor-status-or-errors-in-the-job-queue"></a><a name="monitor-status-or-errors-in-the-job-queue"></a><a name="monitor-status-or-errors-in-the-job-queue"></a>Monitorare lo stato o gli errori nella coda processi
...
### <a name="to-view-status-for-any-job"></a><a name="to-view-status-for-any-job"></a><a name="to-view-status-for-any-job"></a>Per visualizzare lo stato di qualsiasi processo
...
## <a name="view-scheduled-tasks"></a><a name="view-scheduled-tasks"></a><a name="view-scheduled-tasks"></a>Visualizza i compiti programmati
...
## <a name="the-my-job-queue-part"></a><a name="the-my-job-queue-part"></a><a name="the-my-job-queue-part"></a>Parte Coda processi
...
### <a name="to-view-an-error-from-the-my-job-queue-part"></a><a name="to-view-an-error-from-the-my-job-queue-part"></a><a name="to-view-an-error-from-the-my-job-queue-part"></a>Per visualizzare un errore dalla parte Coda processi
...
## <a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a><a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a><a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a>Esempi di cosa puoi programmare utilizzando i movimenti coda processi

### <a name="schedule-reports"></a><a name="schedule-reports"></a><a name="schedule-reports"></a>Programmare report
...
### <a name="schedule-synchronization-between--and-includeprod_short"></a><a name="schedule-synchronization-between--and-includeprod_short"></a><a name="schedule-synchronization-between--and-includeprod_short"></a>Programmare la sincronizzazione tra [!INCLUDE[prod_short](includes/prod_short.md)] e [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
### <a name="schedule-when-to-post-sales-and-purchase-orders"></a><a name="schedule-when-to-post-sales-and-purchase-orders"></a><a name="schedule-when-to-post-sales-and-purchase-orders"></a>Programmare la registrazione delle vendite e degli ordini acquisto
...
## <a name="handle-job-queue-entry-issues"></a><a name="handle-job-queue-entry-issues"></a><a name="handle-job-queue-entry-issues"></a>Gestire i problemi dei movimenti coda processi
...
## <a name="monitor-the-job-queue-with-telemetry"></a><a name="monitor-the-job-queue-with-telemetry"></a><a name="monitor-the-job-queue-with-telemetry"></a>Monitorare la coda processi con la telemetria
