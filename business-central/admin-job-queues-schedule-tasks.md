...
---
# <a name="use-job-queues-to-schedule-tasks" />Utilizzare le code processi per programmare i task
...
## <a name="monitor-status-or-errors-in-the-job-queue" />Monitorare lo stato o gli errori nella coda processi
...
### <a name="to-view-status-for-any-job" />Per visualizzare lo stato di qualsiasi processo
...
## <a name="view-scheduled-tasks" />Visualizza i compiti programmati
...
## <a name="the-my-job-queue-part" />Parte Coda processi
...
### <a name="to-view-an-error-from-the-my-job-queue-part" />Per visualizzare un errore dalla parte Coda processi
...
## <a name="examples-of-what-you-can-schedule-using-job-queue-entries" />Esempi di cosa puoi programmare utilizzando i movimenti coda processi

### <a name="schedule-reports" />Programmare report
...
### <a name="schedule-when-to-post-sales-and-purchase-orders" />Programmare la registrazione delle vendite e degli ordini acquisto
...
## <a name="handle-job-queue-entry-issues" />Gestire i problemi dei movimenti coda processi
...
## <a name="monitor-the-job-queue-with-telemetry" />Monitorare la coda processi con la telemetria
