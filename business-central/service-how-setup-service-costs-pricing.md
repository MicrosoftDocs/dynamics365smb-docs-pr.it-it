...
# <a name="set-up-pricing-and-additional-costs-for-services" />Impostare prezzi e costi aggiuntivi per i servizi assistenza
...
## <a name="to-set-up-a-service-price-group" />Per impostare un gruppo di prezzi in assistenza
...
## <a name="to-set-up-a-service-price-adjustment-group" />Per impostare un gruppo di rettifica dei prezzi di assistenza
...
## <a name="to-set-up-additional-costs-for-services" />Per impostare costi aggiuntivi per i servizi assistenza
...
### <a name="to-set-up-service-costs" />Per impostare i costi di assistenza
...
### <a name="to-specify-a-default-cost-for-service-orders" />Per specificare un costo di default per gli ordini di assistenza
