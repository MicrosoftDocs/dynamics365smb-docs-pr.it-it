...
# <a name="design-details-change-the-costing-method-for-items" />Dettagli di progettazione: modifica dei metodi di costing per gli articoli
...
## <a name="about-costing-methods" />Informazioni sui metodi di costing
...
## <a name="use-assembly-orders-to-change-costing-method-assignments" />Utilizzare gli ordini di assemblaggio per modificare le assegnazioni del metodo di costing
...
### <a name="define-a-default-costing-method" />Definire il metodo di costing di default
...
### <a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them" />Identificare gli articoli per cui modificare il metodo di costing e rinumerarli
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch" />Creare nuovi articoli con il vecchio schema di numerazione e copiare l'anagrafica in un batch
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item" />Copiare manualmente l'anagrafica correlata dall'articolo originale al nuovo articolo
...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item" />Determinare la quantità di inventario da convertire dall'articolo originale al nuovo articolo
...
### <a name="transfer-the-inventory-to-the-new-item" />Trasferire l'inventario al nuovo articolo
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand" />Gestire le quantità di inventario assegnate alla domanda
...
### <a name="block-the-original-item-from-further-use" />Bloccare l'articolo originale da ulteriore utilizzo
