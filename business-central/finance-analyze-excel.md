...
ms.author: edupont
---
# <a name="analyzing-financial-statements-in-microsoft-excel"></a><a name="analyzing-financial-statements-in-microsoft-excel"></a>Analisi dei rendiconti finanziari in Microsoft Excel
...
## <a name="getting-the-overview-and-the-details-in-excel"></a><a name="getting-the-overview-and-the-details-in-excel"></a>Visualizzazione di una panoramica e dei dettagli in Excel
...
### <a name="understanding-the-excel-templates"></a><a name="understanding-the-excel-templates"></a>Comprendere i modelli di Excel
...
## <a name="the--excel-add-in"></a><a name="the--excel-add-in"></a>Componente aggiuntivo per Excel [!INCLUDE [prod_short](includes/prod_short.md)]
