...
# <a name="integrating-with-microsoft-dataverse" />Integrazione con Microsoft Dataverse
...
## <a name="bi-directional-or-uni-directional-data-synchronization" />Sincronizzazione dei dati bidirezionale o unidirezionale
...
## <a name="standard-and-custom-entities" />Entità standard e personalizzate
...
## <a name="about-the-business-central-base-integration-solution" />Informazioni sulla soluzione di integrazione di base di Business Central
