...
ms.author: edupont
---
# <a name="use-time-sheets"></a><a name="use-time-sheets"></a>Usare i fogli presenze
...
## <a name="to-create-time-sheets"></a><a name="to-create-time-sheets"></a>Per creare fogli di presenza
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets"></a><a name="to-reuse-time-sheet-lines-in-other-time-sheets"></a>Per riutilizzare le righe del foglio presenze in altri fogli presenze
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet"></a><a name="to-copy-job-planning-lines-to-a-time-sheet"></a>Per copiare le righe pianificazione commessa in un foglio presenze
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet"></a><a name="to-define-work-types-and-add-one-to-a-time-sheet"></a>Per definire i tipi di lavoro e aggiungerne uno a un foglio presenze
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval"></a><a name="to-fill-in-time-sheet-lines-and-submit-for-approval"></a>Per compilare le righe di un foglio presenze e inviarle per l'approvazione
...
## <a name="to-approve-or-reject-a-time-sheet"></a><a name="to-approve-or-reject-a-time-sheet"></a>Per approvare o rifiutare un foglio presenze
...
## <a name="to-reopen-a-time-sheet"></a><a name="to-reopen-a-time-sheet"></a>Per riaprire un foglio presenze
...
## <a name="to-view-and-approve-time-sheets-by-job"></a><a name="to-view-and-approve-time-sheets-by-job"></a>Per visualizzare e approvare fogli presenze in base alla commessa
...
### <a name="to-approve-or-reject-a-time-sheet-by-job"></a><a name="to-approve-or-reject-a-time-sheet-by-job"></a>Per approvare o rifiutare un foglio presenze in base alla commessa
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal"></a><a name="to-post-time-sheet-lines-in-a-resource-journal"></a>Per registrare le righe del foglio presenze nelle registrazioni risorse
...
## <a name="to-post-time-sheet-lines-in-a-job-journal"></a><a name="to-post-time-sheet-lines-in-a-job-journal"></a>Per registrare le righe del foglio presenze nelle registrazioni commesse
...
## <a name="to-archive-time-sheets"></a><a name="to-archive-time-sheets"></a>Per archiviare fogli presenze
