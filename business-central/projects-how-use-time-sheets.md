...
ms.author: edupont
---
# <a name="use-time-sheets" />Usare i fogli presenze
...
## <a name="to-create-time-sheets" />Per creare fogli di presenza
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets" />Per riutilizzare le righe del foglio presenze in altri fogli presenze
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet" />Per copiare le righe pianificazione commessa in un foglio presenze
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet" />Per definire i tipi di lavoro e aggiungerne uno a un foglio presenze
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval" />Per compilare le righe di un foglio presenze e inviarle per l'approvazione
...
## <a name="to-approve-or-reject-a-time-sheet" />Per approvare o rifiutare un foglio presenze
...
## <a name="to-reopen-a-time-sheet" />Per riaprire un foglio presenze
...
## <a name="to-view-and-approve-time-sheets-by-job" />Per visualizzare e approvare fogli presenze in base alla commessa
...
### <a name="to-approve-or-reject-a-time-sheet-by-job" />Per approvare o rifiutare un foglio presenze in base alla commessa
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal" />Per registrare le righe del foglio presenze nelle registrazioni risorse
...
## <a name="to-post-time-sheet-lines-in-a-job-journal" />Per registrare le righe del foglio presenze nelle registrazioni commesse
...
## <a name="to-archive-time-sheets" />Per archiviare fogli presenze
