...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Dimmi cosa vuoi fare") immetti **Fogli presenze**, quindi scegli il collegamento correlato.  
...
## <a name="copy-project-planning-lines-to-a-time-sheet"></a>Copiare le righe pianificazione commessa in un foglio presenze
...
## <a name="view-and-approve-time-sheets-by-project"></a>Visualizzare e approvare fogli presenze in base alla commessa
...
### <a name="approve-or-reject-a-time-sheet-by-project"></a>Approvare o rifiutare un foglio presenze in base alla commessa
...
## <a name="post-time-sheet-lines-in-a-project-journal"></a>Registrare le righe di un foglio presenze nelle registrazioni commesse
