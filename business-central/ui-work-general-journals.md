...
---
# <a name="work-with-general-journals" />Utilizzare le registrazioni COGE
...
## <a name="use-journal-templates-and-batches" />Usare batch e definizioni di registrazioni
...
### <a name="validating-general-journal-batches" />Convalida di batch registrazioni COGE
...
## <a name="understanding-main-accounts-and-balancing-accounts" />Informazioni su conti principali e contropartita
...
## <a name="work-with-recurring-journals" />Utilizzare le registrazioni periodiche
...
### <a name="recurring-method-field" />Campo Metodo ricorrenza
...
### <a name="recurring-frequency-field" />Campo Frequenza ricorrenza
...
### <a name="expiration-date-field" />Campo Data di scadenza
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts" />Allocare importi di registrazioni periodiche a vari conti
...
#### <a name="example-allocating-rent-payments-to-different-departments" />Esempio: Allocare pagamenti di affitti a diversi reparti
...
### <a name="calculate-the-reversal-date" />Calcolare la data storno
...
## <a name="work-with-standard-journals" />Utilizzare le registrazioni standard
...
### <a name="to-save-a-standard-journal" />Per salvare una registrazione standard
...
### <a name="to-reuse-a-standard-journal" />Per riutilizzare registrazioni standard
...
## <a name="to-renumber-document-numbers-in-journals" />Rinumerare i documenti nei giornali di registrazione
...
### <a name="to-renumber-documents-in-journals" />Per rinumerare i documenti nei giornali di registrazione
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-journals-dynamics-365-business-central" />Vedi il relativo [training Microsoft](/training/paths/use-journals-dynamics-365-business-central/)
