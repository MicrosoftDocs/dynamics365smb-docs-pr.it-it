...
---
# <a name="work-with-general-journals"></a><a name="work-with-general-journals"></a><a name="work-with-general-journals"></a>Utilizzare le registrazioni COGE
...
## <a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a>Usare batch e definizioni di registrazioni
...
### <a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a>Convalida di batch registrazioni COGE
...
## <a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a>Informazioni su conti principali e contropartita
...
## <a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a>Utilizzare le registrazioni periodiche
...
### <a name="recurring-method-field"></a><a name="recurring-method-field"></a><a name="recurring-method-field"></a>Campo Metodo ricorrenza
...
### <a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a>Campo Frequenza ricorrenza
...
### <a name="expiration-date-field"></a><a name="expiration-date-field"></a><a name="expiration-date-field"></a>Campo Data di scadenza
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a>Allocare importi di registrazioni periodiche a vari conti
...
#### <a name="example-allocating-rent-payments-to-different-departments"></a><a name="example-allocating-rent-payments-to-different-departments"></a><a name="example-allocating-rent-payments-to-different-departments"></a>Esempio: Allocare pagamenti di affitti a diversi reparti
...
### <a name="calculate-the-reversal-date"></a><a name="calculate-the-reversal-date"></a><a name="calculate-the-reversal-date"></a>Calcolare la data storno
...
## <a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a>Utilizzare le registrazioni standard
...
### <a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a>Per salvare una registrazione standard
...
### <a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a>Per riutilizzare registrazioni standard
...
## <a name="to-renumber-document-numbers-in-journals"></a><a name="to-renumber-document-numbers-in-journals"></a><a name="to-renumber-document-numbers-in-journals"></a>Rinumerare i documenti nei giornali di registrazione
...
### <a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a>Per rinumerare i documenti nei giornali di registrazione
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/paths/use-journals-dynamics-365-business-central/)
