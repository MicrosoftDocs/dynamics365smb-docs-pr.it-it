...
> [!NOTE]
> L'analisi per i cespiti è leggermente diversa rispetto ad altre aree. Devi analizzare i dati già presenti, come acquisizioni di asset, ammortamento e assicurazione, ma anche dati su dati futuri, come ammortamento e ritiro dei cespiti. Per quest'ultimo tipo di analisi, [!INCLUDE[prod_short](includes/prod_short.md)] include report integrati in grado di calcolare questi numeri.
