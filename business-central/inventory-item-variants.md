...
ms.author: edupont
---
# <a name="manage-product-variants" />Gestire le varianti di prodotto
...
## <a name="item-availability-by-variant" />Disponibilità articolo per variante

[!INCLUDE [inventory_variant-availability](includes/inventory_variant-availability.md)]

## <a name="require-use-of-variants" />Richiede l'uso di varianti
