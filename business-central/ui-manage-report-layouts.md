...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a>Panoramica dei layout di report e documento
...
## <a name="introduction"></a><a name="introduction"></a><a name="introduction"></a>Introduzione
...
## <a name="layout-types"></a><a name="layout-types"></a><a name="layout-types"></a>Tipi di layout
...
### <a name="external"></a><a name="external"></a><a name="external"></a>Esterno
...
## <a name="layout-sources"></a><a name="layout-sources"></a><a name="layout-sources"></a>Origini del layout
