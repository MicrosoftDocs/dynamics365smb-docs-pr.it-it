...
ms.author: edupont
---
# <a name="work-with-payment-tolerances-and-payment-discount-tolerances" />Utilizzare le tolleranze pagamento e le tolleranze sconto pagamento
...
## <a name="applying-payment-tolerance-to-multiple-documents" />Collegamento della tolleranza di pagamento a più documenti
...
## <a name="to-set-up-tolerances" />Per impostare le tolleranze
...
## <a name="to-enable-or-disable-payment-tolerance-warnings" />Per abilitare o disabilitare gli avvisi di tolleranza pagamento
...
## <a name="to-block-payment-tolerance-for-customers" />Per bloccare la tolleranza pagamento per i clienti
...
### <a name="payment-range-diagrams" />Diagrammi dell'intervallo di pagamento
...
### <a name="payment-range-diagrams-1" />Diagrammi dell'intervallo di pagamento

I diagrammi degli intervalli di pagamento per lo scenario sopra illustrato sono:  

#### <a name="1-payment-date-011503-scenarios-1-3-1" />(1) Data di pagamento <=15/01/03 (scenari 1-3)
...
## <a name="see-related-microsoft-training" />Vedi il relativo [training Microsoft](/training/modules/enter-payments-dynamics-365-business-central/)
