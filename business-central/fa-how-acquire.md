...
ms.author: edupont
---
# <a name="acquire-fixed-assets" />Acquisire i cespiti
...
## <a name="to-create-a-fixed-asset-and-acquire-it-automatically" />Per creare un cespite e acquisirlo automaticamente
...
## <a name="to-set-up-a-component-list-for-a-main-asset" />Per impostare una lista di componenti per un bene principale
...
## <a name="to-post-a-fixed-asset-acquisition-manually-with-the-fixed-asset-gl-journal" />Per registrare manualmente un'acquisizione del cespite mediante Registrazioni cespiti in C/G
...
## <a name="to-cancel-an-acquisition-cost-posting-for-one-fixed-asset" />Per annullare una registrazione di costo di acquisto per un cespite
...
## <a name="to-post-the-salvage-value-together-with-the-acquisition-cost" />Per registrare il valore di realizzo con il costo di acquisto
