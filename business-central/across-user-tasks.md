...
ms.author: edupont
---
# <a name="define-user-tasks"></a><a name="define-user-tasks"></a>Definisci task dell'utente
...
## <a name="managing-user-tasks"></a><a name="managing-user-tasks"></a>Gestione dei task degli utenti
...
### <a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a>Selezione dei task degli utenti
...
### <a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a>Eliminazione di task degli utenti
