...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Ripianificare o aggiornare direttamente gli ordini di produzione
...
## <a name="to-replan-a-production-order" />Per ripianificare un ordine di produzione
...
## <a name="to-refresh-a-production-order" />Per aggiornare un ordine di produzione
