...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly"></a><a name="replan-or-refresh-production-orders-directly"></a>Ripianificare o aggiornare direttamente gli ordini di produzione
...
## <a name="to-replan-a-production-order"></a><a name="to-replan-a-production-order"></a>Per ripianificare un ordine di produzione
...
## <a name="to-refresh-a-production-order"></a><a name="to-refresh-a-production-order"></a>Per aggiornare un ordine di produzione
