...
# <a name="set-up-standard-service-codes" />Impostare codici di servizio standard
...
## <a name="to-set-up-a-standard-service-code" />Per impostare un codice di servizio standard
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />Per assegnare un codice di servizio standard a un gruppo di articoli in assistenza
