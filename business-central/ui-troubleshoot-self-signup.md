...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up" />Risoluzione dei problemi relativi all'iscrizione self-service
...
## <a name="what-email-address-can-i-use-with-business-central" />Quale indirizzo e-mail posso utilizzare con Business Central?
...
## <a name="regional-availability" />Disponibilità regionale
