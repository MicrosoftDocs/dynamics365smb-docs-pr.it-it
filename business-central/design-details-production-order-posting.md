...
ms.author: edupont
---
# <a name="design-details-production-order-posting" />Dettagli di progettazione: Registrazione dell'ordine di produzione
...
## <a name="posting-structure" />Struttura della registrazione
...
## <a name="capacity-posting" />Registrazione capacità
...
## <a name="production-order-costing" />Determinazione costi ordine di produzione
