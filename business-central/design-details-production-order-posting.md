...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Dettagli di progettazione: Registrazione dell'ordine di produzione
...
## <a name="posting-structure"></a><a name="posting-structure"></a>Struttura della registrazione
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a>Registrazione capacità
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a>Determinazione costi ordine di produzione
