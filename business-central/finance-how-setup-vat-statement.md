...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names" />Impostazione di definizioni di dichiarazione IVA e di nomi delle dichiarazioni IVA
...
## <a name="to-define-a-vat-statement" />Per definire dichiarazioni IVA
...
## <a name="to-preview-the-vat-statement" />Per visualizzare in anteprima la dichiarazione IVA
