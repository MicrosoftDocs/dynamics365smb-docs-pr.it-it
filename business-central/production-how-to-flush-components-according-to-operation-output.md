...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output" />Eseguire la consuntivazione dei componenti in base all'output dell'operazione
...
## <a name="automatic-consumption-posting-flushing-methods" />Metodi registrazione automatica del consumo (consuntivazione)
...
### <a name="automatic-reporting---forward-flush-the-entire-order" />Reporting automatico - Consuntivazione in avanti dell'intero ordine
...
### <a name="automatic-reporting---forward-flushing-by-operation" />Registrazione automatica - Consuntivazione in avanti in base all'operazione
...
### <a name="automatic-reporting---back-flushing-by-operation" />Registrazione automatica - Consuntivazione a ritroso in base all'operazione
...
### <a name="automatic-reporting---back-flushing-the-entire-order" />Reporting automatico - Consuntivazione a ritroso dell'intero ordine
...
## <a name="to-flush-components-according-to-operation-output" />Per eseguire la consuntivazione dei componenti in base all'output dell'operazione
...
## <a name="flushing-methods" />Metodi di consuntivazione
