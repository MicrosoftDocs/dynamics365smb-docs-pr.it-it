...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>Sintesi della riga di registrazione di contabilità generale
...
## <a name="old-architecture"></a><a name="old-architecture"></a>Architettura precedente
...
### <a name="new-architecture"></a><a name="new-architecture"></a>Nuova Architettura
