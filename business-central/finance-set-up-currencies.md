...
ms.author: edupont
---
# <a name="set-up-currencies"></a><a name="set-up-currencies"></a>Impostare le valute
...
## <a name="currencies"></a><a name="currencies"></a><a name="curr"></a>Valute
...
### <a name="available-currency-functions"></a><a name="available-currency-functions"></a>Funzioni valuta disponibili
...
## <a name="lcy-and-other-currencies"></a><a name="lcy-and-other-currencies"></a>VL e altre valute

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies"></a><a name="rounding-currencies"></a>Arrotondamento delle valute
...
### <a name="unit-amount-rounding"></a><a name="unit-amount-rounding"></a>Arrotondamento importo unitario
...
### <a name="amount-rounding"></a><a name="amount-rounding"></a>Arrotondamento importo
...
## <a name="general-ledger-accounts"></a><a name="general-ledger-accounts"></a>Conti di contabilità generale
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
