...
# <a name="the-image-analyzer-extension" />Estensione di analisi immagini
...
## <a name="privacy-notice" />Informativa sulla privacy
...
## <a name="switch-on-the-image-analyzer-extension" />Attiva l'estensione Analisi di immagini
...
## <a name="analyze-an-item-image" />Analizzare un'immagine dell'articolo
...
## <a name="analyze-a-contact-person-picture" />Analizzare un'immagine di una persona di contatto
...
## <a name="use-your-own-computer-vision-api-account" />Utilizzare il proprio account per l'API Visione artificiale
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period" />Visualizzare il numero delle analisi rimanenti per il periodo corrente
...
## <a name="stop-using-the-image-analyzer-extension" />Interrompere l'utilizzo dell'estensione di analisi immagini
