...
ms.author: edupont
---
# <a name="convert-existing-locations-to-warehouse-locations" />Convertire le ubicazioni esistenti in ubicazione warehouse
...
## <a name="to-enable-an-existing-location-to-operate-as-a-warehouse-location" />Per abilitare un'ubicazione esistente come ubicazione di warehouse
