...
# <a name="set-up-contact-sync-with-outlook-for-business-central-on-premises" />Impostare la sincronizzazione dei contatti di Outlook per Business Central locale
...
## <a name="set-up-contact-sync" />Impostare la sincronizzazione dei contatti
