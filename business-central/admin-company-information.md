...
# <a name="company-information-overview" />Panoramica delle informazioni sulla società
...
## <a name="working-with-multiple-companies" />Lavorare con più società
...
## <a name="change-company-display-name" />Cambiare il nome visualizzato della società
