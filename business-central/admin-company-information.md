...
# <a name="company-information-overview"></a><a name="company-information-overview"></a><a name="company-information-overview"></a>Panoramica delle informazioni sulla società
...
## <a name="working-with-multiple-companies"></a><a name="working-with-multiple-companies"></a><a name="working-with-multiple-companies"></a>Lavorare con più società
...
## <a name="display-a-company-badge"></a><a name="display-a-company-badge"></a><a name="display-a-company-badge"></a><a name="badge"></a>Visualizzare un badge società
...
## <a name="change-company-display-name"></a><a name="change-company-display-name"></a><a name="change-company-display-name"></a>Cambiare il nome visualizzato della società
...
## <a name="experience"></a><a name="experience"></a><a name="experience"></a>Esperienza
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/create-new-companies-dynamics-365-business-central/)
