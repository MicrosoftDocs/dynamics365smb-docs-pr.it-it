...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a>Tenere traccia delle relazioni tra domanda e approvvigionamento
...
## <a name="to-track-linked-items"></a><a name="to-track-linked-items"></a><a name="to-track-linked-items"></a>Per tracciare articoli collegati
...
## <a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a>Elementi di pianificazione non tracciati
