...
ms.author: jswymer
---
# <a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-"></a>Componente di integrazione Power BI e panoramica dell'architettura per [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="components"></a><a name="components"></a>Componenti
...
## <a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a>Cosa è disponibile dall'inizio
...
## <a name="general-flow"></a><a name="general-flow"></a>Flusso generale
