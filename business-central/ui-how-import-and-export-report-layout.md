...
ms.author: edupont
---
# <a name="legacy-import-and-export-custom-report-layouts"></a><a name="legacy-import-and-export-custom-report-layouts"></a>(Legacy) Importare ed esportare layout di report personalizzati
...
### <a name="to-export-a-report-layout-to-a-file"></a><a name="to-export-a-report-layout-to-a-file"></a>Per esportare un layout di report verso un file
...
### <a name="to-import-a-report-layout-file"></a><a name="to-import-a-report-layout-file"></a>Per importare un file di layout di report
