...
# <a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a>Panoramica gestione del magazzino
...
## <a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a>Modellazione della warehouse fisica
...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a><a name="locations-and-bins"></a>Ubicazioni e collocazioni
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Scaffali e collocazioni
...
## <a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a>Flusso di lavoro tipico della warehouse
...
## <a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a>Terminologia relativa a Warehouse Management

### <a name="complexity-levels"></a><a name="complexity-levels"></a><a name="complexity-levels"></a>Livelli di complessità
...
### <a name="warehouse-flows"></a><a name="warehouse-flows"></a><a name="warehouse-flows"></a>Flussi di warehouse
...
### <a name="basic-documents"></a><a name="basic-documents"></a><a name="basic-documents"></a>Documenti di base
...
### <a name="advanced-documents"></a><a name="advanced-documents"></a><a name="advanced-documents"></a>Documenti avanzati
...
### <a name="pages-and-settings"></a><a name="pages-and-settings"></a><a name="pages-and-settings"></a>Pagine e impostazioni
...
#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Collocazioni e contenuto della collocazione
...
#### <a name="bin-type"></a><a name="bin-type"></a><a name="bin-type"></a>Tipo collocazione
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a><a name="bin-ranking"></a>Valutazione collocazione
...
#### <a name="bin-setup"></a><a name="bin-setup"></a><a name="bin-setup"></a>Impostazione della collocazione
...
#### <a name="zone"></a><a name="zone"></a><a name="zone"></a>Area
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a><a name="warehouse-class"></a>Classe warehouse
...
#### <a name="location"></a><a name="location"></a><a name="location"></a>Ubicazione
...
#### <a name="put-away-template"></a><a name="put-away-template"></a><a name="put-away-template"></a>Modello stoccaggio
