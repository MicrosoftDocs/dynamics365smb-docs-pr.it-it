...
# <a name="warehouse-management-overview" />Panoramica gestione del magazzino
...
## <a name="modeling-the-physical-warehouse" />Modellazione della warehouse fisica
...
### <a name="locations-and-bins" />Ubicazioni e collocazioni
...
### <a name="shelves-and-bins" />Scaffali e collocazioni
...
## <a name="typical-warehouse-workflow" />Flusso di lavoro tipico della warehouse
...
## <a name="terminology-related-to-warehouse-management" />Terminologia relativa a Warehouse Management

### <a name="complexity-levels" />Livelli di complessità
...
### <a name="warehouse-flows" />Flussi di warehouse
...
### <a name="basic-documents" />Documenti di base
...
### <a name="advanced-documents" />Documenti avanzati
...
### <a name="pages-and-settings" />Pagine e impostazioni
...
#### <a name="bins-and-bin-content" />Collocazioni e contenuto della collocazione
...
#### <a name="bin-type" />Tipo collocazione
...
#### <a name="bin-ranking" />Valutazione collocazione
...
#### <a name="bin-setup" />Impostazione della collocazione
...
#### <a name="warehouse-class" />Classe warehouse
...
#### <a name="put-away-template" />Modello stoccaggio
