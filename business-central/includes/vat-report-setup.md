...
5. Nei paesi/regioni supportati, per impostare i periodi di dichiarazione IVA, compilare i campi **Versione report** e **Calcolo promemoria periodo** nella scheda rapida **Periodo di dichiarazione**.  

    Nei paesi/aree geografiche in cui i periodi di dichiarazione IVA sono richiesti dalle autorità fiscali, come il Regno Unito, è necessario compilare anche i campi aggiuntivi. [!INCLUDE [tooltip-inline-tip_md](tooltip-inline-tip_md.md)]  Tuttavia, nella versione britannica, questa FastTab ha il nome  **Making Tax Digital**.
