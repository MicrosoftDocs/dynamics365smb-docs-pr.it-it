...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>Per creare un sollecito automaticamente
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>Per creare un sollecito manualmente
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>Per sostituire i testi di un sollecito
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>Per emettere un sollecito
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>Per annullare un sollecito emesso
