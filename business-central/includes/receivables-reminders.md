...
### <a name="to-create-a-reminder-automatically" />Per creare un sollecito automaticamente
...
### <a name="to-create-a-reminder-manually" />Per creare un sollecito manualmente
...
### <a name="to-replace-reminder-texts" />Per sostituire i testi di un sollecito
...
### <a name="to-issue-a-reminder" />Per emettere un sollecito
...
### <a name="to-cancel-an-issued-reminder" />Per annullare un sollecito emesso
