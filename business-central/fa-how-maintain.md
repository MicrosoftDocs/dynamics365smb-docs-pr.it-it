...
---
# <a name="maintain-fixed-assets"></a>Gestione dei cespiti
...
## <a name="record-a-maintenance-cost-directly-on-a-fixed-asset"></a>Registrare un costo di manutenzione direttamente su un cespite
...
## <a name="post-maintenance-costs-from-a-fixed-asset-gl-journal"></a>Registrare costi di manutenzione da una registrazione cespiti in C/G
...
## <a name="record-maintenance-cost-from-a-purchase-invoice"></a>Registrare i costi di manutenzione da una fattura di acquisto
...
## <a name="follow-up-on-service-visits"></a>Follow up delle visite di assistenza
...
## <a name="monitor-maintenance-costs"></a>Monitorare i costi di manutenzione
...
## <a name="view-or-print-maintenance-costs-for-multiple-fixed-assets"></a>Visualizzare o stampare i costi di manutenzione per più cespiti
...
## <a name="view-maintenance-ledger-entries"></a>Visualizzare i movimenti contabili di manutenzione
...
## <a name="view-or-print-maintenance-ledger-entries-for-multiple-fixed-assets"></a>Visualizzare o stampare i movimenti contabili di manutenzione per più cespiti
