...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Utilizzare gli ordini di vendita programmati o gli ordini di acquisto programmati
...
## <a name="to-create-a-blanket-sales-order" />Per creare un ordine di vendita programmato
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Per creare un ordine di vendita da un ordine di vendita programmato
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Per visualizzare lo stato di un ordine di vendita programmato
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Per visualizzare le righe degli ordini di vendita programmati registrate e non registrate
