...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations" />Dettagli di progettazione: Ricerca delle combinazioni di dimensione
...
### <a name="finding-dimension-set-id" />Ricerca ID set di dimensioni
