...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a>Dettagli di progettazione: Ricerca delle combinazioni di dimensione
...
## <a name="building-search-tree"></a><a name="building-search-tree"></a>Creazione albero di ricerca
...
### <a name="example-1"></a><a name="example-1"></a>Esempio 1
...
### <a name="example-2"></a><a name="example-2"></a>Esempio 2
...
### <a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a>Ricerca ID set di dimensioni
