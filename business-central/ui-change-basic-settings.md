...
ms.author: jswymer
---
# <a name="change-basic-settings" />Modificare le impostazioni di base
...
### <a name="change-the-role" />Modificare il ruolo
...
### <a name="work-date-indication" />Indicazione della data del lavoro
...
## <a name="notifications" />Notifiche
...
## <a name="teaching-tips" />Suggerimenti didattici
