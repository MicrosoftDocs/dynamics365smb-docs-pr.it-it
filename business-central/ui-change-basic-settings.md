...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Modificare le impostazioni di base
...
## <a name="role"></a><a name="role"></a>Ruolo <a name="role-center"></a>
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Modificare il ruolo
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Società
...
## <a name="work-date"></a><a name="work-date"></a>Data lavoro <a name="work-date"></a>
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Indicazione della data del lavoro
...
## <a name="region"></a><a name="region"></a><a name="region"></a> Area geografica
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Lingua
...
## <a name="time-zone"></a><a name="time-zone"></a>Fuso orario
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Suggerimenti didattici
