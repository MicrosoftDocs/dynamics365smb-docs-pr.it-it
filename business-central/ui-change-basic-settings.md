...
Usa la pagina **Impostazioni personali** per gestire le impostazioni di base per [!INCLUDE[prod_short](includes/prod_short.md)]. Le modifiche apportate interessano solo la tua area di lavoro, non quella di altri utenti.  
...
La lingua iniziale è determinata dall'amministratore o dalle impostazioni del browser quando si effettua la registrazione per [!INCLUDE[prod_short](includes/prod_short.md)]. La lingua impostata viene utilizzata in tutti i dispositivi dai quali esegui l'accesso, ad esempio un telefono o un tablet.

Puoi installare altre lingue per [!INCLUDE[prod_short](includes/prod_short.md)] da AppSource. Mentre tutte le lingue di visualizzazione supportate sono visualizzate nell'elenco, l'amministratore deve installare l'app della lingua relativa al tenant prima che gli utenti possano passare alla nuova lingua in [!INCLUDE[prod_short](includes/prod_short.md)].  
