...
ms.author: edupont
---
# <a name="use-ocr-to-turn-pdf-and-image-files-into-electronic-documents" />Utilizzare OCR per convertire PDF e file di immagine in documenti elettronici
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-from-the-incoming-documents-page" />Per inviare un file di immagine o PDF al servizio OCR dalla pagina Documenti in entrata
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-by-email" />Per inviare un file di immagine o PDF del servizio OCR tramite e-mail
...
## <a name="to-receive-the-resulting-electronic-document-from-the-ocr-service" />Per ricevere il documento elettronico risultante dal servizio OCR
...
## <a name="to-create-a-purchase-invoice-from-an-electronic-document-received-from-the-ocr-service" />Per creare una fattura di acquisto da un documento elettronico ricevuto dal servizio OCR
...
### <a name="to-map-text-on-an-incoming-document-to-a-specific-vendor-account" />Per mappare il testo di un documento in entrata a un determinato conto del fornitore
...
## <a name="to-handle-errors-when-receiving-electronic-documents" />Per gestire gli errori durante la ricezione di documenti elettronici
...
## <a name="to-train-the-ocr-service-to-avoid-errors" />Per istruire il servizio OCR a evitare errori
