...
ms.author: jswymer
---
# <a name="setting-the-layout-used-by-a-report" />Impostare il layout utilizzato da un report
...
## <a name="set-the-layout-from-the-report-layouts-page" />Impostare il layout dalla pagina Layout report
...
## <a name="set-the-layout-from-report-layout-selection-page" />Impostare il layout dalla pagina Selezione layout report
...
## <a name="revert-to-the-original-default-layout" />Ripristinare il layout predefinito originale
