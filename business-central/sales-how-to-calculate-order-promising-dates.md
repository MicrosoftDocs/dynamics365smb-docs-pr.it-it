...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Calcolare le date per la promessa ordine
...
## <a name="about-order-promising" />Informazioni sulla promessa ordine
...
### <a name="available-to-promise" />ATP (Available-to-Promise)
...
### <a name="capable-to-promise" />CTP (Capable-to-Promise)
...
## <a name="to-set-up-order-promising" />Per impostare le promesse ordine
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Tempo di gestione della warehouse in entrata e in uscita nella promessa ordine
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />Per immettere il tempo di gestione della warehouse in entrata e in uscita predefinito per i documenti di vendita e acquisto
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />Per immettere i tempi di gestione warehouse in entrata e in uscita nelle ubicazioni
...
## <a name="to-make-an-item-critical" />Per identificare un articolo come critico
...
## <a name="to-calculate-an-order-promising-date" />Per calcolare una data per la promessa ordine
...
## <a name="see-related-microsoft-trainingtrainingmodulespromising-sales-order-delivery-dynamics--business-central" />Vedi il relativo [training Microsoft](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
