...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Calcolare le date per la promessa ordine
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a>Informazioni sulla promessa ordine
...
### <a name="available-to-promise"></a><a name="available-to-promise"></a>ATP (Available-to-Promise)
...
### <a name="capable-to-promise"></a><a name="capable-to-promise"></a>CTP (Capable-to-Promise)
...
### <a name="calculations"></a><a name="calculations"></a>Calcoli
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>Per impostare le promesse ordine
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a><a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a>Tempo di gestione della warehouse in entrata e in uscita nella promessa ordine
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a><a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a>Per immettere i tempi di gestione warehouse in entrata e in uscita nelle ubicazioni
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>Per identificare un articolo come critico
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>Per calcolare una data per la promessa ordine
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
