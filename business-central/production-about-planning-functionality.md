...
ms.author: bholtorf
---
# <a name="about-planning-functionality" />Informazioni sulla funzionalità di pianificazione
...
## <a name="demand-and-supply" />Domanda e approvvigionamento
...
## <a name="planning-calculation" />Calcolo della pianificazione
...
## <a name="planning-with-manual-transfer-orders" />Pianificazione con ordini di trasferimento manuali
...
## <a name="other-important-planning-fields" />Altri campi di pianificazione rilevanti
...
## <a name="planning-worksheets-and-requisition-worksheets" />Prospetti pianificazione e richieste di approvvigionamento
...
### <a name="requisition-worksheet" />Richiesta di approvvigionamento
...
## <a name="see-related-microsoft-trainingtrainingmodulesplan-items-dynamics-365-business-central" />Vedi il relativo [training Microsoft](/training/modules/plan-items-dynamics-365-business-central/)
