...
ms.author: jswymer
---
# <a name="get-business-central-desktop-app" />Ottieni Business Central Desktop App
...
## <a name="why-use-the-app" />Perché usare l'applicazione?
...
## <a name="install-the-app-for-business-central-online" />Installare l'app per Business Central online
...
### <a name="from-microsoft-store" />Da Microsoft Store
...
### <a name="from-the-browser" />Dal browser
...
## <a name="install-the-app-for-business-central-on-premises" />Installare l'app per Business Central in locale
