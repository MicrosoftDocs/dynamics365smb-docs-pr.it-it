...
# <a name="developing-business-central-report-layouts-and-datasets" />Sviluppo di layout di report e set di dati di Business Central
...
## <a name="developing-report-layouts" />Sviluppo dei layout di report
...
## <a name="developing-report-datasets" />Sviluppo dei set di dati di report
