...
ms.author: edupont
---
# <a name="create-routings" />Creare cicli
...
## <a name="to-create-a-routing" />Per creare un ciclo
...
## <a name="to-create-routing-links" />Per creare collegamenti ciclo
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations" />Per assegnare personale, strumenti e controlli di qualità alle operazioni di ciclo
...
## <a name="to-create-a-new-versions-of-a-routing" />Per creare nuove versioni di un ciclo
