...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central" />Risoluzione dei problemi di connettività per Business Central
...
## <a name="start-the-connectivity-check" />Avviare il controllo della connettività
...
## <a name="basic-internet-connectivity" />Connettività Internet di base
...
## <a name="cdn-content-delivery-network-resources-loading" />Caricamento delle risorse CDN (Content Delivery Network)
...
## <a name="user-authentication" />Autenticazione utente
...
## <a name="business-central-environments-discovery" />Individuazione degli ambienti di Business Central
...
## <a name="application-service-connectivity" />Connettività del servizio applicativo
...
## <a name="web-server-connectivity" />Connettività server Web
...
## <a name="service-health-status" />Stato di integrità del servizio
