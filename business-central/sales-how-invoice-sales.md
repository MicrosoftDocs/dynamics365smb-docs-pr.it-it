...
ms.author: edupont
---
# <a name="invoice-sales" />Fatturare le vendite
...
## <a name="create-sales-invoices" />Crea fatture di vendita
...
### <a name="to-create-a-sales-invoice" />Per creare una fattura di vendita
...
## <a name="registering-payments" />Registrazione dei pagamenti
...
## <a name="see-related-microsoft-trainingtrainingmodulesinvoicing-customers-dynamics--business-centralindex" />Vedi il relativo [training Microsoft](/training/modules/invoicing-customers-dynamics-365-business-central/index).
