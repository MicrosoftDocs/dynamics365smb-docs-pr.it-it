...
ms.author: edupont
---
# <a name="set-up-initial-item-costs-in-the-italian-version"></a><a name="set-up-initial-item-costs-in-the-italian-version"></a><a name="set-up-initial-item-costs-in-the-italian-version"></a>Impostare i costi iniziali degli articoli nella versione italiana
...
## <a name="to-set-up-initial-item-costs"></a><a name="to-set-up-initial-item-costs"></a><a name="to-set-up-initial-item-costs"></a>Per impostare i costi iniziali per gli articoli
