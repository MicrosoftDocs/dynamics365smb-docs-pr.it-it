...
ms.author: edupont
---
# <a name="print-and-reprint-gl-books-and-vat-registers-in-the-italian-version" />Stampa e ristampa di libri giornale e registri IVA nella versione italiana
...
## <a name="to-print-the-general-ledger-book-report" />Per stampare il report libro giornale
...
## <a name="to-view-or-change-page-numbering-for-reprinting-the-general-ledger-book-report" />Per visualizzare o modificare la numerazione della pagina per la ristampa del report libro contabile
