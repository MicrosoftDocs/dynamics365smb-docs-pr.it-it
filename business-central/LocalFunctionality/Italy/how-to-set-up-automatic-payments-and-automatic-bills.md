...
ms.author: edupont
---
# <a name="set-up-automatic-payments-and-automatic-bills-in-the-italian-version"></a><a name="set-up-automatic-payments-and-automatic-bills-in-the-italian-version"></a>Impostare i pagamenti automatici e gli effetti automatici nella versione italiana
...
## <a name="to-add-bank-information-for-your-company"></a><a name="to-add-bank-information-for-your-company"></a>Per aggiungere le informazioni relative alla banca della società
...
## <a name="to-set-up-automatic-bills-for-sales-and-receivables"></a><a name="to-set-up-automatic-bills-for-sales-and-receivables"></a>Per impostare gli effetti automatici per vendite e incassi
...
## <a name="to-specify-bill-codes-for-a-payment-method"></a><a name="to-specify-bill-codes-for-a-payment-method"></a>Per specificare i codici effetto per un metodo di pagamento
