...
ms.author: edupont
---
# <a name="export-vat-transactions-reports-in-the-italian-version"></a><a name="export-vat-transactions-reports-in-the-italian-version"></a><a name="export-vat-transactions-reports-in-the-italian-version"></a>Esportare i report di transazioni IVA nella versione italiana
...
## <a name="to-export-and-submit-a-vat-transaction-report"></a><a name="to-export-and-submit-a-vat-transaction-report"></a><a name="to-export-and-submit-a-vat-transaction-report"></a>Per esportare e inviare un report di transazioni IVA
