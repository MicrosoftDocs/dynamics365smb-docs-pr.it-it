...
# <a name="print-withholding-tax-reports-in-the-italian-version"></a><a name="print-withholding-tax-reports-in-the-italian-version"></a>Stampare i report di ritenuta d'acconto nella versione italiana

Nel report **Ritenute** viene visualizzato un elenco delle ritenute dovute allo stato italiano.  

## <a name="to-print-a-withholding-tax-report"></a><a name="to-print-a-withholding-tax-report"></a>Per stampare un report delle ritenute
