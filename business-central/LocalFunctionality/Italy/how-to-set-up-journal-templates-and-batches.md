...
ms.author: edupont
---
# <a name="set-up-journal-templates-and-batches" />Impostazione di definizioni e batch di registrazioni
...
## <a name="to-set-up-intrastat-journal-templates" />Per impostare definizioni di registrazioni Intrastat
...
## <a name="to-set-up-intrastat-journal-batches" />Per impostare batch di registrazioni Intrastat
