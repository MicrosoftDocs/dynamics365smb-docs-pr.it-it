...
ms.author: edupont
---
# <a name="create-electronic-vat-transactions-reports-in-the-italian-version"></a><a name="create-electronic-vat-transactions-reports-in-the-italian-version"></a><a name="create-electronic-vat-transactions-reports-in-the-italian-version"></a>Creare i report elettronici di transazioni IVA nella versione italiana
...
## <a name="to-create-a-vat-transactions-report"></a><a name="to-create-a-vat-transactions-report"></a><a name="to-create-a-vat-transactions-report"></a>Per creare un report di transazioni IVA
