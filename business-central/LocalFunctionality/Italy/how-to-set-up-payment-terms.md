...
ms.author: edupont
---
# <a name="set-up-payment-terms-in-the-italian-version"></a><a name="set-up-payment-terms-in-the-italian-version"></a>Impostare le condizioni pagamento nella versione italiana
...
## <a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a>Impostare le condizioni pagamento
