...
ms.author: edupont
---
# <a name="set-up-withholding-tax-in-the-italian-version" />Impostare la ritenuta d'acconto nella versione italiana
...
## <a name="to-set-up-withholding-tax-codes" />Per impostare i codici ritenuta
...
## <a name="to-set-up-withholding-tax-for-vendors" />Per impostare la ritenuta per i fornitori
...
## <a name="to-calculate-withholding-tax-for-purchase-invoices" />Per calcolare la ritenuta per le fatture di acquisto
...
## <a name="to-make-a-vendor-payment" />Per effettuare un pagamento fornitore
