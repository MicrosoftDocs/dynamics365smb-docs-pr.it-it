...
ms.author: edupont
---
# <a name="update-vat-transactions-data"></a><a name="update-vat-transactions-data"></a><a name="update-vat-transactions-data"></a>Aggiornare i dati delle transazioni IVA
...
## <a name="to-update-vat-transaction-data"></a><a name="to-update-vat-transaction-data"></a><a name="to-update-vat-transaction-data"></a>Per aggiornare i dati delle transazioni IVA
