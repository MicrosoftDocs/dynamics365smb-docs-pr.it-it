...
ms.author: edupont
---
# <a name="set-up-alternate-depreciation-methods" />Impostare metodi di ammortamento alternativi
...
## <a name="to-set-up-alternate-depreciation-methods" />Per impostare metodi di ammortamento alternativi
