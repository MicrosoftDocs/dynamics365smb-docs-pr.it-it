...
ms.author: edupont
---
# <a name="set-up-alternate-depreciation-methods"></a><a name="set-up-alternate-depreciation-methods"></a><a name="set-up-alternate-depreciation-methods"></a>Impostare metodi di ammortamento alternativi
...
## <a name="to-set-up-alternate-depreciation-methods"></a><a name="to-set-up-alternate-depreciation-methods"></a><a name="to-set-up-alternate-depreciation-methods"></a>Per impostare metodi di ammortamento alternativi
