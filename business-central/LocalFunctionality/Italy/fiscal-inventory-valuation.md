...
ms.author: edupont
---
# <a name="fiscal-inventory-valuation"></a><a name="fiscal-inventory-valuation"></a>Valutazione magazzino fiscale
...
## <a name="fiscal-inventory-valuation-in-"></a><a name="fiscal-inventory-valuation-in-"></a>Valutazione magazzino fiscale in [!INCLUDE[prod_short](../../includes/prod_short.md)]
...
## <a name="end-of-year"></a><a name="end-of-year"></a>Fine anno
