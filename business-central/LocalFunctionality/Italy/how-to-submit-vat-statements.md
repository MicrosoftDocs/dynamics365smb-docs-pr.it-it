...
ms.author: edupont
---
# <a name="submit-vat-statements-in-the-italian-version"></a><a name="submit-vat-statements-in-the-italian-version"></a>Inviare dichiarazioni IVA nella versione italiana
...
## <a name="to-review-and-print-vat-statements"></a><a name="to-review-and-print-vat-statements"></a>Per esaminare e stampare le dichiarazioni IVA
...
## <a name="to-settle-and-post-vat-transactions"></a><a name="to-settle-and-post-vat-transactions"></a>Per liquidare e registrare le transazioni IVA
...
## <a name="to-submit-vat-statements"></a><a name="to-submit-vat-statements"></a>Per inviare le dichiarazioni IVA
