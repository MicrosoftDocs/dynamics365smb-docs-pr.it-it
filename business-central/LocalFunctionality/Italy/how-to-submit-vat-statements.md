...
ms.author: edupont
---
# <a name="submit-vat-statements-in-the-italian-version" />Inviare dichiarazioni IVA nella versione italiana
...
## <a name="to-review-and-print-vat-statements" />Per esaminare e stampare le dichiarazioni IVA
...
## <a name="to-settle-and-post-vat-transactions" />Per liquidare e registrare le transazioni IVA
...
## <a name="to-submit-vat-statements" />Per inviare le dichiarazioni IVA
