...
ms.author: edupont
---
# <a name="italian-vat"></a><a name="italian-vat"></a>IVA italiana
...
## <a name="vat-codes-and-rates"></a><a name="vat-codes-and-rates"></a>Codici e aliquote IVA
...
### <a name="computing-vat"></a><a name="computing-vat"></a>Elaborazione dell'IVA
...
### <a name="dates"></a><a name="dates"></a>Date
...
### <a name="non-deductible-vat"></a><a name="non-deductible-vat"></a>IVA non detraibile
...
## <a name="service-tariffs"></a><a name="service-tariffs"></a>Nomenclatura articoli in assistenza
...
## <a name="vat-transaction-reports"></a><a name="vat-transaction-reports"></a>Report transazioni IVA
