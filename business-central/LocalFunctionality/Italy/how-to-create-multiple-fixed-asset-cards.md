...
ms.author: edupont
---
# <a name="create-multiple-fixed-asset-cards-in-the-italian-version" />Creare più schede cespite nella versione italiana
...
## <a name="to-create-multiple-fixed-asset-cards" />Per creare più schede cespite
