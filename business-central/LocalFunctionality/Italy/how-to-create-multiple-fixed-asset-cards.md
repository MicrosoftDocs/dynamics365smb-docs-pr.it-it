...
ms.author: edupont
---
# <a name="create-multiple-fixed-asset-cards-in-the-italian-version"></a><a name="create-multiple-fixed-asset-cards-in-the-italian-version"></a><a name="create-multiple-fixed-asset-cards-in-the-italian-version"></a>Creare più schede cespite nella versione italiana
...
## <a name="to-create-multiple-fixed-asset-cards"></a><a name="to-create-multiple-fixed-asset-cards"></a><a name="to-create-multiple-fixed-asset-cards"></a>Per creare più schede cespite
