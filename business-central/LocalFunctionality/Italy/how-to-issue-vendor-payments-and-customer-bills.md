...
ms.author: edupont
---
# <a name="issue-vendor-payments-and-customer-bills"></a><a name="issue-vendor-payments-and-customer-bills"></a><a name="issue-vendor-payments-and-customer-bills"></a>Emettere pagamenti fornitori ed effetti clienti
...
## <a name="to-issue-payment-to-a-vendor"></a><a name="to-issue-payment-to-a-vendor"></a><a name="to-issue-payment-to-a-vendor"></a>Per emettere il pagamento per un fornitore
