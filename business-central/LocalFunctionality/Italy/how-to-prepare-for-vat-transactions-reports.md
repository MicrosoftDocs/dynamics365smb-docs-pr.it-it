...
ms.author: edupont
---
# <a name="prepare-for-vat-transactions-reports-in-the-italian-version" />Preparare i report di transazioni IVA nella versione italiana
...
## <a name="to-set-up-vat-transaction-amounts" />Per impostare gli importi delle transazioni IVA
...
### <a name="to-specify-a-tax-representative-for-a-non-resident-customer" />Per specificare un rappresentante fiscale per un cliente non residente
