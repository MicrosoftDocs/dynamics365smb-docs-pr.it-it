...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses" />Registrare e rimborsare le spese dei dipendenti
...
## <a name="to-record-an-employees-expense" />Per registrare le spese di un dipendente
...
## <a name="to-reimburse-an-employee" />Per rimborsare un dipendente
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries" />Per riconciliare i rimborsi con movimenti contabili del dipendente
