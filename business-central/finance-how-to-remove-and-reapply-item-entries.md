...
ms.author: edupont
---
# <a name="remove-and-reapply-item-ledger-entries" />Rimuovere e ricollegare movimenti contabili articolo
...
## <a name="to-remove-an-item-application-by-using-the-application-worksheet" />Per rimuovere un collegamento articoli tramite il Prospetto collegamento
...
## <a name="to-reapply-an-item-application-by-using-the-application-worksheet" />Per riapplicare un collegamento articoli tramite il Prospetto collegamento
