...
---
# <a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a>Dettagli di progettazione: Trasferimenti nella pianificazione
...
## <a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a>Perché il trasferimento è un caso speciale?
...
## <a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a>I trasferimenti dipendono dalla domanda
...
## <a name="planning-sequence"></a><a name="planning-sequence"></a>Sequenza di pianificazione
...
## <a name="transfer-level-code"></a><a name="transfer-level-code"></a>Codice livello trasferimento
...
## <a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a>Pianificazione dei trasferimenti senza SKU
...
## <a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a>Modificare la quantità con gli impegni
...
## <a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a>Modificare la quantità in una catena di trasferimento
...
## <a name="lead-time-calculation"></a><a name="lead-time-calculation"></a>Calcolo del lead time
...
## <a name="safety-lead-time"></a><a name="safety-lead-time"></a>Lead time di sicurezza
...
## <a name="reschedule"></a><a name="reschedule"></a>Ripianifica
...
## <a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a>Numeri seriali e di lotto nelle catene di trasferimento
