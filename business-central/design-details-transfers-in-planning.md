...
---
# <a name="design-details-transfers-in-planning" />Dettagli di progettazione: Trasferimenti nella pianificazione
...
## <a name="why-is-a-transfer-a-special-case" />Perché il trasferimento è un caso speciale?
...
## <a name="transfers-are-dependent-demand" />I trasferimenti dipendono dalla domanda
...
## <a name="planning-sequence" />Sequenza di pianificazione
...
## <a name="transfer-level-code" />Codice livello trasferimento
...
## <a name="planning-transfers-without-sku" />Pianificazione dei trasferimenti senza SKU
...
## <a name="changing-quantity-with-reservations" />Modificare la quantità con gli impegni
...
## <a name="changing-quantity-in-a-transfer-chain" />Modificare la quantità in una catena di trasferimento
...
## <a name="lead-time-calculation" />Calcolo del lead time
...
## <a name="safety-lead-time" />Lead time di sicurezza
...
## <a name="serial-and-lot-numbers-in-transfer-chains" />Numeri seriali e di lotto nelle catene di trasferimento
