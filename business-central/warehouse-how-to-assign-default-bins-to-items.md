...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Assegnare collocazioni di default ad articoli
...
## <a name="to-assign-a-default-bin-to-an-item" />Per assegnare una collocazione di default a un articolo
...
## <a name="to-change-the-default-bin-for-an-item" />Per modificare la collocazione di default per un articolo
