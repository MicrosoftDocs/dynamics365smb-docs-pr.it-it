...
ms.author: jswymer
---
# <a name="add-contacts-to-segments" />Aggiungere contatti ai segmenti
...
## <a name="to-add-a-contact-to-a-segment" />Per aggiungere un contatto a un segmento
...
## <a name="to-refine-the-number-of-contacts" />Per perfezionare il numero dei contatti
...
## <a name="to-reduce-the-number-of-contacts" />Per ridurre il numero dei contatti
