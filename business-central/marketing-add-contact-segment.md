...
ms.author: jswymer
---
# <a name="add-contacts-to-segments"></a><a name="add-contacts-to-segments"></a><a name="add-contacts-to-segments"></a>Aggiungere contatti ai segmenti
...
## <a name="to-add-a-contact-to-a-segment"></a><a name="to-add-a-contact-to-a-segment"></a><a name="to-add-a-contact-to-a-segment"></a>Per aggiungere un contatto a un segmento
...
## <a name="to-refine-the-number-of-contacts"></a><a name="to-refine-the-number-of-contacts"></a><a name="to-refine-the-number-of-contacts"></a>Per perfezionare il numero dei contatti
...
## <a name="to-reduce-the-number-of-contacts"></a><a name="to-reduce-the-number-of-contacts"></a><a name="to-reduce-the-number-of-contacts"></a>Per ridurre il numero dei contatti
