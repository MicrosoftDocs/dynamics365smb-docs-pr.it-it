...
# <a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a>Creazione di report di Power BI per visualizzare i dati di [!INCLUDE [prod_long](includes/prod_long.md)]
...
## <a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="getdata"></a>Aggiungi [!INCLUDE[prod_short](includes/prod_short.md)] come origine dati in Power BI Desktop
...
## <a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a>Creazione di report accessibili
...
## <a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a>Creazione di report per visualizzare i dati associati a un elenco
...
## <a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="theme"></a>Uso del tema del report [!INCLUDE [prod_short](includes/prod_short.md)] (opzionale)
...
### <a name="download-the-theme"></a><a name="download-the-theme"></a>Scaricare il tema
...
### <a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a>Importare il tema in un report
...
## <a name="publish-reports"></a><a name="publish-reports"></a>Pubblicare i report
...
## <a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a>Distribuire o condividere un report
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a>"Impossibile inserire un record. L'intento di connessione corrente è di sola lettura." errore durante la connessione alla pagina API personalizzata
