...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Impostare prezzi e sconti
...
## <a name="setting-up-prices-and-discounts" />Impostazione di prezzi e sconti
...
## <a name="about-price-lists" />Informazioni sui listini prezzi
...
## <a name="set-up-prices" />Impostare i prezzi
...
## <a name="work-with-invoice-discounts-and-service-charges" />Utilizzare Sconti fattura e Addebito assistenza
...
## <a name="calculating-the-best-price" />Calcolo del prezzo migliore
...
## <a name="see-related-microsoft-training" />Vedi il relativo [training Microsoft](/training/modules/customer-discounts-dynamics-365-business-central/)
