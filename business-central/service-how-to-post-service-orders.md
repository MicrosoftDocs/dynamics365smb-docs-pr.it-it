...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Registrare note di credito e ordini di assistenza
...
## <a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a>Per registrare un ordine di assistenza
...
## <a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a>Per registrare gli ordini di assistenza tramite processo batch
1. Scegli l'icona a forma di ![lampadina che consente di aprire la funzionalità delle informazioni.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Ordini assistenza**, quindi scegli il collegamento correlato.  
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>Per registrare una nota di credito di assistenza
...
## <a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a>Per registrare il consumo da un ordine di assistenza
...
## <a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a>Per registrare spedizioni da ordini di assistenza
...
## <a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a>Per annullare un consumo registrato
...
## <a name="to-post-service-lines"></a><a name="to-post-service-lines"></a>Per registrare le righe di assistenza
