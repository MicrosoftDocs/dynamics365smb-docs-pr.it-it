...
### <a name="sign-up-power-bi" />Iscrizione a Power BI
...
## <a name="work-with-power-bi-reports" />Utilizzare i report Power BI

### <a name="show-reports-on-list-pages" />Visualizza i report sulle pagine di elenco
...
### <a name="switch-reports" />Cambia rapporti
...
### <a name="get-more-reports" />Ottieni più report
...
### <a name="manage-and-modify-reports" />Gestire e modificare i report
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page" />Non è possibile visualizzare un report nella pagina Seleziona report in una pagina di elenco
