...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Utilizzare i report Power BI in [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="get-started"></a><a name="get-started"></a><a name="get-started"></a>Inizia
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Iscrizione a Power BI
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Connettersi a Power BI - una sola volta
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a><a name="from--on-premises"></a>Da [!INCLUDE [prod_short](includes/prod_short.md)] in locale
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Utilizzare i report Power BI

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Visualizza i report sulle pagine di elenco
...
### <a name="switch-reports"></a><a name="switch-reports"></a><a name="switch-reports"></a>Cambia rapporti
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a><a name="get-more-reports"></a>Ottieni più report
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Gestire e modificare i report
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Caricare i report
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>Non è possibile visualizzare un report nella pagina Seleziona report in una pagina di elenco
