...
ms.author: jswymer
---
# <a name="specify-a-default-printer"></a><a name="specify-a-default-printer"></a><a name="default"></a>Specificare una stampante predefinita
...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a><a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a>Imposta una stampante come stampante predefinita per tutti i lavori di stampa
...
## <a name="set-a-default-printer-for-specific-reports"></a><a name="set-a-default-printer-for-specific-reports"></a>Imposta una stampante predefinita per report specifici
...
## <a name="choosing-the-printer-when-running-a-report"></a><a name="choosing-the-printer-when-running-a-report"></a>Scelta della stampante durante l'esecuzione di un report
...
## <a name="sizing-print-jobs"></a><a name="sizing-print-jobs"></a>Ridimensionamento dei lavori di stampa
