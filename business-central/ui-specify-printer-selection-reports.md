...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs" />Imposta una stampante come stampante predefinita per tutti i lavori di stampa
...
## <a name="set-a-default-printer-for-specific-reports" />Imposta una stampante predefinita per report specifici
...
## <a name="choosing-the-printer-when-running-a-report" />Scelta della stampante durante l'esecuzione di un report
...
## <a name="sizing-print-jobs" />Ridimensionamento dei lavori di stampa
