...
ms.author: edupont
---
# <a name="depreciate-or-amortize-fixed-assets" />Ammortamento dei cespiti
...
## <a name="to-calculate-depreciation-automatically" />Per calcolare automaticamente l'ammortamento
...
## <a name="to-post-depreciation-manually-from-the-fixed-asset-gl-journal" />Per registrare un ammortamento manualmente tramite Registrazioni Cespiti in C/G
...
## <a name="to-manage-the-ending-book-value" />Per gestire il valore contabile finale
...
## <a name="to-calculate-allocations-in-the-fixed-asset-gl-journal" />Per calcolare le allocazioni nella registrazione cespiti in C/G
...
## <a name="use-duplication-lists-to-prepare-to-post-to-multiple-depreciation-books" />Utilizzare le liste di duplicazione per preparare la registrazione in diversi registri beni ammortizzabili
...
## <a name="to-post-entries-to-different-depreciation-books" />Per registrare i movimenti in diversi registri beni ammortizzabili
...
## <a name="to-copy-fixed-asset-ledger-entries-between-depreciation-books" />Per copiare i movimenti contabili cespiti tra i registri beni ammortizzabili
