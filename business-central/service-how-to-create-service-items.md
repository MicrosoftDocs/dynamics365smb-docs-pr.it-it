...
ms.author: edupont
---
# <a name="create-service-items" />Creare articoli in assistenza
...
## <a name="to-create-a-service-item" />Per creare un articolo in assistenza
...
## <a name="to-create-service-items-within-a-service-order" />Per creare articoli in assistenza all'interno di un ordine di assistenza
...
## <a name="to-create-a-service-item-when-shipping-items" />Per creare un articolo in assistenza durante la spedizione degli articoli
...
## <a name="to-insert-a-starting-fee-for-a-service-item" />Per inserire una spesa iniziale per un articolo in assistenza
