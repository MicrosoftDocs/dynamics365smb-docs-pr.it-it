...
## <a name="transaction-and-budget-tables" />Tabelle del budget e delle transazioni
...
### <a name="tables-that-contain-the-dimension-set-id-field" />Tabelle che contengono il campo ID set di dimensioni
