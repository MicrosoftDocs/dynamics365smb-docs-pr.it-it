...
ms.author: edupont
---
# <a name="design-details-table-structure"></a><a name="design-details-table-structure"></a><a name="design-details-table-structure"></a>Dettagli di progettazione: Struttura della tabella
...
## <a name="table-480-dimension-set-entry"></a><a name="table-480-dimension-set-entry"></a><a name="table-480-dimension-set-entry"></a>Tabella 480, Movimento set di dimensioni
...
## <a name="table-481-dimension-set-tree-node"></a><a name="table-481-dimension-set-tree-node"></a><a name="table-481-dimension-set-tree-node"></a>Tabella 481, Nodo albero set di dimensioni
...
## <a name="table-482-reclas-dimension-set-buffer"></a><a name="table-482-reclas-dimension-set-buffer"></a><a name="table-482-reclas-dimension-set-buffer"></a>Buffer set di dimensioni di riclassificazione tabella 482
...
## <a name="transaction-and-budget-tables"></a><a name="transaction-and-budget-tables"></a><a name="transaction-and-budget-tables"></a>Tabelle del budget e delle transazioni
...
### <a name="table-83-item-journal-line"></a><a name="table-83-item-journal-line"></a><a name="table-83-item-journal-line"></a>Tabella 83, Righe reg. magazzino
...
### <a name="table-349-dimension-value"></a><a name="table-349-dimension-value"></a><a name="table-349-dimension-value"></a>Tabella 349, Valore dimensioni
Oltre agli altri campi dimensione nella tabella, questi campi sono importanti.  
...
### <a name="tables-that-contain-the-dimension-set-id-field"></a><a name="tables-that-contain-the-dimension-set-id-field"></a><a name="tables-that-contain-the-dimension-set-id-field"></a>Tabelle che contengono il campo ID set di dimensioni
