...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Impostare un indicatore colorato nelle pile per la società o per i singoli utenti
...
### <a name="to-set-up-colored-indicators-on-cues" />Per impostare indicatori colorati nelle pile
