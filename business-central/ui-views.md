...
ms.author: edupont
---
# <a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a>Salvare e personalizzare visualizzazioni elenco
...
## <a name="to-save-a-view"></a><a name="to-save-a-view"></a><a name="to-save-a-view"></a>Per salvare una visualizzazione
...
## <a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a>Per rinominare o rimuovere una visualizzazione
...
## <a name="managing-many-views"></a><a name="managing-many-views"></a><a name="managing-many-views"></a>Gestione di molte visualizzazioni
