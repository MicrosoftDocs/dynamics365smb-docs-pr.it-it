...
# <a name="set-up-customer-price-groups" />Impostare i gruppi di prezzi dei clienti
...
## <a name="how-to-create-sales-prices-for-a-group-of-customers" />Come creare prezzi di vendita per un gruppo di clienti
...
### <a name="to-create-sales-prices-for-a-group-of-customers" />Per creare prezzi di vendita per un gruppo di clienti
...
## <a name="how-to-enter-customer-price-group-codes-on-customer-cards" />Come inserire i codici dei gruppi di prezzo dei clienti sulle carte cliente
...
### <a name="to-enter-customer-price-group-codes-on-a-customer-card" />Per inserire i codici dei gruppi di prezzo dei clienti su una carta cliente
