...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Gestione dei valori delle opzioni mancanti
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>Estensione dei set di opzioni in [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a>Aggiornare la mappatura delle opzioni [!INCLUDE[prod_short](includes/cds_long_md.md)]
