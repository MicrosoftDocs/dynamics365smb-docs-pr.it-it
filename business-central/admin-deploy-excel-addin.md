...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel"></a><a name="get-the-business-central-add-in-for-excel"></a><a name="get-the-business-central-add-in-for-excel"></a>Ottieni il Business Central Add-in per Excel
...
### <a name="about-the-add-in"></a><a name="about-the-add-in"></a><a name="about-the-add-in"></a>Informazioni sull'add-in
...
### <a name="about-deployment-as-an-admin"></a><a name="about-deployment-as-an-admin"></a><a name="about-deployment-as-an-admin"></a>Riguardo all'impiego come amministratore
...
## <a name="preparation-on-premises-only"></a><a name="preparation-on-premises-only"></a><a name="preparation-on-premises-only"></a>Preparazione (solo in sede)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment"></a><a name="deploy-the-add-in-by-using-centralized-deployment"></a><a name="deploy-the-add-in-by-using-centralized-deployment"></a>Distribuire il componente aggiuntivo utilizzando la distribuzione centralizzata
...
### <a name="before-you-begin"></a><a name="before-you-begin"></a><a name="before-you-begin"></a>Prima di iniziare
...
### <a name="set-up-centralized-deployment-of-the-add-in"></a><a name="set-up-centralized-deployment-of-the-add-in"></a><a name="set-up-centralized-deployment-of-the-add-in"></a>Impostare la distribuzione centralizzata dell'add-in
...
## <a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="install"></a>Acquisizione individuale: Installare manualmente l'add-in per uso personale
...
### <a name="configure-the-business-central-connection"></a><a name="configure-the-business-central-connection"></a><a name="configure-the-business-central-connection"></a>Configurare la connessione a Business Central
...
## <a name="prepare-devices-and-network-for-the-excel-add-in"></a><a name="prepare-devices-and-network-for-the-excel-add-in"></a><a name="prepare-devices-and-network-for-the-excel-add-in"></a>Preparare i dispositivi e la rete per l'Add-In di Excel
