...
ms.author: edupont
---
# <a name="about-item-types"></a><a name="about-item-types"></a><a name="about-item-types"></a>Informazioni sui tipi di articolo
...
## <a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a>Metodi di costing per tipi di articoli
...
## <a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a>Catalogo e articoli in assistenza
