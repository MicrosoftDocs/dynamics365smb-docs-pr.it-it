...
description: 'Descrive le guide al setup assistito, i video, gli argomenti della Guida e le pagine da utilizzare per iniziare a utilizzare Business Central.'
author: brentholtorf
ms.author: bholtorf
...
Per ulteriori informazioni su come avviare un business, visualizza la pagina **Setup assistito** dove sono disponibili guide al setup assistito, video o argomenti di assistenza per alcune attività di setup. Per accedere alla pagina, scegli [questo collegamento](https://businesscentral.dynamics.com/?page=1801).  
...
>
> La prima volta che si accede, si utilizza l'esperienza **Essential**. Per ulteriori informazioni, vedi [Modifica delle funzionalità visualizzate](ui-experiences.md).
