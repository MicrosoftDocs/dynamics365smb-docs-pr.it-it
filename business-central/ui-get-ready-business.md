...
ms.author: edupont
---
# <a name="get-ready-for-doing-business" />Preparazione al business
...
## <a name="teaching-tips-and-tours" />Suggerimenti per l'insegnamento e tour
...
## <a name="role-specific-home-pages" />Home page specifiche del ruolo
...
## <a name="company-information" />Informazioni società
...
## <a name="adding-users-and-permissions" />Aggiunta di utenti e permessi
...
### <a name="set-up-your-company-in-" />Configurare la società in [!INCLUDE[prod_short](includes/prod_short.md)]
