...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows" />Procedura: Utilizzare i workflow di approvazione
...
## <a name="request-a-record-approval" />Richiesta di un'approvazione di record
...
## <a name="cancel-approval-requests" />Annullare le richieste di approvazione
...
## <a name="approve-or-reject-approval-requests" />Approvare o rifiutare le richieste di approvazione
...
## <a name="delegate-approval-requests" />Delega richieste di approvazione
...
## <a name="manage-overdue-approval-requests" />Gestire le richieste di approvazione scadute
