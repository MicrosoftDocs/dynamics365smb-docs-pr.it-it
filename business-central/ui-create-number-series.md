...
ms.author: edupont
---
# <a name="create-number-series"></a><a name="create-number-series"></a>Creazione di numerazioni
...
## <a name="gaps-in-number-series"></a><a name="gaps-in-number-series"></a>Interruzioni nelle numerazioni
...
## <a name="behavior-of-the-no-field-on-documents-and-cards"></a><a name="behavior-of-the-no-field-on-documents-and-cards"></a>Comportamento del campo Nr. in documenti e schede
...
## <a name="to-create-a-new-number-series"></a><a name="to-create-a-new-number-series"></a>Per creare nuove numerazioni
...
## <a name="to-create-relationships-between-number-series"></a><a name="to-create-relationships-between-number-series"></a>Per creare relazioni tra numerazioni
...
## <a name="to-set-up-where-a-number-series-is-used"></a><a name="to-set-up-where-a-number-series-is-used"></a>Per impostare le aree in cui la numerazione viene utilizzata
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
