...
ms.author: edupont
---
# <a name="create-number-series" />Creazione di numerazioni
...
## <a name="gaps-in-number-series" />Interruzioni nelle numerazioni
...
## <a name="behavior-of-the-no-field-on-documents-and-cards" />Comportamento del campo Nr. in documenti e schede
...
## <a name="to-create-a-new-number-series" />Per creare nuove numerazioni
...
## <a name="to-create-relationships-between-number-series" />Per creare relazioni tra numerazioni
...
## <a name="to-set-up-where-a-number-series-is-used" />Per impostare le aree in cui la numerazione viene utilizzata
...
## <a name="see-related-microsoft-training" />Vedi il relativo [training Microsoft](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
