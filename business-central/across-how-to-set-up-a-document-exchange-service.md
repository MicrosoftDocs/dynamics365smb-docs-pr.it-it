...
ms.author: edupont
---
# <a name="set-up-a-document-exchange-service" />Impostare un servizio di scambio documenti
...
## <a name="connecting-with-trading-partners" />Connessione con i partner commerciali
...
## <a name="to-connect-to-the-business-central-integration-app-on-tradeshift" />Per connettersi all'applicazione Business Central Integration su Tradeshift
...
## <a name="to-connect-to-a-document-exchange-service" />Per connettersi a un servizio di scambio di documenti
...
## <a name="settings-for-business-central-on-premises" />Impostazioni per Business Central On-Premises
...
## <a name="see-related-microsoft-trainingtrainingmoduleselectronic-documents-dynamics-365-business-central" />Vedi il relativo [training Microsoft](/training/modules/electronic-documents-dynamics-365-business-central/)
