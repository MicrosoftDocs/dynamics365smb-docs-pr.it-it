...
ms.author: edupont
---
# <a name="register-new-items" />Registrare nuovi articoli
...
## <a name="to-create-a-new-item-card" />Per creare una nuova scheda articolo
...
### <a name="to-save-the-item-card-as-a-template" />Per salvare la scheda articolo come modello
...
### <a name="items-used-in-production-orders" />Articoli utilizzati negli ordini di produzione
...
## <a name="to-set-up-multiple-vendors-for-an-item" />Per impostare più fornitori per un articolo
...
## <a name="set-up-item-substitutions" />Configurare articoli sostitutivi
...
### <a name="to-make-an-item-substitution" />Per sostituire un articolo
...
## <a name="categories-attributes-and-variants" />Categorie, attributi e varianti

[!INCLUDE[inventory_variant](includes/inventory_variant.md)]

Ulteriori informazioni sulle varianti in [Gestire le varianti di prodotto](inventory-item-variants.md).  

## <a name="deleting-item-cards" />Eliminazione delle schede articolo
...
## <a name="manage-inventory-in-warehouses" />Gestione del magazzino in warehouse
