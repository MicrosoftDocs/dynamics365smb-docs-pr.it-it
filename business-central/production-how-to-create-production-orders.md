...
ms.author: edupont
---
# <a name="create-production-order-headers"></a><a name="create-production-order-headers"></a><a name="create-production-order-headers"></a>Creare le testate degli ordini di produzione
...
## <a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a>Per creare una testata degli ordini di produzione
