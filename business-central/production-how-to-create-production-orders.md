...
ms.author: edupont
---
# <a name="create-production-order-headers" />Creare le testate degli ordini di produzione
...
## <a name="to-create-a-production-order-header" />Per creare una testata degli ordini di produzione
