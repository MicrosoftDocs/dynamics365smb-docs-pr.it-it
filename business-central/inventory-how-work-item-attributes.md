...
ms.author: edupont
---
# <a name="work-with-item-attributes" />Usare gli attributi articolo
...
## <a name="create-item-attributes" />Creare gli attributi articolo
...
## <a name="create-values-for-item-attributes-of-type-option" />Creare i valori per gli attributi articolo di tipo Opzione
...
## <a name="assign-item-attributes-to-items" />Assegnare attributi articolo agli articoli
...
## <a name="assign-item-attributes-to-item-categories" />Assegnare attributi articolo alle categorie articoli
...
## <a name="filter-by-item-attributes" />Filtrare per attributi articolo
