...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign"></a><a name="walkthrough-conducting-a-sales-campaign"></a><a name="walkthrough-conducting-a-sales-campaign"></a>Procedura dettagliata: Conduzione di una campagna di vendita
...
## <a name="setting-up-a-campaign"></a><a name="setting-up-a-campaign"></a><a name="setting-up-a-campaign"></a>Impostazione della campagna
...
### <a name="to-set-up-a-campaign"></a><a name="to-set-up-a-campaign"></a><a name="to-set-up-a-campaign"></a>Per impostare una campagna
...
## <a name="selecting-the-target-audience"></a><a name="selecting-the-target-audience"></a><a name="selecting-the-target-audience"></a>Selezione del target
...
### <a name="to-create-a-segment-with-the-relevant-contacts"></a><a name="to-create-a-segment-with-the-relevant-contacts"></a><a name="to-create-a-segment-with-the-relevant-contacts"></a>Per creare un segmento con i contatti scelti
...
### <a name="to-save-your-segmentation-criteria"></a><a name="to-save-your-segmentation-criteria"></a><a name="to-save-your-segmentation-criteria"></a>Per salvare i criteri di segmentazione
...
### <a name="to-remove-contacts-from-the-segment"></a><a name="to-remove-contacts-from-the-segment"></a><a name="to-remove-contacts-from-the-segment"></a>Per rimuovere contatti dal segmento
...
### <a name="to-bring-back-the-removed-contacts"></a><a name="to-bring-back-the-removed-contacts"></a><a name="to-bring-back-the-removed-contacts"></a>Per riportare i contatti rimossi
...
## <a name="linking-a-segment-to-a-campaign"></a><a name="linking-a-segment-to-a-campaign"></a><a name="linking-a-segment-to-a-campaign"></a>Collegamento di un segmento a una campagna
...
### <a name="to-link-a-segment-to-the-campaign"></a><a name="to-link-a-segment-to-the-campaign"></a><a name="to-link-a-segment-to-the-campaign"></a>Per collegare un segmento a una campagna
...
## <a name="sending-letters-and-email-messages-to-contacts"></a><a name="sending-letters-and-email-messages-to-contacts"></a><a name="sending-letters-and-email-messages-to-contacts"></a>Invio di lettere e messaggi di posta elettronica ai contatti
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact"></a><a name="to-use-a-segment-to-send-a-letter-to-a-contact"></a><a name="to-use-a-segment-to-send-a-letter-to-a-contact"></a>Per utilizzare un segmento per l'invio di una lettera a un contatto
...
### <a name="to-send-an-email-message-to-a-contact"></a><a name="to-send-an-email-message-to-a-contact"></a><a name="to-send-an-email-message-to-a-contact"></a>Per inviare un messaggio di posta elettronica a un contatto
...
## <a name="registering-campaign-responses"></a><a name="registering-campaign-responses"></a><a name="registering-campaign-responses"></a>Registrazione delle risposte alla campagna
...
### <a name="to-register-campaign-responses"></a><a name="to-register-campaign-responses"></a><a name="to-register-campaign-responses"></a>Per registrare le risposte alla campagna
