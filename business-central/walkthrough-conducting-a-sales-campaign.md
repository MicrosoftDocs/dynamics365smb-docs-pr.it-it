...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Procedura dettagliata: Conduzione di una campagna di vendita
...
## <a name="setting-up-a-campaign" />Impostazione della campagna
...
### <a name="to-set-up-a-campaign" />Per impostare una campagna
...
## <a name="selecting-the-target-audience" />Selezione del target
...
### <a name="to-create-a-segment-with-the-relevant-contacts" />Per creare un segmento con i contatti scelti
...
### <a name="to-save-your-segmentation-criteria" />Per salvare i criteri di segmentazione
...
### <a name="to-remove-contacts-from-the-segment" />Per rimuovere contatti dal segmento
...
### <a name="to-bring-back-the-removed-contacts" />Per riportare i contatti rimossi
...
## <a name="linking-a-segment-to-a-campaign" />Collegamento di un segmento a una campagna
...
### <a name="to-link-a-segment-to-the-campaign" />Per collegare un segmento a una campagna
...
## <a name="sending-letters-and-email-messages-to-contacts" />Invio di lettere e messaggi di posta elettronica ai contatti
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact" />Per utilizzare un segmento per l'invio di una lettera a un contatto
...
### <a name="to-send-an-email-message-to-a-contact" />Per inviare un messaggio di posta elettronica a un contatto
...
## <a name="registering-campaign-responses" />Registrazione delle risposte alla campagna
...
### <a name="to-register-campaign-responses" />Per registrare le risposte alla campagna
