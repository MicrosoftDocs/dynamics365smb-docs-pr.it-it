...
## <a name="installing-the-business-central-app-by-using-centralized-deployment" />Installare l'applicazione Business Central utilizzando la distribuzione centralizzata
...
## <a name="managing-privacy-and-compliance" />Gestione della privacy e della conformità
...
### <a name="restricting-sharing-of-cards" />Limitazione della condivisione delle schede
...
### <a name="responding-to-data-requests" />Rispondere alle richieste di dati
...
## <a name="show-or-hide-record-data-on-cards" />Mostrare o nascondere i dati dei record sulle schede
