...
# <a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a>Gestione dell'integrazione di Microsoft Teams con [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="minimum-requirements"></a><a name="minimum-requirements"></a><a name="minimum-requirements"></a>Requisiti minimi
...
### <a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a>Gestione dell'app [!INCLUDE [prod_short](includes/prod_short.md)] (facoltativo)
...
### <a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a>Requisiti minimi
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a>Installare l'applicazione Business Central utilizzando la distribuzione centralizzata
...
## <a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a>Gestione della privacy e della conformità
...
### <a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a>Informazioni su dove vengono memorizzate le schede di [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a>Limitazione della condivisione delle schede
...
### <a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a>Rispondere alle richieste di dati
...
## <a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a>Mostrare o nascondere i dati dei record sulle schede
