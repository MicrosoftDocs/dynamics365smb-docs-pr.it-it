...
---
# <a name="set-up-online-maps" />Impostare le mappe online
...
## <a name="set-up-the-online-map-feature" />Impostare la funzionalità delle mappe online
...
### <a name="customize-the-online-map-provider-features" />Personalizza le funzionalità del provider di mappe online
