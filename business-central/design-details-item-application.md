...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a><a name="design-details-item-application"></a>Dettagli di progettazione: Collegamento articoli
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a><a name="inventory-increase"></a>Aumento di magazzino
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a><a name="inventory-decrease"></a>Riduzione di magazzino
...
## <a name="fixed-application"></a><a name="fixed-application"></a><a name="fixed-application"></a>Collegamento fisso
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Esempio: collegamento fisso nel reso di acquisto
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Esempio: collegamento fisso con costo medio
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Esempio: collegamento fisso nel reso di vendita
...
## <a name="transfer-application"></a><a name="transfer-application"></a><a name="transfer-application"></a>Applicazione trasferimento
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Esempio: metodo di costing medio
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Esempio: Metodo di costing standard
...
## <a name="reapplication"></a><a name="reapplication"></a><a name="reapplication"></a>Nuovo collegamento
