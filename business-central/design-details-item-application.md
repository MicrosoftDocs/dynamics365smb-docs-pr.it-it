...
ms.author: edupont
---
# <a name="design-details-item-application" />Dettagli di progettazione: Collegamento articoli
...
## <a name="inventory-increase" />Aumento di magazzino
...
## <a name="inventory-decrease" />Riduzione di magazzino
...
## <a name="fixed-application" />Collegamento fisso
...
### <a name="example--fixed-application-in-purchase-return" />Esempio: collegamento fisso nel reso di acquisto
...
### <a name="example--fixed-application-with-average-cost" />Esempio: collegamento fisso con costo medio
...
### <a name="example--fixed-application-in-sales-return" />Esempio: collegamento fisso nel reso di vendita
...
## <a name="transfer-application" />Applicazione trasferimento
...
### <a name="example--average-costing-method" />Esempio: metodo di costing medio
...
### <a name="example--standard-costing-method" />Esempio: Metodo di costing standard
...
## <a name="reapplication" />Nuovo collegamento
