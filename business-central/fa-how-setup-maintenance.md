...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a>Per impostare la manutenzione cespiti
...
## <a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a>Per impostare le informazioni generali di manutenzione
...
## <a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a>Per impostare i codici di manutenzione
...
## <a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a>Per impostare i conti spesa manutenzione
