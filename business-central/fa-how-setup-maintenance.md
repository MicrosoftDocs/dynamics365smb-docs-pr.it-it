...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Per impostare la manutenzione cespiti
...
## <a name="to-set-up-general-maintenance-information" />Per impostare le informazioni generali di manutenzione
...
## <a name="to-set-up-maintenance-codes" />Per impostare i codici di manutenzione
...
## <a name="to-set-up-maintenance-expense-accounts" />Per impostare i conti spesa manutenzione
