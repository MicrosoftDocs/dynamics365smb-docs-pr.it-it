...
# <a name="troubleshooting-accessing-camera-and-location" />Risoluzione dei problemi: accesso alla fotocamera e alla posizione
...
## <a name="device-must-have-camera-and-location-capabilities" />Il dispositivo deve avere fotocamera e funzionalità di posizione
...
## <a name="access-permissions-not-enabled" />Autorizzazioni di accesso non abilitate
...
## <a name="web-client-connection-not-secure" />Connessione client Web non protetta
...
## <a name="work-with-virtualization-technologies" />Utilizzare le tecnologie di virtualizzazione
