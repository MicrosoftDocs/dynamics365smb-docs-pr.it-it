...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Impostazione della contabilità industriale

Prima di iniziare a utilizzare la contabilità industriale, è necessario effettuare attività di impostazione.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Saldi tra tipo di costo, centro di costo e oggetto di costo
...
## <a name="setting-up-cost-types" />Impostazione di tipi di costo
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Per trasferire il piano dei conti della contabilità generale al piano dei tipi di costo
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Per impostare nuovi tipi di costo nella pagina Piano dei tipi di costo
...
### <a name="to-update-cost-types" />Per aggiornare i tipi di costo
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Definizione della relazione tra i tipi di costo e i conti di contabilità generale
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Relazione tra i conti di contabilità generale e i tipi di costo
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Tipi di costo senza una relazione con la contabilità generale
...
## <a name="setting-up-cost-centers" />Impostazione di centri di costo
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Per trasferire i valori dimensioni nella contabilità generale al grafico dei centri di costo
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Per creare nuovi centri di costo nella pagina Piano dei centri di costo
...
## <a name="setting-up-cost-objects" />Impostazione di oggetti di costo
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Per trasferire i valori dimensioni dalla contabilità generale al grafico degli oggetti di costo
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Per creare nuovi oggetti di costo nella pagina Piano degli oggetti di costo
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Definizione dei centri di costo e degli oggetti di costo per il piano dei conti
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts" />Definizione dei valori dimensioni di default per i conti di contabilità generale
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Definizione dei valori dimensioni per i costi generali e diretti
...
## <a name="see-related-microsoft-trainingtrainingmodulescost-accounting-dynamics-365-business-central" />Vedi il relativo [training Microsoft](/training/modules/cost-accounting-dynamics-365-business-central/)
