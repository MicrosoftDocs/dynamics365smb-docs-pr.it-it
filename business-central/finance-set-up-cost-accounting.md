---
title: Impostazione contabilità industriale
...
# <a name="set-up-cost-accounting"></a>Impostazione contabilità industriale
...
## <a name="set-up-cost-types"></a>Imposta i tipi di costo
...
È possibile scegliere l'azione  **Aggiorna dimensioni contabilità costi** per aggiornare le dimensioni contabilità costi.
1. Scegli la ![lampadina che apre la funzione Dimmi 2.](media/ui-search/search_small.png "Dimmi cosa vuoi fare") immetti **Piano dei centri di costo**, quindi scegli il collegamento correlato.  
...
> [!NOTE]  
>  Per assicurarti che il centro di costo e l'oggetto di costo predefiniti impostati in contabilità generale vengano automaticamente trasferiti alla contabilità dei costi, Seleziona seleziona la casella di controllo  **Controlla registrazioni Co.Ge.** nella pagina  **Impostazione contabilità dei costi** .
