...
# <a name="sharing-business-central-records-and-page-links-in-microsoft-teams"></a><a name="sharing-business-central-records-and-page-links-in-microsoft-teams"></a>Condivisione di record e link di pagine di Business Central in Microsoft Teams
...
## <a name="include-and-view-a-business-central-card-in-a-teams-conversation"></a><a name="include-and-view-a-business-central-card-in-a-teams-conversation"></a>Includere e visualizzare una scheda Business Central in una conversazione Teams
...
### <a name="include-a-business-central-card-in-a-teams-conversation"></a><a name="include-a-business-central-card-in-a-teams-conversation"></a>Includere una scheda Business Central in una conversazione di Teams
...
### <a name="view-card-details"></a><a name="view-card-details"></a>Visualizzare i dettagli della scheda
...
## <a name="share-a-link-to-page-from-business-central-to-teams"></a><a name="share-a-link-to-page-from-business-central-to-teams"></a><a name="share-link"></a>Condividi un link alla pagina da Business Central a Teams
...
### <a name="prerequisites-1"></a><a name="prerequisites-1"></a>Prerequisiti
...
### <a name="share-a-link"></a><a name="share-a-link"></a>Condividi un link
