...
# <a name="sharing-business-central-records-and-page-links-in-microsoft-teams" />Condivisione di record e link di pagine di Business Central in Microsoft Teams
...
## <a name="include-and-view-a-business-central-card-in-a-teams-conversation" />Includere e visualizzare una scheda Business Central in una conversazione Teams
...
### <a name="include-a-business-central-card-in-a-teams-conversation" />Includere una scheda Business Central in una conversazione di Teams
...
### <a name="view-card-details" />Visualizzare i dettagli della scheda
...
### <a name="share-a-link" />Condividi un link
