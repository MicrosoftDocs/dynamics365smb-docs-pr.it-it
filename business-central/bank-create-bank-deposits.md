...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Creare depositi bancari
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Numerazione e depositi forfettari
...
### <a name="general-journal-templates-for-bank-deposits" />Definizione registrazioni COGE per depositi bancari
...
## <a name="dimensions-on-bank-deposit-lines" />Dimensioni nelle righe di deposito bancario
...
## <a name="create-a-bank-deposit" />Creare un deposito bancario
...
## <a name="finding-posted-bank-deposits" />Ricerca dei depositi bancari registrati
...
## <a name="reversing-a-posted-bank-deposit" />Storno di un deposito bancario registrato
