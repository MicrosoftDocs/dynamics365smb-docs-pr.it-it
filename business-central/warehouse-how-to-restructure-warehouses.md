...
ms.author: edupont
---
# <a name="restructure-warehouses" />Ristrutturare warehouse
...
## <a name="to-restructure-a-basic-warehouse-that-uses-bins-only" />Per ristrutturare una warehouse di base in cui vengono utilizzate solo collocazioni
...
## <a name="to-restructure-an-advanced-warehouse-that-uses-directed-put-away-and-pick" />Per ristrutturare una warehouse avanzata in cui vengono utilizzati stoccaggi e prelievi guidati
...
## <a name="to-delete-a-bin" />Per eliminare una collocazione
...
## <a name="to-rename-a-bin-and-change-the-bin-code-in-all-records" />Per rinominare una collocazione e modificare il codice collocazione in tutti i record
