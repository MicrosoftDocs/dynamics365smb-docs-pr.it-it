...
ms.author: edupont
---
# <a name="transferring-and-posting-cost-entries" />Trasferimento e registrazione di movimenti di costi
...
## <a name="criteria-for-transferring-general-ledger-entries-to-cost-entries" />Criteri per trasferire movimenti C/G ai movimenti di costi
...
## <a name="transferring-general-ledger-entries-to-cost-entries" />Trasferire movimenti C/G ai movimenti di costi
...
### <a name="to-prepare-the-transfer" />Per preparare il trasferimento
...
### <a name="to-transfer-general-ledger-entries-to-cost-entries" />Per trasferire movimenti C/G a movimenti di costi
...
## <a name="automatic-transfer-and-combined-entries" />Trasferimento automatico e movimenti combinati
...
## <a name="results-of-transferring-general-ledger-entries-to-cost-entries" />Risultati del trasferimento di movimenti C/G a movimenti di costi
...
### <a name="general-ledger-entries" />Movimenti C/G
...
### <a name="cost-entries" />Movimenti di costi
...
### <a name="cost-register" />Registro costi
...
## <a name="see-related-microsoft-trainingtrainingmodulestransfer-gl-entries-dynamics-365-business-central" />Vedi il relativo [training Microsoft](/training/modules/transfer-gl-entries-dynamics-365-business-central/)
