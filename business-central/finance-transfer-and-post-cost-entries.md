---
title: Trasferimento e registrazione delle voci di costo
...
# <a name="transferring-and-posting-cost-entries"></a>Trasferimento e registrazione delle voci di costo
...
## <a name="criteria-for-transferring-general-ledger-entries-to-cost-entries"></a>Criteri per il trasferimento delle voci contabilità generale alle voci di costo

È importante comprendere i criteri per il trasferimento delle voci contabilità generale alle voci di costo. Durante il trasferimento, il processo batch **Trasferisci movimenti C/G a CA** utilizza i seguenti criteri per determinare se e come i movimenti C/G vengono trasferiti.  
...
Le voci contabilità generale non vengono trasferite se:  

- Le voci hanno valori di dimensione che non corrispondono a un centro di costo o a un oggetto di costo.  
...
- Le voci hanno un account contabilità generale che non è del tipo **Conto economico**.  
- Le voci hanno un account contabilità generale a cui non è assegnato alcun tipo di costo.  
...
## <a name="transferring-general-ledger-entries-to-cost-entries"></a>Trasferimento delle voci contabilità generale alle voci di costo
...
2.  Scegliere **Sì** per avviare il trasferimento. Il processo trasferisce tutte le voci contabilità generale che non sono ancora state trasferite.  
...
## <a name="automatic-transfer-and-combined-entries"></a>Trasferimento automatico e voci combinate
...
## <a name="results-of-transferring-general-ledger-entries-to-cost-entries"></a>Risultati del trasferimento delle voci contabilità generale alle voci di costo
...
### <a name="cost-register"></a>Registro dei costi

Nella tabella **Registro costi**, [!INCLUDE[prod_short](includes/prod_short.md)] crea un movimento con il trasferimento di origine dalla contabilità generale. La voce registra il primo e l'ultimo numero di voce delle voci contabilità generale trasferite, oltre al primo e all'ultimo numero di voce delle voci di costo create.
