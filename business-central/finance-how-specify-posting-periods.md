...
ms.author: edupont
---
# <a name="specify-posting-periods"></a><a name="specify-posting-periods"></a><a name="specify-posting-periods"></a>Specificare i periodi di registrazione

Utilizzare i periodi di registrazione per specificarne quando gli utenti possono registrare nella contabilità generale.  

## <a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a>Per specificare i periodi di registrazione
