...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Registrare più documenti contemporaneamente
...
## <a name="to-post-multiple-purchase-orders-immediately" />Per registrare immediatamente più ordini di acquisto
...
## <a name="to-batch-post-multiple-purchase-orders" />Per eseguire registrazioni batch di ordini di acquisto
...
## <a name="to-set-up-background-posting-with-job-queues" />Per configurare la registrazione background con le code processi
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Per visualizzare lo stato di un documento di vendita o di acquisto
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Per creare un movimento coda processi per la registrazione batch di ordini di vendita
...
## <a name="monitor-the-job-queue" />Monitorare la coda processi
