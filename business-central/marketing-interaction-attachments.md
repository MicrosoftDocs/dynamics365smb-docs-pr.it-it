---
title: Allegati per le interazioni
...
---
# <a name="attachments-for-interactions"></a>Allegati per le interazioni
...
Gli allegati possono essere praticamente qualsiasi tipo di file, come documenti Word, presentazioni Powerpoint, file Excel o file di testo e così via.
...
Con gli allegati puoi effettuare le seguenti operazioni:

* **Apri**: puoi avviare il programma associato, ad esempio Microsoft Word, e il documento viene visualizzato. Sarà quindi possibile modificare il documento.
* **Importa**: puoi importare qualsiasi tipo di allegato. È ad esempio possibile effettuare la scansione di una lettera ricevuta, importarla e allegarla all'interazione che ne registra la ricezione.
* **Esporta**: puoi esportare allegati in una posizione del file su disco.
* **Elimina**: puoi eliminare l'allegato corrente da un modello interazione.
* **Copia**: puoi copiare allegati da un altro modello interazione.
