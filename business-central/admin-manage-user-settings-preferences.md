...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences"></a><a name="manage-user-settings-and-preferences"></a><a name="manage-user-settings-and-preferences"></a>Gestire le impostazioni e le preferenze dell'utente
...
## <a name="types-of-user-settings"></a><a name="types-of-user-settings"></a><a name="types-of-user-settings"></a>Tipi di impostazioni utente
...
## <a name="overview-of-all-user-specific-changes"></a><a name="overview-of-all-user-specific-changes"></a><a name="overview-of-all-user-specific-changes"></a>Panoramica di tutte le modifiche specifiche dell'utente
...
## <a name="to-review-or-delete-user-personalizations"></a><a name="to-review-or-delete-user-personalizations"></a><a name="to-review-or-delete-user-personalizations"></a>Per rivedere o eliminare le personalizzazioni degli utenti
