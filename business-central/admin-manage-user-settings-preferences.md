...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Gestire le impostazioni e le preferenze dell'utente
...
## <a name="types-of-user-settings" />Tipi di impostazioni utente
...
## <a name="overview-of-all-user-specific-changes" />Panoramica di tutte le modifiche specifiche dell'utente
...
## <a name="to-review-or-delete-user-personalizations" />Per rivedere o eliminare le personalizzazioni degli utenti
