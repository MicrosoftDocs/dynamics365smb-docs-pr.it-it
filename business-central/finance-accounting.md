...
## <a name="accountant-role-center" />Gestione ruolo utente Contabile
...
## <a name="company-hub" />Hub aziendale
...
#### <a name="to-add-your-accountant-as-a-guest-user" />Per aggiungere il contabile come utente guest
...
#### <a name="to-add-the-accountant-to-the-right-company" />Per aggiungere il contabile alla società giusta
