...
ms.author: edupont
---
# <a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a>Esperienze di contabile in [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="accountant-role-center"></a><a name="accountant-role-center"></a><a name="accountant-role-center"></a>Gestione ruolo utente Contabile
...
## <a name="company-hub"></a><a name="company-hub"></a><a name="company-hub"></a>Hub aziendale
...
## <a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviteaccountant"></a>Invitare il contabile esterno in [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a>Aggiunta del contabile a Microsoft 365 nel portale di Azure
...
#### <a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a>Per aggiungere il contabile come utente guest
...
#### <a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a>Per concedere al contabile l'accesso a [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a>Importazione del nuovo utente in [!INCLUDE[prod_short](includes/prod_short.md)]
...
#### <a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a>Per aggiungere il contabile alla società giusta
