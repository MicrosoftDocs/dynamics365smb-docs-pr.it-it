...
---
# <a name="mapping-the-tables-and-fields-to-synchronize" />Mapping delle tabelle e dei campi da sincronizzare
...
## <a name="mapping-integration-tables" />Mapping delle tabelle di integrazione
...
### <a name="additional-mappings" />Mapping aggiuntivi
...
### <a name="strategies-for-auto-resolving-conflicts" />Strategie per la risoluzione automatica dei conflitti
...
## <a name="mapping-integration-fields" />Mapping dei campi di integrazione
...
### <a name="handle-differences-in-field-values" />Gestione delle differenze nei valori di campo
...
### <a name="handle-missing-option-values" />Gestione dei valori delle opzioni mancanti
...
## <a name="couple-records" />Associare i record
...
## <a name="filter-records-and-rows" />Filtro di record e righe
...
## <a name="create-new-records" />Creare nuovi record
...
### <a name="to-create-new-records-during-synchronization" />Per creare nuovi record durante la sincronizzazione
...
## <a name="use-configuration-templates-on-table-mappings" />Utilizzare i modelli di configurazione sui mapping di tabella
...
### <a name="to-specify-configuration-templates-on-a-table-mapping" />Per specificare i modelli di configurazione in un mapping di tabella
