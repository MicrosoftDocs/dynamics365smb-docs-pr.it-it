...
---
# <a name="put-items-away-with-warehouse-put-aways" />Eseguire lo stoccaggio con Stoccaggi warehouse:
...
## <a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet" />Per creare documenti di stoccaggio in blocco con i prospetti stoccaggi
...
## <a name="to-create-a-put-away-from-a-posted-receipt" />Per creare uno stoccaggio a partire dal carico registrato
...
## <a name="to-put-items-away" />Per stoccare gli articoli
