...
# <a name="cash-flow-overview" />Panoramica del flusso di cassa
...
## <a name="definition-of-cash-flow" />Definizione del flusso di cassa
...
## <a name="work-with-cash-flow" />Utilizzare il flusso di cassa
...
## <a name="making-a-cash-flow-forecast" />Esecuzione delle previsioni flusso di cassa
