...
# <a name="cash-flow-overview"></a><a name="cash-flow-overview"></a>Panoramica del flusso di cassa
...
## <a name="definition-of-cash-flow"></a><a name="definition-of-cash-flow"></a>Definizione del flusso di cassa
...
## <a name="work-with-cash-flow"></a><a name="work-with-cash-flow"></a>Utilizzare il flusso di cassa
...
## <a name="making-a-cash-flow-forecast"></a><a name="making-a-cash-flow-forecast"></a>Esecuzione delle previsioni flusso di cassa
