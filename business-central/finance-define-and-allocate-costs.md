...
## <a name="set-up-allocation-source-and-targets"></a>Imposta la fonte e gli obiettivi di allocazione
...
## <a name="to-set-filters-for-dynamic-allocation-bases"></a>Per impostare filtri per basi di allocazione dinamica
...
### <a name="set-filters"></a>Imposta filtri
...
|Articoli acquistati (importo)|Nr. articolo|Sì|Sì|Sì|Categoria registrazione magazzino|

## <a name="scenario-1-defining-static-allocations-based-on-allocation-ratio"></a>Scenario 1: Definizione di allocazioni statiche in base al rapporto di allocazione
...
In questo articolo viene descritto come definire tre nuovi oggetti di costo target di allocazione per il centro di costo PROD di origine allocazione utilizzando il rapporto di allocazione stabilito 5:2:4. I tre oggetti di costo di destinazione sono ACCESSORI, VERNICE e ARREDI.  
...
## <a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a>Scenario 2: Definizione di allocazioni dinamiche in base agli articoli venduti
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Allocazione costi**, quindi scegli il collegamento correlato.  
2. Nella pagina **Allocazione costi** scegliere l'azione **Nuovo**.  
3. Nel campo **ID** seleziona <kbd>INVIO</kbd> o immetti un ID.  
4. Nel campo **Livello** immettere **1**.  
5. Nei campi **Data di inizio validità** e **Data di fine validità**, immettere le date appropriate.  
