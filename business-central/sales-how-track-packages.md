...
ms.author: edupont
---
# <a name="track-packages"></a><a name="track-packages"></a><a name="track-packages"></a>Rintracciare i colli
...
## <a name="to-track-a-package"></a><a name="to-track-a-package"></a><a name="to-track-a-package"></a>Per rintracciare un collo
