...
ms.author: edupont
---
# <a name="design-details-revaluation" />Dettagli di progettazione: Rivalutazione
...
## <a name="calculating-the-revaluable-quantity" />Calcolo della quantità rivalutabile
...
## <a name="expected-cost-in-revaluation" />Costo previsto nella Rivalutazione
...
## <a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation" />Determinare se una riduzione di magazzino è interessata dalla rivalutazione
...
## <a name="wip-inventory-revaluation" />Rivalutazione del magazzino WIP
