...
---
# <a name="analyze-list-page-and-query-data-using-data-analysis-mode"></a>Analizzare la pagina elenco e dati di query utilizzando la modalità di analisi dei dati
...
## <a name="work-with-data-analysis-mode"></a>Lavorare con la modalità di analisi dei dati
