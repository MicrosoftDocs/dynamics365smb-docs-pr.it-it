...
---
# <a name="analyze-list-data-using-data-analysis-mode"></a><a name="analyze-list-data-using-data-analysis-mode"></a>Analizzare i dati di elenco utilizzando la modalità di analisi dei dati
...
## <a name="work-with-data-analysis-mode"></a><a name="work-with-data-analysis-mode"></a>Lavorare con la modalità di analisi dei dati
...
### <a name="data-area-1"></a><a name="data-area-1"></a>Area dati (1)
...
### <a name="summary-bar-2"></a><a name="summary-bar-2"></a>Barra di riepilogo (2)
...
### <a name="columns-3"></a><a name="columns-3"></a>Colonne (3)
...
### <a name="analysis-filters-4"></a><a name="analysis-filters-4"></a>Filtri analisi (4)
...
### <a name="tabs-5"></a><a name="tabs-5"></a>Schede (5)
...
## <a name="pivot-mode"></a><a name="pivot-mode"></a>Modalità pivot
...
## <a name="limitations"></a><a name="limitations"></a>Limiti
