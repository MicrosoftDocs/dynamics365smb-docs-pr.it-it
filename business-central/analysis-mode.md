...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Analizzare i dati di elenco utilizzando la modalità di analisi dei dati
...
## <a name="prerequisite" />Prerequisiti
...
## <a name="work-with-data-analysis-mode" />Lavorare con la modalità di analisi dei dati
...
## <a name="pivot-mode" />Modalità pivot
