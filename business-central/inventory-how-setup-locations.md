...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a><a name="set-up-locations"></a>Impostare le ubicazioni
...
## <a name="location-cards"></a><a name="location-cards"></a><a name="location-cards"></a>Schede Ubicazione
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>Per impostare un'ubicazione
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>Per creare i percorsi di trasferimento
...
## <a name="bins"></a><a name="bins"></a><a name="bins"></a>Collocazioni
...
## <a name="zones"></a><a name="zones"></a><a name="zones"></a>Zone
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Dimensioni predefinite per le ubicazioni
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Esempio di dimensioni predefinite per le ubicazioni
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Vedi le informazioni relative al training in [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
