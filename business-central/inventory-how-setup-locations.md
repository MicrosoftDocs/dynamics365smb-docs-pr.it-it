...
ms.author: bholtorf
---
# <a name="set-up-locations" />Impostare le ubicazioni
...
## <a name="location-cards" />Schede Ubicazione
...
### <a name="to-set-up-a-location" />Per impostare un'ubicazione
...
### <a name="to-create-a-transfer-route" />Per creare i percorsi di trasferimento
...
## <a name="default-dimensions-for-locations" />Dimensioni predefinite per le ubicazioni
...
### <a name="example-of-default-dimensions-on-locations" />Esempio di dimensioni predefinite per le ubicazioni
...
## <a name="see-related-training-at-microsoft-learn" />Vedi le informazioni relative al training in [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
