...
ms.author: edupont
---
# <a name="set-up-base-calendars" />Impostare i calendari di base
...
## <a name="to-set-up-a-base-calendar" />Per impostare un calendario base
...
## <a name="lead-time-calculation" />Calcolo lead time
...
## <a name="to-customize-a-calendar" />Per personalizzare un calendario
...
## <a name="to-assign-a-base-calendar" />Per assegnare un calendario di base
