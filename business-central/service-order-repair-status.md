...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Come impostare gli stati per gli ordini di assistenza e le riparazioni
...
## <a name="to-set-up-service-status-priorities" />Per impostare le priorità di stato di assistenza
...
## <a name="to-set-up-a-repair-status" />Per impostare uno stato di riparazione
