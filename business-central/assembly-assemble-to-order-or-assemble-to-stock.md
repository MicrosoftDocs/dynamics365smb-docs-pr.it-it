...
---
# <a name="understanding-assemble-to-order-and-assemble-to-stock"></a><a name="understanding-assemble-to-order-and-assemble-to-stock"></a>Assemblaggio su ordine e assemblaggio per magazzino
...
## <a name="assemble-to-stock"></a><a name="assemble-to-stock"></a>Assemblaggio per magazzino
...
## <a name="combination-scenarios"></a><a name="combination-scenarios"></a>Scenari di combinazione
