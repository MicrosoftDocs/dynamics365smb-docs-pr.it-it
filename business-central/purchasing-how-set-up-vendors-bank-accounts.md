...
---
# <a name="set-up-vendor-bank-accounts" />Impostare i conti correnti fornitori
...
## <a name="add-or-edit-a-vendor-bank-account" />Aggiungere o modificare un conto bancario fornitore
...
## <a name="set-up-a-preferred-vendor-bank-account" />Impostare un conto corrente fornitore preferito
