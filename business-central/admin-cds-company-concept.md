...
# <a name="data-ownership-models" />Modelli di proprietà dei dati
...
## <a name="team-ownership" />Proprietà del team
...
## <a name="choosing-a-different-business-unit" />Scelta di una Business Unit diversa
...
## <a name="person-ownership" />Proprietà della persona
