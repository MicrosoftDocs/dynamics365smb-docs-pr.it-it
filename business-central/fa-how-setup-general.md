...
ms.author: edupont
---
# <a name="set-up-general-fixed-assets-information"></a><a name="set-up-general-fixed-assets-information"></a>Impostare i valori generali per i cespiti
...
## <a name="to-set-up-general-default-values-for-fixed-assets"></a><a name="to-set-up-general-default-values-for-fixed-assets"></a>Per impostare i valori predefiniti generali per i cespiti
...
## <a name="to-set-up-fixed-asset-posting-groups"></a><a name="to-set-up-fixed-asset-posting-groups"></a>Per impostare le categorie di registrazione dei cespiti
...
## <a name="to-set-up-fixed-asset-allocation-keys"></a><a name="to-set-up-fixed-asset-allocation-keys"></a>Per impostare le chiavi di allocazione relative ai cespiti
...
## <a name="to-set-up-fixed-asset-journal-templates"></a><a name="to-set-up-fixed-asset-journal-templates"></a>Per impostare le definizioni registrazioni dei cespiti
...
## <a name="to-set-up-fixed-asset-journal-batches"></a><a name="to-set-up-fixed-asset-journal-batches"></a>Per impostare i batch registrazioni cespiti
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates"></a><a name="to-set-up-fixed-asset-reclassification-journal-templates"></a>Per impostare le definizioni registrazioni di riclassificazione dei cespiti
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches"></a><a name="to-set-up-fixed-asset-reclassification-journal-batches"></a>Per impostare i batch registrazioni di riclassificazione dei cespiti
...
## <a name="to-set-up-fixed-asset-class-codes"></a><a name="to-set-up-fixed-asset-class-codes"></a>Per impostare i codici di classe cespiti
...
## <a name="to-set-up-fixed-asset-subclass-codes"></a><a name="to-set-up-fixed-asset-subclass-codes"></a>Per impostare i codici di sottoclasse cespiti
...
## <a name="to-set-up-fixed-asset-location-codes"></a><a name="to-set-up-fixed-asset-location-codes"></a>Per impostare i codici di ubicazione cespiti
...
## <a name="to-register-opening-entries"></a><a name="to-register-opening-entries"></a>Per registrare movimenti di apertura
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/paths/set-up-fixed-assets-management/)
