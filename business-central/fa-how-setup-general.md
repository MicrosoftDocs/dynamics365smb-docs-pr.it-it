...
ms.author: edupont
---
# <a name="set-up-general-fixed-assets-information" />Impostare i valori generali per i cespiti
...
## <a name="to-set-up-general-default-values-for-fixed-assets" />Per impostare i valori predefiniti generali per i cespiti
...
## <a name="to-set-up-fixed-asset-posting-groups" />Per impostare le categorie di registrazione dei cespiti
...
## <a name="to-set-up-fixed-asset-allocation-keys" />Per impostare le chiavi di allocazione relative ai cespiti
...
## <a name="to-set-up-fixed-asset-journal-templates" />Per impostare le definizioni registrazioni dei cespiti
...
## <a name="to-set-up-fixed-asset-journal-batches" />Per impostare i batch registrazioni cespiti
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates" />Per impostare le definizioni registrazioni di riclassificazione dei cespiti
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />Per impostare i batch registrazioni di riclassificazione dei cespiti
...
## <a name="to-set-up-fixed-asset-class-codes" />Per impostare i codici di classe cespiti
...
## <a name="to-set-up-fixed-asset-subclass-codes" />Per impostare i codici di sottoclasse cespiti
...
## <a name="to-set-up-fixed-asset-location-codes" />Per impostare i codici di ubicazione cespiti
...
## <a name="to-register-opening-entries" />Per registrare movimenti di apertura
