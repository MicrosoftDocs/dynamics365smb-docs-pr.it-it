...
ms.author: edupont
---
# <a name="make-drop-shipments" />Effettuare spedizioni dirette
...
## <a name="to-create-a-sales-order-for-drop-shipment" />Per creare un ordine di vendita per una spedizione diretta
...
## <a name="to-create-the-purchase-order-for-drop-shipment" />Per creare l'ordine di acquisto per la spedizione diretta
...
## <a name="to-create-multiple-purchase-orders-for-drop-shipments" />Per creare più ordini di acquisto per spedizioni dirette
...
## <a name="to-view-the-linked-purchase-order-from-the-sales-order" />Per visualizzare l'ordine di acquisto collegato dall'ordine di vendita
...
## <a name="to-post-a-drop-shipment" />Per registrare una spedizione diretta
