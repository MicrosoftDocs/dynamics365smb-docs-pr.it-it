---
title: Inviare le dichiarazioni IVA alle autorità fiscali
description: 'Scopri come preparare report in cui è elencata l''IVA sulle vendite effettuate in un periodo, oppure sulle vendite e sugli acquisti, e come inviare il report a un''autorità fiscale.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
# <a name="report-vat-to-tax-authorities"></a>Segnalare l'IVA alle autorità fiscali

In questo articolo vengono descritti i report che puoi utilizzare per inviare alle autorità fiscali della tua regione informazioni sugli importi dell'imposta sul valore aggiunto (IVA) per vendite e acquisti. [!INCLUDE[prod_short](includes/prod_short.md)]  A seconda del Paese/regione specifico, i report potrebbero includere informazioni specifiche oppure potrebbero essere necessari ulteriori report da inviare. Controlla gli articoli per il tuo paese/area geografica nella sezione [Funzionalità locale](about-localization.md).  
...
Dopo che l'autorità fiscale avrà esaminato la tua segnalazione, invierà un'e-mail al referente della tua azienda. In [!INCLUDE[prod_short](includes/prod_short.md)], il nome del contatto è specificato nella pagina **Informazioni società**. Prima di inviare il report, assicurarsi che il contatto sia stato selezionato.  
...
Facoltativamente, se la tua azienda non ha sede nel Regno Unito, utilizza la pagina  **Periodo dichiarazioni IVA** per impostare le dichiarazioni IVA programmate. Se la tua azienda ha sede nel Regno Unito, consulta  [Rendere la tassazione digitale nel Regno Unito](LocalFunctionality/UnitedKingdom/making-tax-digital-submit-vat-return.md).  
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi 3.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") Icona, immettere **Elenco vendite CE** o **Dichiarazioni IVA**, quindi selezionare il relativo collegare.  
...
| Accettato | La dichiarazione IVA ha questo stato se il report viene contrassegnato come accettato tramite l'azione  **Contrassegna come accettato** . Se il report **Dichiarazione IVA** è contrassegnato come **Accettato** puoi eseguire l'azione **Calcola e registra liquidazione IVA**. |
...
[Impostare i calcoli e i metodi di registrazione per l'imposta sul valore aggiunto](finance-setup-vat.md)    
[Utilizzare l'IVA nelle vendite e negli acquisti](finance-work-with-vat.md)    
[Imposta le vendite](sales-setup-sales.md)    
