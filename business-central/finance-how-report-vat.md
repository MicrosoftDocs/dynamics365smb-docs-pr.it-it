...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Dichiarare l'IVA all'autorità fiscale
...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>Informazioni sul report Lista vendite UE
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Inviare un report Lista vendite UE

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>Informazioni sul report Dichiarazione IVA
...
## <a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a>Per connettersi al servizio Web dell'autorità fiscale
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>Per impostare i report IVA in [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>Per impostare i periodi di dichiarazione IVA
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>Per salvare e inviare un report IVA
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>Stato dichiarazione IVA
...
## <a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a>Visualizzare le comunicazioni con l'autorità fiscale
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Inviare i report IVA manualmente
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a>Liquidazione IVA
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Configurazione dei report IVA personalizzati
