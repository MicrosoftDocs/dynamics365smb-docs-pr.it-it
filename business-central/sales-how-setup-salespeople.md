...
ms.author: edupont
---
# <a name="set-up-salespeople"></a><a name="set-up-salespeople"></a>Impostare gli agenti
...
## <a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a>Per impostare un codice agente
