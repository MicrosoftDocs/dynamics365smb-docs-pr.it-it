...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central"></a><a name="managing-onedrive-integration-with-business-central"></a>Gestione dell'integrazione di OneDrive con Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central"></a><a name="configure-onedrive-for-integration-with-business-central"></a>Configurare OneDrive per l'integrazione con Business Central
...
### <a name="managing-privacy"></a><a name="managing-privacy"></a>Gestione della privacy
...
## <a name="configure-business-central"></a><a name="configure-business-central"></a>Configura Business Central
...
### <a name="about-multiple-environments"></a><a name="about-multiple-environments"></a>Informazioni sugli ambienti multipli
...
### <a name="configure-onedrive-using-onedrive-setup"></a><a name="configure-onedrive-using-onedrive-setup"></a>Configurare OneDrive usando Setup OneDrive
...
### <a name="switching-to-new-onedrive-integration-after-upgrade"></a><a name="switching-to-new-onedrive-integration-after-upgrade"></a>Passaggio alla nuova integrazione OneDrive dopo l'aggiornamento
...
## <a name="restoring-onedrive-and-"></a><a name="restoring-onedrive-and-"></a>Ripristinare OneDrive e [!INCLUDE[prod_short](includes/prod_short.md)]
