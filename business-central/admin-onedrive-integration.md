...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Gestione dell'integrazione di OneDrive con Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Configurare OneDrive per l'integrazione con Business Central
...
### <a name="managing-privacy" />Gestione della privacy
...
## <a name="configure-business-central" />Configura Business Central
...
### <a name="about-multiple-environments" />Informazioni sugli ambienti multipli
...
### <a name="configure-onedrive-using-onedrive-setup" />Configurare OneDrive usando Setup OneDrive
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Passaggio alla nuova integrazione OneDrive dopo l'aggiornamento
