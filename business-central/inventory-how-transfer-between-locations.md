...
---
# <a name="transfer-inventory-between-locations" />Trasferire il magazzino tra le ubicazioni
...
## <a name="transfer-orders" />Ordini di trasferimento
...
## <a name="item-reclassification-journals" />Registrazioni riclassificazione articoli
...
## <a name="to-transfer-items-with-a-transfer-order" />Per trasferire gli articoli con un ordine di trasferimento
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Registrare più ordini di trasferimento in un batch
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Pianificare un movimento coda processi per registrare più documenti in un batch
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />Per trasferire gli articoli con le registrazioni di riclassificazione articolo
...
## <a name="undo-a-transfer-shipment" />Annullare una spedizione trasferimento
