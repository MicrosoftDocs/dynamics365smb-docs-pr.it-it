...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Procedura dettagliata: Impostazione e utilizzo di un workflow di approvazione di acquisto
...
### <a name="setting-up-approval-users" />Impostazione degli utenti approvazione
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Per impostare l'utente corrente e Alicia come utenti approvazione
...
### <a name="setting-up-notifications" />Impostazione delle notifiche
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Per impostare come e quando si riceve la notifica
...
## <a name="creating-the-approval-workflow" />Creazione del workflow di approvazione
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Per creare e abilitare un workflow di approvazione dell'ordine di acquisto
...
## <a name="use-the-approval-workflow" />Utilizzare il flusso di lavoro di approvazione
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Per richiedere l'approvazione di un ordine di acquisto, come Alicia
...
### <a name="to-approve-the-purchase-order-as-sean" />Per approvare l'ordine di acquisto, come Sean
