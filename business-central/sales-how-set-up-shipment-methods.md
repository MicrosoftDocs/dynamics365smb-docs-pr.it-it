...
ms.author: edupont
---
# <a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a>Impostare i metodi di spedizione
...
## <a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a>Per impostare un metodo di spedizione
