...
ms.author: edupont
---
# <a name="create-recurring-sales" />Creare vendite ricorrenti
...
## <a name="set-up-recurring-sales-lines" />Impostare righe di vendita ricorrenti
...
## <a name="assign-recurring-sales-lines-to-a-customer" />Assegnare righe di vendita ricorrenti a un cliente
...
## <a name="insert-recurring-sales-lines-on-a-sales-invoice" />Inserire righe di vendita ricorrenti in una fattura di vendita
...
## <a name="create-multiple-sales-invoices-based-on-recurring-sales-lines" />Creare più fatture di vendita in base alle righe di vendita ricorrenti
