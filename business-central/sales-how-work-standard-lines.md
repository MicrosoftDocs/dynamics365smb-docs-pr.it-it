...
ms.author: edupont
---
# <a name="create-recurring-sales"></a><a name="create-recurring-sales"></a>Creare vendite ricorrenti
...
## <a name="set-up-recurring-sales-lines"></a><a name="set-up-recurring-sales-lines"></a>Impostare righe di vendita ricorrenti
...
## <a name="assign-recurring-sales-lines-to-a-customer"></a><a name="assign-recurring-sales-lines-to-a-customer"></a>Assegnare righe di vendita ricorrenti a un cliente
...
## <a name="insert-recurring-sales-lines-on-a-sales-invoice"></a><a name="insert-recurring-sales-lines-on-a-sales-invoice"></a>Inserire righe di vendita ricorrenti in una fattura di vendita
...
## <a name="create-multiple-sales-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-sales-invoices-based-on-recurring-sales-lines"></a>Creare più fatture di vendita in base alle righe di vendita ricorrenti
