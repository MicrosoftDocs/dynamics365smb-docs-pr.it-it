...
ms.author: edupont
---
# <a name="use-resources-for-jobs"></a><a name="use-resources-for-jobs"></a><a name="use-resources-for-jobs"></a>Utilizzare le risorse per le commesse
...
## <a name="to-assign-resources-to-jobs"></a><a name="to-assign-resources-to-jobs"></a><a name="to-assign-resources-to-jobs"></a>Per assegnare le risorse alle commesse
...
## <a name="to-record-resource-usage-for-a-job"></a><a name="to-record-resource-usage-for-a-job"></a><a name="to-record-resource-usage-for-a-job"></a>Per registrare l'utilizzo delle risorse per una commessa
...
## <a name="to-adjust-resource-prices"></a><a name="to-adjust-resource-prices"></a><a name="to-adjust-resource-prices"></a>Per rettificare i prezzi delle risorse
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices"></a><a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices"></a><a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices"></a>Per ottenere suggerimenti per la modifica del prezzo di una risorsa sulla base dei prezzi alternativi esistenti
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices"></a><a name="to-get-resource-price-change-suggestions-based-on-standard-prices"></a><a name="to-get-resource-price-change-suggestions-based-on-standard-prices"></a>Per ottenere suggerimenti per la modifica del prezzo di una risorsa sulla base dei prezzi standard
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices"></a><a name="to-get-resource-price-change-suggestions-based-on-alternate-prices"></a><a name="to-get-resource-price-change-suggestions-based-on-alternate-prices"></a>Per ottenere suggerimenti per la modifica del prezzo di una risorsa sulla base dei prezzi alternativi
