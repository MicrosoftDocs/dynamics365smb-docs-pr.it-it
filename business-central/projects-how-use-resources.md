...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Utilizzare le risorse per le commesse
...
## <a name="to-assign-resources-to-jobs" />Per assegnare le risorse alle commesse
...
## <a name="to-record-resource-usage-for-a-job" />Per registrare l'utilizzo delle risorse per una commessa
...
## <a name="to-adjust-resource-prices" />Per rettificare i prezzi delle risorse
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Per ottenere suggerimenti per la modifica del prezzo di una risorsa sulla base dei prezzi alternativi esistenti
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Per ottenere suggerimenti per la modifica del prezzo di una risorsa sulla base dei prezzi standard
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Per ottenere suggerimenti per la modifica del prezzo di una risorsa sulla base dei prezzi alternativi
