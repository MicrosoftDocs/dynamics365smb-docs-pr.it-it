...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Utilizzare Dynamics 365 Sales da Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a>Associazione di record
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Sincronizzazione completa dei record
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Gestione di dati di ordini di vendita
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Gestione di dati di offerte di vendita
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Gestione di spedizioni vendita registrate, pagamenti clienti e statistiche
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Gestione dei prezzi di vendita
> [!NOTE]
