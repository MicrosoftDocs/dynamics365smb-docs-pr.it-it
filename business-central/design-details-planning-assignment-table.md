...
ms.author: edupont
---
# <a name="design-details-planning-assignment-table"></a><a name="design-details-planning-assignment-table"></a>Dettagli di progettazione: Tabella Assegnazione pianificazione
