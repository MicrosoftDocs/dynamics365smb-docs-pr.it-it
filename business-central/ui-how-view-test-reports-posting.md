...
ms.author: solsen
---
# <a name="view-test-reports-before-posting" />Visualizzare i report dei test prima della registrazione
...
## <a name="to-print-a-test-report-before-posting-a-purchase-invoice" />Per stampare un report di test prima di registrare una fattura di acquisto
