...
ms.author: edupont
---
# <a name="design-details-posting-date-on-adjustment-value-entry" />Dettagli di progettazione: Data di registrazione del movimento di valorizzazione della rettifica
...
## <a name="how-posting-dates-are-assigned" />Come vengono assegnate le date di distacco
...
#### <a name="item-ledger-entry" />Mov. Contabile Articoli
...
#### <a name="inventory-periods" />Periodi di inventario
...
#### <a name="general-ledger-setup" />Setup contabilità generale
...
## <a name="common-problems-with-the-adjust-cost---item-entries-batch-job" />Problemi comuni con il lavoro batch "Regolare i costi - voci di articolo"
...
### <a name="error-message-posting-date-is-not-within-your-range-of-allowed-posting-dates" />Messaggio di errore: "La data di invio non rientra nel tuo range di date di invio consentite..."
