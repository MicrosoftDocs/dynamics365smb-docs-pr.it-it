...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />L'estensione della gestione del gruppo IVA per il Regno Unito
...
## <a name="forming-a-vat-group" />Formazione di un gruppo IVA
...
### <a name="license-requirements" />Requisiti di licenza
...
## <a name="set-up-a-vat-group" />Impostare un gruppo IVA
...
### <a name="azure-active-directory-setup-for-group-members" />Configurazione di Azure Active Directory per il gruppo IVA
...
### <a name="group-api-setup" />Configurazione del gruppo API
...
## <a name="set-up-vat-group-members" />Impostare i membri del gruppo IVA
...
### <a name="vat-group-representative-uses-business-central-online" />Il rappresentante del gruppo IVA usa Business Central Online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />Il rappresentante del gruppo IVA usa Business Central locale
...
## <a name="set-up-the-vat-group-representative" />Impostare il rappresentante del gruppo IVA
...
## <a name="use-the-vat-group-management-features" />Utilizzare le funzionalità di gestione del gruppo IVA
...
### <a name="review-vat-member-submissions" />Revisione degli invii dei membri del gruppo IVA
...
### <a name="create-a-group-vat-return" />Creare una dichiarazione IVA di gruppo
