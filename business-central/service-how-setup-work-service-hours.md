...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours" />Impostare le ore di lavoro e le ore di assistenza
...
## <a name="to-set-up-default-service-hours" />Per impostare le ore di assistenza di default
...
## <a name="to-set-up-work-hour-templates" />Per impostare i modelli delle ore di lavoro
...
## <a name="to-set-up-contract-specific-service-hours" />Per impostare le ore di assistenza specifiche del contratto
