...
# <a name="control-access-to-business-central-using-security-groups" />Controllare l'accesso a Business Central utilizzando i gruppi di sicurezza
...
## <a name="business-central-online-and-on-premises" />Business Central Online e in locale
...
## <a name="add-a-security-group-in-business-central" />Aggiungere un gruppo di sicurezza in Business Central
...
### <a name="assign-permissions-to-a-security-group" />Assegnare autorizzazioni a un gruppo di sicurezza
...
## <a name="review-the-permissions-in-a-security-group" />Esaminare le autorizzazioni di un gruppo di sicurezza
...
## <a name="security-groups-and-user-groups" />Gruppi di sicurezza e gruppi di utenti
...
### <a name="optional-convert-user-groups-to-permission-sets" />Facoltativo: converti i gruppi di utenti in set di autorizzazioni
