...
ms.author: edupont
---
# <a name="about-calculating-standard-cost"></a><a name="about-calculating-standard-cost"></a>Informazioni sul calcolo del costo standard
...
## <a name="setting-up-standard-costs"></a><a name="setting-up-standard-costs"></a>Impostazione dei costi standard
...
### <a name="material-costs"></a><a name="material-costs"></a>Costi materiale
...
### <a name="capacity-costs"></a><a name="capacity-costs"></a>Costi della capacità
...
### <a name="subcontractor-costs"></a><a name="subcontractor-costs"></a>Costi dei terzisti
...
## <a name="updating-standard-costs"></a><a name="updating-standard-costs"></a>Aggiornamento dei costi standard
