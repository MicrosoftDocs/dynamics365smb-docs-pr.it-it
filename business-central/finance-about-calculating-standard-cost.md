...
## <a name="set-up-standard-costs"></a>Imposta costi standard
...
## <a name="update-standard-costs"></a>Aggiorna i costi standard
...
### <a name="post-inventory-cost-to-gl"></a>Registra costo inventario in C/G
...
### <a name="roll-up-standard-cost"></a>Riepilogo costo standard
...
### <a name="implement-standard-cost-change"></a>Implementare la modifica dei costi standard
