...
ms.author: edupont
---
# <a name="about-calculating-standard-cost" />Informazioni sul calcolo del costo standard
...
## <a name="setting-up-standard-costs" />Impostazione dei costi standard
...
### <a name="material-costs" />Costi materiale
...
### <a name="capacity-costs" />Costi della capacità
...
### <a name="subcontractor-costs" />Costi dei terzisti
...
## <a name="updating-standard-costs" />Aggiornamento dei costi standard
