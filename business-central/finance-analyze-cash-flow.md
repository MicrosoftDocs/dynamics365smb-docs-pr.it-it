---
title: Analizzare i flussi di cassa
...
# <a name="analyze-cash-flow-in-your-company"></a>Analizza il flusso di cassa della tua azienda
...
| Quando potrebbe verificarsi un surplus o un deficit di cassa?</br> Dovrei pagare i debiti o stipulare un prestito per le spese imminenti? |Previsioni flusso di cassa |
...
[Lavora con [!INCLUDE[prod_short](includes/prod_short.md)]](ui-work-product.md)   
[Impostazione dell'analisi del flusso di cassa](finance-setup-cash-flow-analyses.md)    
[Prevedi il tuo flusso di cassa in Dynamics 365 Business Central](/training/modules/forecast-cash-flow-dynamics-365-business-central/index)    
