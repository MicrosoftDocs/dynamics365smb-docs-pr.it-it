...
ms.author: bholtorf
---
# <a name="analyzing-cash-flow-in-your-company" />Analizzare il flusso di cassa dell'azienda
...
## <a name="to-view-a-cash-flow-worksheet" />Per visualizzare un prospetto flusso di cassa
