...
ms.author: edupont
---
# <a name="insure-fixed-assets" />Assicurazione di cespiti
...
## <a name="to-create-or-modify-an-insurance-card" />Per creare o modificare una scheda assicurazione
...
## <a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal" />Per assegnare un cespite a una polizza assicurativa mediante la registrazione dalla registrazione assicurazioni
...
## <a name="to-update-the-insurance-value-of-a-fixed-asset" />Per aggiornare il valore dell'assicurazione di un cespite
...
## <a name="to-monitor-insurance-coverage" />Per controllare la copertura assicurativa
...
### <a name="overview-of-insurance-policies" />Sintesi delle polizze assicurative
...
### <a name="insurance-coverage" />Copertura assicurativa
...
### <a name="overunder-coverage" />Sopra/sottocopertura
...
### <a name="uninsured-fixed-assets" />Cespiti non assicurati
...
## <a name="to-view-insurance-coverage-ledger-entries" />Per visualizzare i movimenti contabili di copertura assicurativa
...
## <a name="to-view-the-total-insurance-value-of-fixed-assets" />Per visualizzare il valore totale assicurato dei cespiti
...
## <a name="to-correct-insurance-coverage-entries" />Per correggere i movimenti di copertura assicurativa
