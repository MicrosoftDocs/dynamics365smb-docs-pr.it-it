...
ms.author: edupont
---
# <a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a>Abilitare i workflow di approvazione
...
## <a name="enable-a-workflow"></a><a name="enable-a-workflow"></a><a name="enable-a-workflow"></a>Abilitare un flusso di lavoro
