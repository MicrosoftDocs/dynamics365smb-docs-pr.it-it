...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a>Pianificare una nuova domanda ordine per ordine
...
## <a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a>Per pianificare la domanda di un nuovo ordine di produzione
...
## <a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a>Per pianificare qualunque nuova domanda
...
## <a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a>Per creare ordini di approvvigionamento
