...
ms.author: edupont
---
# <a name="work-with-manufacturing-batch-units-of-measure" />Utilizzare le unità di misura batch di produzione
...
## <a name="to-create-a-production-bom-using-a-batch-unit-of-measure" />Per creare una DB di produzione tramite un'unità di misura batch
...
## <a name="to-calculate-a-manufacturing-batch-unit-of-measure-on-a-production-order" />Per calcolare un'unità di misura batch di produzione in un ordine di produzione
