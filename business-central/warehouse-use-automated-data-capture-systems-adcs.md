...
---
# <a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a>Utilizzare i sistemi di acquisizione automatica dei dati (ADCS, Automatic Data Capture System)
...
## <a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a>Per abilitare i servizi Web per ADCS

Per utilizzare il sistema di acquisizione automatica dei dati, è necessario abilitare il servizio Web ADCS.  

## <a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a>Per abilitare e pubblicare il servizio Web ADCS
...
## <a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a>Per impostare una warehouse per l'utilizzo di ADCS
...
## <a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a>Per specificare un articolo per utilizzare il sistema ADCS
...
## <a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a>Per aggiungere un utente ADCS
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a>Per specificare che un impiegato warehouse è un utente ADCS
...
## <a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a>Per creare e personalizzare miniform
...
### <a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a>Per creare un miniform per ADCS
...
### <a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a>Per personalizzare le funzioni del miniform
