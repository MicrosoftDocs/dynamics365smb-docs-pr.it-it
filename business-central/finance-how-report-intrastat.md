...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting" />Utilizzare il reporting Intrastat
...
## <a name="fill-in-the-intrastat-report" />Compilare il report Intrastat
...
## <a name="modify-the-intrastat-report" />Modificare il report Intrastat
...
## <a name="validate-intrastat-lines" />Convalidare le righe Intrastat
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure" />Ricalcolo del peso o dell'unità di misura supplementare
...
## <a name="intrastat-rules" />Regole Intrastat
...
### <a name="fixed-assets-reporting" />Report cespiti
...
### <a name="intrastat-report-statuses" />Stati del report Intrastat
