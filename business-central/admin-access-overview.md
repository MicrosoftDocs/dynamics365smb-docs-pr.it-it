...
# <a name="manage-access-to-business-central" />Gestire l'accesso a Business Central
...
## <a name="layered-access" />Accesso su più livelli
...
## <a name="business-central-administrator-tasks" />Attività di amministrazione in Business Central
...
## <a name="business-central-developer-tasks" />Attività di Business Central per sviluppatori
