...
ms.author: bholtorf
---
# <a name="personalize-your-workspace" />Personalizzare l'area di lavoro
...
## <a name="to-change-the-width-of-a-column" />Per modificare la larghezza di una colonna
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner" />Per avviare la personalizzazione di una pagina tramite il banner **Personalizzazione**
...
### <a name="to-remove-hide-and-show-actions-and-action-groups" />Per rimuovere, nascondere e visualizzare azioni e gruppi di azioni
...
### <a name="to-move-actions-and-action-groups" />Per spostare azioni e gruppi di azioni
...
## <a name="to-clear-personalization" />Per cancellare la personalizzazione
...
## <a name="other-points-of-interest" />Altri punti di interesse
