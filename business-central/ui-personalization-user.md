...
> [!NOTE]
> Gli amministratori possono apportare le stesse modifiche area di disposizione degli utenti personalizzando un profilo (ruolo), che può essere assegnato a più utenti. Per saperne di più sulle pagine per i ruoli, vai a [Personalizzare le pagine per i ruoli](ui-personalization-manage.md)<br /><br />
...
## <a name="video-and-training"></a>Video e formazione

Il video seguente mostra alcuni dei modi per personalizzare il Centro gestione ruoli.

> [!Video https://www.microsoft.com/en-us/videoplayer/embed/RE4ArUB?rel=0]

Per la formazione online, vai a [Personalizza l'interfaccia utente di Microsoft Dynamics 365 Business Central](/training/modules/personalize-ui-dynamics-365-business-central/).
