...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-" />Annullare la sottoscrizione o rimuovere [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing--from-your-app-launcher" />Rimozione di [!INCLUDE[prod_short](includes/prod_short.md)] dall'avvio delle applicazioni
