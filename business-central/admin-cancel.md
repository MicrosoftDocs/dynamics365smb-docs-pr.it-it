...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-includeprodshortincludesprodshortmd" />Annullare la sottoscrizione o rimuovere [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing-includeprodshortincludesprodshortmd-from-your-app-launcher" />Rimozione di [!INCLUDE[prod_short](includes/prod_short.md)] dall'avvio delle applicazioni
