...
ms.date: 06/15/2022
---
# <a name="database-wait-statistics-in-"></a><a name="database-wait-statistics-in-"></a>Statistiche di attesa del database in [!INCLUDE[prod_long](includes/prod_long.md)]
