...
ms.author: edupont
---
# <a name="walkthrough-managing-projects-with-jobs" />Procedura dettagliata: Gestione dei progetti con le commesse
...
### <a name="copying-a-job" />Copia di una commessa
...
### <a name="making-payment-by-installment" />Pagamenti rateali
...
### <a name="to-prepare-the-sample-data" />Per preparare i dati di esempio
...
### <a name="to-create-a-job-journal-batch" />Per creare un batch registrazioni commesse
...
### <a name="to-set-up-a-job" />Per impostare una commessa
...
### <a name="to-customize-pricing" />Per personalizzare il prezzo
...
### <a name="to-add-job-tasks" />Per aggiungere task commessa
...
### <a name="to-create-planning-lines" />Per creare righe di pianificazione
...
## <a name="calculating-remaining-usage" />Calcolo dell'utilizzo residuo
...
### <a name="to-calculate-remaining-usage" />Per calcolare l'utilizzo residuo
...
## <a name="creating-and-posting-a-job-sales-invoice" />Creazione e registrazione di una fattura di vendita per una commessa
...
### <a name="to-create-a-job-sales-invoice" />Per creare una fattura di vendita per una commessa
...
### <a name="to-post-a-new-sales-invoice" />Per registrare una nuova fattura di vendita
...
### <a name="to-view-the-posted-invoice" />Per visualizzare la fattura registrata
...
### <a name="to-open-the-statistics-page" />Per aprire la pagina Statistiche
...
### <a name="to-manage-fixed-pricing-in-jobs" />Per gestire i prezzi fissi nelle commesse
...
### <a name="to-enter-hours-in-the-job-journal" />Per inserire ore nelle Registrazioni commesse
...
## <a name="copying-jobs" />Copia di commesse
...
### <a name="to-copy-a-job" />Per copiare una commessa
...
## <a name="making-payments-by-installments" />Pagamenti rateali
...
### <a name="to-set-up-a-new-account" />Per impostare un nuovo conto
...
### <a name="to-make-a-payment-by-installment" />Per effettuare un pagamento rateale
...
### <a name="to-create-an-invoice" />Per creare una fattura
