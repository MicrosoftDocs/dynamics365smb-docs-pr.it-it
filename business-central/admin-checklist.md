...
ms.author: edupont
---
# <a name="onboard-users-with-checklists" />Aggiungere utenti con elenchi di controllo
...
## <a name="to-add-an-item-to-the-checklist" />Per aggiungere un elemento all'elenco di controllo
