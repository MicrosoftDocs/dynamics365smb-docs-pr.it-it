...
ms.author: bholtorf
---
# <a name="register-new-vendors"></a><a name="register-new-vendors"></a>Registrare nuovi fornitori
...
## <a name="adding-new-vendors"></a><a name="adding-new-vendors"></a>Aggiunta di nuovi fornitori
...
### <a name="to-create-a-new-vendor"></a><a name="to-create-a-new-vendor"></a>Per creare un nuovo fornitore
...
### <a name="deleting-and-editing-vendor-information"></a><a name="deleting-and-editing-vendor-information"></a>Cancellazione e modifica delle informazioni del fornitore
...
## <a name="to-save-the-vendor-card-as-a-template"></a><a name="to-save-the-vendor-card-as-a-template"></a>Per salvare la scheda fornitore come modello
