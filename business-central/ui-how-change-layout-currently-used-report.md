...
ms.author: jswymer
---
# <a name="legacy-set-the-layout-used-by-a-report" />(Legacy) Impostare il layout utilizzato da un report
...
## <a name="to-change-which-report-layout-to-use-for-a-report-or-document" />Per modificare il layout di report da utilizzare per un report o un documento
...
## <a name="to-change-the-custom-layout-to-use-for-a-report-layout" />Per modificare il layout personalizzato da utilizzare per un layout di report
