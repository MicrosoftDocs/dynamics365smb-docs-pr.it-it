...
---
# <a name="pick-items-with-inventory-picks" />Prelevare articoli con prelievi magazzino
...
## <a name="to-create-multiple-inventory-picks-with-a-batch-job" />Per creare più prelievi magazzino utilizzando un processo batch
...
## <a name="to-create-the-pick-in-two-steps" />Per creare il prelievo in due passaggi

### <a name="to-request-an-inventory-pick-by-releasing-the-source-document" />Per richiedere un prelievo magazzino emettendo il documento di origine
...
### <a name="to-create-an-inventory-pick-based-on-the-source-document" />Per creare un prelievo da magazzino basato sul documento di origine
...
## <a name="to-record-inventory-picks" />Per registrare i prelievi magazzino
...
## <a name="handling-assemble-to-order-items-with-inventory-picks" />Gestione di articoli da assemblare su ordine con prelievi magazzino
