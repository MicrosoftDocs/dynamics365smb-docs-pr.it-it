...
ms.author: edupont
---
# <a name="analyze-data-by-dimensions"></a><a name="analyze-data-by-dimensions"></a><a name="analyze-data-by-dimensions"></a>Analizzare i dati per dimensioni
...
## <a name="set-up-an-analysis-view"></a><a name="set-up-an-analysis-view"></a><a name="set-up-an-analysis-view"></a>Impostare una visualizzazione analisi
...
## <a name="analyze-by-dimensions"></a><a name="analyze-by-dimensions"></a><a name="analyze-by-dimensions"></a>Analizzare per dimensioni
...
## <a name="update-an-analysis-view"></a><a name="update-an-analysis-view"></a><a name="update-an-analysis-view"></a>Aggiornare una visualizzazione analisi
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Vedi le informazioni relative al training in [Microsoft Learn](/learn/modules/dimensions-financial-reports-dynamics-365-business-central/index).
