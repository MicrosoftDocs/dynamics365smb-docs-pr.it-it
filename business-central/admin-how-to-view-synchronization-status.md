...
# <a name="view-the-status-of-synchronization-jobs" />Visualizzare lo stato dei processi d sincronizzazione
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />Per visualizzare e risolvere gli errori di sincronizzazione per record associati
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />Per visualizzare il registro di sincronizzazione per uno specifico record (sincronizzato manualmente)
...
## <a name="remove-couplings-between-records" />Rimuovere associazioni tra record
