...
# <a name="manage-work-across-multiple-companies-in-the-company-hub"></a><a name="manage-work-across-multiple-companies-in-the-company-hub"></a>Gestire il lavoro tra più aziende nell'hub aziendale
...
## <a name="company-hub-home-page"></a><a name="company-hub-home-page"></a>Home page dell'hub aziendale
...
## <a name="assigned-tasks"></a><a name="assigned-tasks"></a>Task assegnati
...
### <a name="my-user-tasks"></a><a name="my-user-tasks"></a>Task personali dell'utente
...
## <a name="access-the-company-hub"></a><a name="access-the-company-hub"></a>Accesso all'hub aziendale
...
## <a name="set-up-the-company-hub"></a><a name="set-up-the-company-hub"></a>Impostazione dell'hub aziendale
