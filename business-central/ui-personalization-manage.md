...
ms.author: edupont
---
# <a name="customize-pages-for-profiles" />Personalizzare pagine per profili
...
## <a name="to-customize-pages-for-a-profile" />Per personalizzare pagine per un profilo
...
## <a name="to-view-all-customized-pages-for-a-profile" />Per visualizzare tutte le pagine personalizzate per un profilo
...
## <a name="to-delete-all-customizations-for-a-profile" />Per eliminare tutte le personalizzazioni per un profilo
...
## <a name="to-delete-customization-for-specific-pages-for-a-profile" />Per eliminare la personalizzazione di specifiche pagine per un profilo
