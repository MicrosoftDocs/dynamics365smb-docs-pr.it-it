...
ms.author: edupont
---
# <a name="create-special-orders"></a><a name="create-special-orders"></a><a name="create-special-orders"></a>Creare ordini speciali
...
## <a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a>Per creare un ordine speciale
