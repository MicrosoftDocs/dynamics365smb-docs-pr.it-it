...
---
# <a name="manage-the-intercompany-inbox-and-outbox"></a><a name="manage-the-intercompany-inbox-and-outbox"></a>Gestire la casella in entrata e in uscita intercompany
...
## <a name="organizing-the-inbox"></a><a name="organizing-the-inbox"></a>Organizzazione della casella in arrivo
...
### <a name="transaction-source"></a><a name="transaction-source"></a>Origine transazione
...
#### <a name="created-by-intercompany-partner"></a><a name="created-by-intercompany-partner"></a>Creata da un partner intercompany
...
#### <a name="returned-from-intercompany-partner"></a><a name="returned-from-intercompany-partner"></a>Restituita da un partner intercompany
...
## <a name="recreating-inbox-entries"></a><a name="recreating-inbox-entries"></a>Ricostruzione di movimenti nella casella in entrata
...
## <a name="get-an-overview-of-intercompany-transactions-for-a-period"></a><a name="get-an-overview-of-intercompany-transactions-for-a-period"></a>Ottenere una panoramica delle transazioni intercompany per un periodo
...
## <a name="import-intercompany-transactions-from-a-file"></a><a name="import-intercompany-transactions-from-a-file"></a>Importare transazioni intercompany da un file
...
## <a name="process-incoming-intercompany-transactions"></a><a name="process-incoming-intercompany-transactions"></a>Elaborare le transazioni intercompany in entrata
...
## <a name="to-process-outgoing-intercompany-transactions"></a><a name="to-process-outgoing-intercompany-transactions"></a>Per elaborare le transazioni intercompany in uscita
...
## <a name="recreate-intercompany-inbox-transactions"></a><a name="recreate-intercompany-inbox-transactions"></a>Ricreare transazioni nella casella in entrata intercompany
