...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure" />Dettagli di progettazione: Struttura di registrazione di tracciabilità articolo
...
## <a name="one-to-many-relation" />Relazione uno-a-molti
