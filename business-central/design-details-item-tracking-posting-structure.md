...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure"></a><a name="design-details-item-tracking-posting-structure"></a>Dettagli di progettazione: Struttura di registrazione di tracciabilità articolo
...
## <a name="one-to-many-relation"></a><a name="one-to-many-relation"></a>Relazione uno-a-molti
...
## <a name="codeunits-80-and-90"></a><a name="codeunits-80-and-90"></a>Codeunit 80 e 90
...
## <a name="posting-the-item-journal"></a><a name="posting-the-item-journal"></a>Contabilizzazione della registrazione magazzino
