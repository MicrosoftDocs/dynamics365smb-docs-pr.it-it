...
# <a name="work-with-word-layouts" />Utilizzare i layout di Word
...
## <a name="embedding-fonts-in-word-layouts-for-consistency" />Incorporazione di caratteri in layout di Word per mantenere la coerenza
...
## <a name="adding-data-fields" />Aggiunta di campi dati
...
### <a name="to-add-a-label-or-data-field" />Per aggiungere un campo dati o etichetta
...
### <a name="to-add-repeating-rows-of-data-fields-to-create-a-list" />Per aggiungere righe ripetuti di campi dati per creare una lista
...
## <a name="adding-image-fields" />Aggiungere campi immagine
...
### <a name="to-add-an-image" />Per aggiungere un'immagine
...
### <a name="to-remove-a-label-or-data-field" />Per rimuovere un campo dati o etichetta
...
## <a name="custom-xml-part-overview" />Panoramica della parte XML personalizzata
...
### <a name="xml-structure-of-custom-xml-part" />Struttura XML della parte XML personalizzata
...
### <a name="custom-xml-part-in-word" />Personalizzare la parte XML in Word
