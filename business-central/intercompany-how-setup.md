...
* Scambiare informazioni sui setup interaziendali. Ciascun partner può ottenere queste informazioni da **Setup interaziendale**, **Azioni**, **Dettagli connessione**.
...
Esegui **Seteup interaziendale**, **Azioni**, **Dettagli connessione** in tutte le società per specificare le informazioni. 
...
> [!TIP]
> È una buona idea tenere aperto un editor di testo, ad esempio Blocco note, mentre crei l'app registrata. Avrai bisogno di alcune informazioni quando esegui **Setup interaziendale**, **Azioni**, **Dettagli connessione**, quindi è conveniente avere le informazioni a portata di mano.
...
5. Nel campo **Set di autorizzazioni**, scegli il set di autorizzazioni **D365 INTERCOMPANY CE & DATA ACCESS IC CE**.
