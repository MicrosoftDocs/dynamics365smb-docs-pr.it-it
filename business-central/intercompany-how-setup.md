...
---
# <a name="set-up-intercompany-transactions"></a><a name="set-up-intercompany-transactions"></a><a name="set-up-intercompany-transactions"></a>Impostare transazioni intercompany
...
## <a name="overview-of-the-steps-to-get-started"></a><a name="overview-of-the-steps-to-get-started"></a><a name="overview-of-the-steps-to-get-started"></a>Panoramica dei passaggi per iniziare
...
## <a name="set-up-a-synchronization-partner"></a><a name="set-up-a-synchronization-partner"></a><a name="set-up-a-synchronization-partner"></a>Impostare un partner di sincronizzazione
...
## <a name="set-up-the-intercompany-charts-of-accounts"></a><a name="set-up-the-intercompany-charts-of-accounts"></a><a name="set-up-the-intercompany-charts-of-accounts"></a>Impostare il piano dei conti intercompany
...
### <a name="import-or-export-an-intercompany-chart-of-accounts"></a><a name="import-or-export-an-intercompany-chart-of-accounts"></a><a name="import-or-export-an-intercompany-chart-of-accounts"></a>Importare o esportare un piano dei conti intercompany
...
## <a name="set-up-intercompany-dimensions"></a><a name="set-up-intercompany-dimensions"></a><a name="set-up-intercompany-dimensions"></a>Impostare le dimensioni intercompany
...
### <a name="import-or-export-intercompany-dimensions"></a><a name="import-or-export-intercompany-dimensions"></a><a name="import-or-export-intercompany-dimensions"></a>Importare o esportare le dimensioni intercompany
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions"></a><a name="map-intercompany-dimensions-to-your-companys-dimensions"></a><a name="map-intercompany-dimensions-to-your-companys-dimensions"></a>Mappare le dimensioni intercompany alle dimensioni della società
...
## <a name="set-up-intercompany-general-journal-templates-and-batches"></a><a name="set-up-intercompany-general-journal-templates-and-batches"></a><a name="set-up-intercompany-general-journal-templates-and-batches"></a>Impostare modelli e batch di registrazioni COGE intercompany
...
## <a name="set-up-a-company-for-intercompany-transactions"></a><a name="set-up-a-company-for-intercompany-transactions"></a><a name="set-up-a-company-for-intercompany-transactions"></a>Impostare una società per le transazioni intercompany
...
## <a name="set-up-intercompany-partners"></a><a name="set-up-intercompany-partners"></a><a name="set-up-intercompany-partners"></a>Impostare i partner IC
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors"></a><a name="set-up-intercompany-partners-as-customers-and-vendors"></a><a name="set-up-intercompany-partners-as-customers-and-vendors"></a>Impostare partner IC come clienti e fornitori
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts"></a><a name="set-up-default-intercompany-partner-general-ledger-accounts"></a><a name="set-up-default-intercompany-partner-general-ledger-accounts"></a>Impostare i conti C/G predefiniti per i partner IC
...
### <a name="auto-accept-transactions-from-intercompany-partners"></a><a name="auto-accept-transactions-from-intercompany-partners"></a><a name="auto-accept-transactions-from-intercompany-partners"></a>Accettare automaticamente le transazioni da partner IC
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a><a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a><a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a>Specificare i conti bancari da utilizzare per i partner intercompany
...
## <a name="troubleshoot-your-intercompany-setup"></a><a name="troubleshoot-your-intercompany-setup"></a><a name="troubleshoot-your-intercompany-setup"></a>Risoluzione dei problemi dell'impostazione intercompany
