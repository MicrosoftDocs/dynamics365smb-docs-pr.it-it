...
ms.author: edupont
---
# <a name="manage-job-supplies" />Gestire gli approvvigionamenti delle commesse
...
## <a name="to-purchase-items-or-services-for-a-job" />Per acquistare articoli o servizi per una commessa
...
## <a name="to-view-the-value-of-purchases-for-a-job" />Per visualizzare il valore degli acquisti per una commessa
...
## <a name="to-post-a-job-related-expense" />Per registrare una spesa correlata a una commessa
