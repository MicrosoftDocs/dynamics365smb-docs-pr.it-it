...
ms.author: bholtorf
---
# <a name="upgrading-an-integration-with-dynamics-365-sales" />Aggiornamento di un'integrazione con Dynamics 365 Sales
...
## <a name="to-upgrade-your-connection-to-use-dataverse" />Per aggiornare la connessione per utilizzare Dataverse
