...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a>Utilizzare contratti e offerte di contratto di assistenza
...
## <a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a>Per creare un contratto o un'offerta di contratto di assistenza
...
## <a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a>Per convertire un'offerta di contratto di assistenza in contratto di assistenza
...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>Per creare note di credito di assistenza per un contratto
...
## <a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a>Aggiornamento e valutazione dei contratti
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a>Per aggiungere una riga di contratto a un contratto di assistenza o a un'offerta di contratto
...
## <a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a>Per eliminare le righe di contratto
...
## <a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a>Costo e valore riga assistenza
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>Per aggiungere uno sconto contrattuale alle offerte di contratto di assistenza
...
## <a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a>Per modificare l'intestatario di un contratto di assistenza
...
## <a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a>Per aggiornare un prezzo del contratto di assistenza
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>Per registrare movimenti di contratto prepagati
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Modifica dello stato del contratto di assistenza
...
## <a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a>Per annullare un contratto di assistenza
...
## <a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a>Archiviazione di un contratto di assistenza o un'offerta di contratto di assistenza
