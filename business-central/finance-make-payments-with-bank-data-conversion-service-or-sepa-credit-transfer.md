...
## <a name="setting-up-sepa-credit-transfer" />Impostare un bonifico SEPA
...
### <a name="to-set-up-a-bank-account-for-sepa-credit-transfer" />Per impostare un conto bancario per il bonifico SEPA
...
### <a name="to-set-up-a-vendor-card-for-sepa-credit-transfer" />Per impostare una scheda fornitore per il bonifico SEPA
...
### <a name="to-set-the-payment-journal-up-to-export-payment-files" />Per impostare le registrazioni pagamenti fino per esportare i file di pagamento
...
### <a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods" />Per connettere la definizione di scambio dati per uno o più tipi di pagamento con uno o più metodi di pagamento rilevanti
...
## <a name="preparing-the-payment-journal" />Preparare le registrazioni pagamenti
...
## <a name="exporting-payments-to-a-bank-file" />Esportare pagamenti in un file della banca
...
### <a name="to-export-payments-to-a-bank-file" />Per esportare pagamenti in un file della banca
...
### <a name="to-plan-when-to-post-exported-payments" />Per pianificare quando registrare i pagamenti esportati
...
### <a name="to-re-export-payments-to-a-bank-file" />Per riesportare i pagamenti in un file della banca
...
## <a name="posting-the-payments" />Registrazione dei pagamenti
