...
ms.author: bholtorf
---
# <a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a><a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a>Effettuare pagamenti con l'estensione AMC Banking 365 Fundamentals o il bonifico SEPA
...
## <a name="setting-up-the-amc-banking-365-fundamentals-extension"></a><a name="setting-up-the-amc-banking-365-fundamentals-extension"></a>Impostazione dell'estensione AMC Banking 365 Fundamentals
...
## <a name="setting-up-sepa-credit-transfer"></a><a name="setting-up-sepa-credit-transfer"></a>Impostare un bonifico SEPA
...
### <a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a><a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a>Per impostare un conto bancario per il bonifico SEPA
...
### <a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a><a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a>Per impostare una scheda fornitore per il bonifico SEPA
...
### <a name="to-set-the-payment-journal-up-to-export-payment-files"></a><a name="to-set-the-payment-journal-up-to-export-payment-files"></a>Per impostare le registrazioni pagamenti fino per esportare i file di pagamento
...
## <a name="preparing-the-payment-journal"></a><a name="preparing-the-payment-journal"></a>Preparare le registrazioni pagamenti
...
## <a name="exporting-payments-to-a-bank-file"></a><a name="exporting-payments-to-a-bank-file"></a>Esportare pagamenti in un file della banca
...
### <a name="to-export-payments-to-a-bank-file"></a><a name="to-export-payments-to-a-bank-file"></a>Per esportare pagamenti in un file della banca
...
### <a name="to-plan-when-to-post-exported-payments"></a><a name="to-plan-when-to-post-exported-payments"></a>Per pianificare quando registrare i pagamenti esportati
...
### <a name="to-re-export-payments-to-a-bank-file"></a><a name="to-re-export-payments-to-a-bank-file"></a>Per riesportare i pagamenti in un file della banca
...
## <a name="posting-the-payments"></a><a name="posting-the-payments"></a>Registrazione dei pagamenti
