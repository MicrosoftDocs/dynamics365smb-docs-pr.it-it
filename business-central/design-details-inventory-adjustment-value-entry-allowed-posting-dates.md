...
## <a name="change-the-user-setup" />Cambiare l'impostazione dell'utente
...
### <a name="overview-of-involved-posting-date-setup" />Panoramica della configurazione della data di registrazione coinvolta
...
#### <a name="user-setup" />Impostazione dell'utente
