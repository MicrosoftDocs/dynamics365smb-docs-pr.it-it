...
## <a name="change-the-user-setup"></a><a name="change-the-user-setup"></a>Cambiare l'impostazione dell'utente
...
### <a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a>Panoramica della configurazione della data di registrazione coinvolta
...
#### <a name="user-setup"></a><a name="user-setup"></a>Impostazione dell'utente
