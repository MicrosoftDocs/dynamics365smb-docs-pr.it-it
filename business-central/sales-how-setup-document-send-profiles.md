...
## <a name="to-set-up-a-document-sending-profile" />Per impostare un profilo di invio documenti
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Per specificare un profilo di invio in una scheda cliente
