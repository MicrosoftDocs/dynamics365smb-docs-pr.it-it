...
# <a name="sales-quick-start"></a><a name="sales-quick-start"></a><a name="sales-quick-start"></a>Inizio rapido delle vendite
...
## <a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a>Impostare gli articoli da vendere
...
### <a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a>Impostare un nuovo elemento
...
## <a name="set-up-customers"></a><a name="set-up-customers"></a><a name="set-up-customers"></a>Impostare i clienti
...
### <a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a>Impostare un nuovo cliente
...
## <a name="create-a-sales-order"></a><a name="create-a-sales-order"></a><a name="create-a-sales-order"></a>Creare un ordine di vendita
...
### <a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a>Per creare un ordine di vendita
...
## <a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a>Creare una fattura di vendita
...
### <a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a>Per creare e pubblicare una fattura di vendita
