...
ms.author: edupont
---
# <a name="set-up-resources-for-projects" />Impostazione delle risorse per i progetti
...
## <a name="to-set-up-a-resource" />Per impostare una risorsa
...
## <a name="to-set-up-a-resource-group" />Per impostare un gruppo di risorse
...
## <a name="to-set-capacity-for-a-resource" />Per impostare la capacità per una risorsa
...
## <a name="to-set-up-alternate-resource-costs" />Per impostare costi di risorsa alternativi
...
## <a name="to-set-up-alternate-resource-prices" />Per impostare prezzi di risorsa alternativi
