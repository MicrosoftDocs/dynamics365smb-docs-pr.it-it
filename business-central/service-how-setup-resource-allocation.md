...
# <a name="set-up-resource-allocation" />Impostare l'assegnazione delle risorse
...
## <a name="to-set-up-skills" />Per impostare le competenze
...
## <a name="to-assign-skills-to-service-items-and-resources" />Per assegnare le competenze agli articoli in assistenza e alle risorse
...
## <a name="to-set-up-zones" />Per impostare le zone
...
## <a name="to-assign-zones-to-customers-and-resources" />Per assegnare le zone ai clienti e alle risorse
...
## <a name="to-specify-what-to-show-when-a-resource-is-chosen" />Per specificare il contenuto da visualizzare quando si sceglie una risorsa
...
## <a name="to-update-resource-capacity" />Per aggiornare la capacità della risorsa
...
## <a name="to-update-skills-for-items-service-items-or-service-item-groups" />Per aggiornare le competenze per gli articoli, gli articoli in assistenza o i gruppi di articoli in assistenza
