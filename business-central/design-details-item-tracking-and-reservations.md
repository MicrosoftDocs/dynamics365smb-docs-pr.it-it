...
ms.author: edupont
---
# <a name="design-details-item-tracking-and-reservations" />Dettagli di progettazione: Tracciabilità articolo e impegni
...
## <a name="specific-reservation" />Impegno specifico
...
## <a name="nonspecific-reservation" />Impegno non specifico
...
## <a name="reshuffle" />Ridistribuzione
...
## <a name="supported-business-scenarios" />Scenari aziendali supportati
...
### <a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation" />Immissione di numeri seriali o di lotto in un documento in uscita con impegno non specifico errato
...
### <a name="reserve-specific-serial-or-lot-numbers" />Impegna un numero seriale o numeri di lotto
...
### <a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers" />Registrazione di un documento in uscita con impegno non specifico di un numero seriale o di lotto
