...
ms.author: edupont
---
# <a name="design-details-item-tracking-and-reservations"></a><a name="design-details-item-tracking-and-reservations"></a>Dettagli di progettazione: Tracciabilità articolo e impegni
...
## <a name="specific-reservation"></a><a name="specific-reservation"></a>Impegno specifico
...
## <a name="nonspecific-reservation"></a><a name="nonspecific-reservation"></a>Impegno non specifico
...
## <a name="reshuffle"></a><a name="reshuffle"></a>Ridistribuzione
...
## <a name="supported-business-scenarios"></a><a name="supported-business-scenarios"></a>Scenari aziendali supportati
...
### <a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation"></a><a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation"></a>Immissione di numeri seriali o di lotto in un documento in uscita con impegno non specifico errato
...
### <a name="reserve-specific-serial-or-lot-numbers"></a><a name="reserve-specific-serial-or-lot-numbers"></a>Impegna un numero seriale o numeri di lotto
...
### <a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers"></a><a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers"></a>Registrazione di un documento in uscita con impegno non specifico di un numero seriale o di lotto
