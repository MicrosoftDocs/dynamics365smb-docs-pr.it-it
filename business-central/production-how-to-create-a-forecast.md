...
ms.author: edupont
---
# <a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a>Creare una previsione della domanda
...
## <a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a>Previsioni di vendita e previsioni di produzione
...
## <a name="component-forecast"></a><a name="component-forecast"></a><a name="component-forecast"></a>Previsione di componenti
...
## <a name="forecasting-periods"></a><a name="forecasting-periods"></a><a name="forecasting-periods"></a>Previsione di periodi
...
## <a name="forecast-by-locations"></a><a name="forecast-by-locations"></a><a name="forecast-by-locations"></a>Previsione in base alle ubicazioni
...
### <a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a>Usare la previsione in base alle ubicazioni
...
### <a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a>Non utilizzare previsioni in base alle ubicazioni
...
## <a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a>Per creare una previsione della domanda
