...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Creare una previsione della domanda
...
## <a name="sales-forecasts-and-production-forecasts" />Previsioni di vendita e previsioni di produzione
...
## <a name="component-forecast" />Previsione di componenti
...
## <a name="forecasting-periods" />Previsione di periodi
...
## <a name="forecast-by-locations" />Previsione in base alle ubicazioni
...
### <a name="use-forecast-by-locations" />Usare la previsione in base alle ubicazioni
...
### <a name="do-not-use-forecast-by-locations" />Non utilizzare previsioni in base alle ubicazioni
...
## <a name="to-create-a-demand-forecast" />Per creare una previsione della domanda
