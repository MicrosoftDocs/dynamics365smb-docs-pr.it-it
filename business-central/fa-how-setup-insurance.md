...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Impostare l'assicurazione cespiti
...
## <a name="to-set-up-general-insurance-information" />Per impostare le informazioni generali delle assicurazioni
...
## <a name="to-set-up-insurance-types" />Per impostare i tipi di assicurazione
...
## <a name="to-set-up-insurance-cards" />Per impostare le schede assicurazione
...
## <a name="to-set-up-insurance-journal-templates" />Per impostare le definizioni registrazioni assicurazioni
...
## <a name="to-set-up-insurance-journal-batches" />Per impostare i batch registrazioni assicurazioni
