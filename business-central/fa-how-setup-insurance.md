...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a>Impostare l'assicurazione cespiti
...
## <a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a>Per impostare le informazioni generali delle assicurazioni
...
## <a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a>Per impostare i tipi di assicurazione
...
## <a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a>Per impostare le schede assicurazione
...
## <a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a>Per impostare le definizioni registrazioni assicurazioni
...
## <a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a>Per impostare i batch registrazioni assicurazioni
