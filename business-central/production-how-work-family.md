...
ms.author: edupont
---
# <a name="work-with-production-families"></a><a name="work-with-production-families"></a><a name="work-with-production-families"></a>Utilizzare famiglie di prodotti
...
## <a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a>Per impostare una famiglia di prodotti
...
## <a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a>Per produrre in base a una famiglia di prodotti
