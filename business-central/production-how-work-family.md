...
ms.author: edupont
---
# <a name="work-with-production-families" />Utilizzare famiglie di prodotti
...
## <a name="to-set-up-a-production-family" />Per impostare una famiglia di prodotti
...
## <a name="to-produce-based-on-a-production-family" />Per produrre in base a una famiglia di prodotti
