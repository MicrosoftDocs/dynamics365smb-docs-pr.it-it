...
# <a name="set-up-fault-reporting" />Impostare il reporting dei guasti
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />Per specificare il livello globale di reporting dei guasti
...
## <a name="to-create-fault-and-resolution-code-relationships" />Per creare relazioni codici guasto e risoluzione
