...
# <a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a>Impostare il reporting dei guasti
...
## <a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a>Per specificare il livello globale di reporting dei guasti
...
## <a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a>Per creare relazioni codici guasto e risoluzione
