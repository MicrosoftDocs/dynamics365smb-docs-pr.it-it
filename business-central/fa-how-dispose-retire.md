...
ms.author: edupont
---
# <a name="dispose-of-or-retire-fixed-assets" />Smaltimento o ritiro dei cespiti
...
## <a name="to-post-a-disposal-from-the-fixed-asset-gl-journal" />Per registrare una cessione tramite Registrazioni Cespiti in C/G
...
## <a name="to-view-disposal-ledger-entries" />Per visualizzare i movimenti contabili di cessione
...
## <a name="see-related-microsoft-trainingtrainingmodulesdispose-fixed-assets" />Vedi il relativo [training Microsoft](/training/modules/dispose-fixed-assets/)
