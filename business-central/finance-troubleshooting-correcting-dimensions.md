...
# <a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a>Risoluzione dei problemi e correzione delle dimensioni
...
## <a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a>Risoluzione dei problemi relativi alle dimensioni
...
## <a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a>Modifica delle assegnazioni delle dimensioni dopo la registrazione
...
### <a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a>Configurazione delle dimensioni delle correzioni
...
### <a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a>Correzione di una dimensione
...
### <a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a>Convalida delle correzioni delle dimensioni
...
### <a name="undoing-a-correction"></a><a name="undoing-a-correction"></a>Annullamento di una correzione
...
### <a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a>Correzioni dimensionali su set di dati di grandi dimensioni
...
### <a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a>Utilizzare le visualizzazioni delle analisi con correzioni delle dimensioni
...
### <a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a>Visualizzazione delle correzioni delle dimensioni storiche
...
### <a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a>Gestione delle correzioni incomplete
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a>Utilizzare la contabilità industriale con movimenti C/G corretti
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/dimensions-dynamics-365-business-central/)
