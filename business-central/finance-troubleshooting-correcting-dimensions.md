...
### <a name="set-up-dimension-corrections"></a>Imposta le correzioni dimensionali
...
### <a name="correct-a-dimension"></a>Correggere una dimensione
...
1. Per avviare una correzione dimensionale, utilizzare una delle seguenti pagine:
    ...
    * Nella pagina **Registri G/L**, selezionando un registro e quindi scegliendo l'azione **Correggi dimensioni** . Questa azione avvia una correzione per i movimenti nel registro selezionato.
    * Nella pagina **Voci contabilità generale**, scegliendo l'azione **Correggi dimensioni** . 
...
### <a name="validate-dimension-corrections"></a>Convalida delle correzioni dimensionali
...
### <a name="undo-a-correction"></a>Annulla una correzione
...
### <a name="view-historical-dimension-corrections"></a>Visualizza le correzioni dimensionali storiche
...
### <a name="handle-incomplete-corrections"></a>Gestire le correzioni incomplete
