...
ms.author: edupont
---
# <a name="invoice-jobs"></a><a name="invoice-jobs"></a>Fatturazione di commesse
...
## <a name="to-create-multiple-job-sales-invoices"></a><a name="to-create-multiple-job-sales-invoices"></a>Per creare più fatture di vendita commesse
...
## <a name="to-create-and-post-job-sales-invoice-from-job-planning-lines"></a><a name="to-create-and-post-job-sales-invoice-from-job-planning-lines"></a>Per creare e registrare una fattura di vendita commessa dalle righe di pianificazione commessa
