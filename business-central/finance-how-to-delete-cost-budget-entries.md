...
ms.author: edupont
---
# <a name="delete-cost-budget-entries"></a><a name="delete-cost-budget-entries"></a>Elimina mov. budget costi
...
## <a name="to-delete-a-cost-budget-entry"></a><a name="to-delete-a-cost-budget-entry"></a>Per eliminare un mov. budget costi
