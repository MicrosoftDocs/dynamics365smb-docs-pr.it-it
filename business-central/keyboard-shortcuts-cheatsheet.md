...
# <a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a>Riferimento rapido per tasti di scelta rapida - Solo PC
...
#### <a name="navigate--select-rows"></a><a name="navigate--select-rows"></a><a name="navigate--select-rows"></a>Spostarsi e selezionare righe
...
#### <a name="copy--paste"></a><a name="copy--paste"></a><a name="copy--paste"></a>Copiare e incollare
...
#### <a name="search-filter--sort"></a><a name="search-filter--sort"></a><a name="search-filter--sort"></a>Cercare, filtrare e ordinare
...
#### <a name="quick-entry"></a><a name="quick-entry"></a><a name="quick-entry"></a>Accesso rapido
...
##### <a name="report-preview"></a><a name="report-preview"></a><a name="report-preview"></a>Visualizzare in anteprima un report

|Premi questi tasti|Operazione da eseguire|
|-|-|
|<kbd>CTRL</kbd>+<kbd>Home</kbd>/<kbd>Fine</kbd>|Passare alla prima/ultima pagina|

#### <a name="numeric-keypad"></a><a name="numeric-keypad"></a><a name="numeric-keypad"></a>Tastiera numerica
