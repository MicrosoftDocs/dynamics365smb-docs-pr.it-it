...
# <a name="keyboard-quick-reference---pc-only" />Riferimento rapido per tasti di scelta rapida - Solo PC
...
#### <a name="navigate--select-rows" />Spostarsi e selezionare righe
...
#### <a name="copy--paste" />Copiare e incollare
...
#### <a name="search-filter--sort" />Cercare, filtrare e ordinare
...
#### <a name="quick-entry" />Accesso rapido
...
##### <a name="report-preview" />Visualizzare in anteprima un report

|Premi questi tasti|Operazione da eseguire|
|-|-|
|<kbd>CTRL</kbd>+<kbd>Home</kbd>/<kbd>Fine</kbd>|Passare alla prima/ultima pagina|

#### <a name="numeric-keypad" />Tastiera numerica
