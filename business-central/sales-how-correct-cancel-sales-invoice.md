...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-sales-invoices" />Correggere o annullare le fatture di vendita non pagate
...
## <a name="to-cancel-a-posted-sales-invoice" />Per annullare una fattura di vendita registrata
...
## <a name="to-correct-a-posted-sales-invoice" />Per correggere una fattura di vendita registrata
