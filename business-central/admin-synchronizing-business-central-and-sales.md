...
# <a name="synchronizing-data-in-business-central-with-microsoft-dataverse" />Sincronizzazione di dati in Business Central con Microsoft Dataverse
...
## <a name="standard-table-mapping-for-synchronization" />Mapping delle tabelle standard per la sincronizzazione
...
### <a name="tip-for-admins-viewing-table-mappings" />Suggerimento per amministratori: visualizzazione di mapping di tabelle
