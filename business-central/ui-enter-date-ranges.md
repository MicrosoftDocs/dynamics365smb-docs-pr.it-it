...
# <a name="work-with-calendar-dates-and-times" />Utilizzare date e orari del calendario
...
## <a name="check-your-region-and-language-settings" />Verificare le impostazioni di lingua e paese
...
### <a name="picking-dates-from-the-calendar" />Selezionare le date dal calendario
...
### <a name="day-week-year-pattern" />Schema giorno\-settimana\-anno
...
### <a name="digit-patterns" />Schemi con cifre
...
### <a name="work-date" />Data del lavoro
...
### <a name="closing-date" />Data chiusura
...
## <a name="use-date-formulas" />Usare le formule data
...
## <a name="entering-combined-dates-and-times" />Immissione di date e ore combinate
