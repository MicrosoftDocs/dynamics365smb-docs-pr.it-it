...
# <a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a>Utilizzare date e orari del calendario
...
## <a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a>Verificare le impostazioni di lingua e paese
...
### <a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a>Selezionare le date dal calendario
...
### <a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a>Schema giorno\-settimana\-anno
...
### <a name="digit-patterns"></a><a name="digit-patterns"></a><a name="digit-patterns"></a>Schemi con cifre
...
### <a name="today"></a><a name="today"></a><a name="today"></a>Oggi
...
### <a name="period"></a><a name="period"></a><a name="period"></a>Periodo
...
### <a name="work-date"></a><a name="work-date"></a><a name="work-date"></a>Data del lavoro
...
### <a name="closing-date"></a><a name="closing-date"></a><a name="closing-date"></a>Data chiusura
...
## <a name="setting-ranges"></a><a name="setting-ranges"></a><a name="setting-ranges"></a><a name="BKMK_SettingDateRanges"></a> Impostazione di intervalli di date
...
## <a name="use-date-formulas"></a><a name="use-date-formulas"></a><a name="use-date-formulas"></a>Usare le formule data
...
## <a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a>Immissione di date e ore combinate
