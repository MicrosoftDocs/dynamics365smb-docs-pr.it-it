...
ms.author: edupont
---
# <a name="setting-up-relationship-management" />Setup Relationship Management
...
## <a name="automatically-recording-interactions" />Interazioni di registrazioni automatiche
...
## <a name="synchronizing-contacts-with-customers-and-more" />Sincronizzare i contatti con i clienti e altri soggetti
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities" />Assegnare una numerazione ai contatti e alle opportunità
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created" />Cercare i contatti duplicati quando vengono creati dei contatti
