...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central" />Visualizzare e modificare in Excel da Business Central
...
## <a name="open-in-excel" />Apri in Excel
...
## <a name="edit-in-excel" />Modifica in Excel
...
### <a name="first-time-sign-in" />Primo accesso
...
### <a name="work-across-environments-and-companies" />Utilizzo di ambienti e società
...
### <a name="limits-when-using-excel-for-the-web" />Limiti quando si utilizza Excel per il Web
...
## <a name="see-the-differences-between-the-options" />Vedere le differenze tra le opzioni
<br><br>  
