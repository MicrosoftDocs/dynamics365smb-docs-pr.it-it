...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central"></a><a name="viewing-and-editing-in-excel-from-business-central"></a>Visualizzare e modificare in Excel da Business Central
...
## <a name="open-in-excel"></a><a name="open-in-excel"></a>Apri in Excel
...
## <a name="edit-in-excel"></a><a name="edit-in-excel"></a>Modifica in Excel
...
### <a name="first-time-sign-in"></a><a name="first-time-sign-in"></a>Primo accesso
...
### <a name="work-across-environments-and-companies"></a><a name="work-across-environments-and-companies"></a>Utilizzo di ambienti e società
...
### <a name="limits-when-using-excel-for-the-web"></a><a name="limits-when-using-excel-for-the-web"></a>Limiti quando si utilizza Excel per il Web
...
## <a name="see-the-differences-between-the-options"></a><a name="see-the-differences-between-the-options"></a>Vedere le differenze tra le opzioni
<br><br>  
