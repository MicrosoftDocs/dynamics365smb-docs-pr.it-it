...
# <a name="set-up-service-contracts" />Impostare i contratti di assistenza
...
## <a name="to-set-up-a-service-contract-group" />Per impostare un gruppo di contratti di assistenza
...
## <a name="to-set-up-a-service-contract-account-group" />Per impostare un gruppo conto dei contratti di assistenza
...
## <a name="to-set-up-a-contract-template" />Per impostare un modello di contratto
...
## <a name="to-set-up-a-customer-template" />Per impostare un modello di cliente
