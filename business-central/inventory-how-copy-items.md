...
ms.author: edupont
---
# <a name="copy-existing-items-to-create-new-items" />Copiare articoli esistenti per creare nuovi articoli
...
## <a name="to-copy-an-existing-item-to-a-new-item" />Per copiare un articolo esistente in un nuovo articolo
