...
ms.author: edupont
---
# <a name="design-details-accounts-in-the-general-ledger" />Dettagli di progettazione: Conti nella contabilità generale
...
## <a name="from-the-inventory-ledger" />Dai contabili inventario
...
## <a name="from-the-capacity-ledger" />Dal contabile capacità
...
## <a name="calculating-the-amount-to-post-to-the-general-ledger" />Calcolo della quantità da registrare nella contabilità generale
