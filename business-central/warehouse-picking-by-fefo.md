...
ms.author: edupont
---
# <a name="enable-picking-items-by-fefo"></a><a name="enable-picking-items-by-fefo"></a><a name="enable-picking-items-by-fefo"></a>Abilitare il prelievo di articoli tramite il metodo FEFO
