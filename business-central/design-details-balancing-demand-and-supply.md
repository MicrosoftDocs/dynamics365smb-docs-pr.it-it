...
---
# <a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a>Dettagli di progettazione: Bilanciamento della domanda e dell'offerta
...
## <a name="supply-and-demand"></a><a name="supply-and-demand"></a><a name="supply-and-demand"></a>Domanda e offerta
...
## <a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a>Il concetto di bilanciamento in breve
...
## <a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a>Elaborare gli ordini prima della data di inizio pianificazione
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a>I numeri seriali o di lotto e i collegamenti ordine su ordine sono esenti dal periodo precedente
...
## <a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a>Caricare i profili di magazzino
...
### <a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a>Le dimensioni articolo sono separate
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a>I numeri seriali e di lotto vengono caricati dal livello di specifica
...
### <a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a>I collegamenti ordine su ordine non sono mai interrotti
...
### <a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a>Il componente richiesto viene caricato in base alle modifiche dell'ordine di produzione
...
### <a name="consume-safety-stock"></a><a name="consume-safety-stock"></a><a name="consume-safety-stock"></a>Consumare la scorta di sicurezza
...
### <a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a>La domanda di previsione viene ridotta dagli ordini di vendita
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a>La domanda dell'ordine programmato viene ridotta dagli ordini di vendita
...
## <a name="prioritize-orders"></a><a name="prioritize-orders"></a><a name="prioritize-orders"></a>Assegnare la priorità agli ordini
...
### <a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a>Priorità sul lato della domanda
...
### <a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a>Priorità sul lato dell'approvvigionamento
...
### <a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a>Priorità correlata allo stato di domanda e offerta
...
## <a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a>Bilanciamento dell'offerta con la domanda
...
### <a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a>Regole per le azioni per gli eventi di approvvigionamento
...
### <a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a>Determinare la quantità di approvvigionamento
...
### <a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a>Collegamenti della tracciabilità ordini durante la pianificazione
...
## <a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a>Chiusura della domanda e dell'offerta bilanciate
...
### <a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a>Creare la riga di pianificazione (azione suggerita)
