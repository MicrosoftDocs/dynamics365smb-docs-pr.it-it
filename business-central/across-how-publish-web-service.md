...
ms.author: edupont
---
# <a name="publish-a-web-service" />Pubblicare un servizio Web
...
## <a name="creating-and-publishing-a-web-service" />Creazione e pubblicazione di un servizio Web

I seguenti passaggi illustrano come creare e pubblicare un servizio Web.  

### <a name="to-create-and-publish-a-web-service" />Per creare e pubblicare un servizio Web
...
### <a name="to-verify-the-availability-of-a-web-service" />Per verificare la disponibilità di un servizio Web
