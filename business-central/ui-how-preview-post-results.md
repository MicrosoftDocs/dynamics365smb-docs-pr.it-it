...
ms.author: solsen
---
# <a name="preview-posting-results" />Visualizzare in anteprima i risultati della contabilizzazione
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice" />Per visualizzare in anteprima i movimenti C/G che deriveranno dalla registrazione di una fattura di acquisto
