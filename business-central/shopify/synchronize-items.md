...
# <a name="synchronize-items-and-inventory" />Sincronizzare articoli e inventario
...
## <a name="define-item-synchronizations" />Definire le sincronizzazioni degli articoli
...
## <a name="import-items-from-shopify" />Importare articoli da Shopify
...
### <a name="effect-of-shopify-product-skus-and-barcodes-on-mapping-and-creating-items-and-variants-in-business-central" />Effetto delle SKU e dei codici a barre dei prodotti Shopify sulla mappatura e sulla creazione di articoli e varianti in Business Central
...
## <a name="export-items-to-shopify" />Esportare articoli in Shopify
...
### <a name="fields-mapping-overview" />Panoramica mapping dei campi
...
## <a name="run-item-synchronization" />Esegui sincronizzazione articoli

La sincronizzazione completa o parziale degli articoli può essere eseguita in molti modi diversi.

### <a name="initial-sync-of-items-from-business-central-to-shopify" />Sincronizzazione iniziale degli articoli da Business Central a Shopify
...
### <a name="sync-products-from-shopify-to-business-central" />Sincronizza i prodotti da Shopify a Business Central
...
### <a name="ad-hoc-updates-of-shopify-products" />Aggiornamenti ad hoc di prodotti Shopify
...
## <a name="sync-item-images" />Sincronizza immagini articolo
...
### <a name="sync-product-images-from-the-shopify-shop-page" />Sincronizzare le immagini dei prodotti dalla pagina del punto vendita Shopify
...
### <a name="sync-product-images-from-the-shopify-products-page" />Sincronizzare le immagini dei prodotti dalla pagina dei prodotti Shopify
...
### <a name="image-synchronization-remarks" />Osservazioni sulla sincronizzazione delle immagini
...
## <a name="sync-prices-with-shopify" />Sincronizzare i prezzi con Shopify
...
### <a name="sync-prices-from-the-shopify-products-page" />Sincronizzare i prezzi dalla pagina dei prodotti Shopify

1. Vai alla ![lampadina che apre la funzione Dimmi](../media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") della ricerca. e immetti **Prodotti Shopify**, quindi scegli il collegamento correlato.
2. Scegli l'azione **Sincronizza i prezzi con Shopify**.

### <a name="price-calculation-remarks" />Nore sul calcolo del prezzo
...
## <a name="sync-inventory-to-shopify" />Sincronizzare l'inventario con Shopify
...
### <a name="to-enable-inventory-sync" />Per abilitare la sincronizzazione dell'inventario
...
### <a name="sync-inventory-from-the-shopify-shop-page" />Sincronizzare l'inventario dalla pagina del punto vendita Shopify

1. Vai alla ![lampadina che apre la funzione Dimmi](../media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") della ricerca. e immetti **Punti vendita Shopify**, quindi scegli il collegamento correlato.
2. Seleziona il punto vendita per il quale desideri sincronizzare l'inventario per l'apertura della pagina **Scheda del punto vendita Shopify**.
3. Scegli l'azione **Sincronizza inventario**.

### <a name="sync-inventory-from-the-shopify-products-page" />Sincronizzare l'inventario dalla pagina dei prodotti Shopify

1. Vai alla ![lampadina che apre la funzione Dimmi](../media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") della ricerca. e immetti **Prodotti Shopify**, quindi scegli il collegamento correlato.
2. Scegli l'azione **Sincronizza inventario**.

### <a name="inventory-remarks" />Note sull'inventario
...
* L'inventario e la spedizione sui **Servizi di evasione ordini di Business Central** non sono supportati, utilizza invece le località normali.

#### <a name="example-of-calculation-of-projected-available-balance" />Esempio di calcolo del saldo disponibile previsto
