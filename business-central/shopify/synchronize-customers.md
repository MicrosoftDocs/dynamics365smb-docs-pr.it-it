...
# <a name="synchronize-customers" />Sincronizzare clienti
...
## <a name="important-settings-when-importing-customers-from-shopify" />Impostazioni importanti durante l'importazione di clienti da Shopify
...
### <a name="customer-template-per-country" />Modello cliente per paese
...
## <a name="export-customers-to-shopify" />Esportare clienti su Shopify
...
### <a name="populate-customer-information-in-shopify" />Inserisci le informazioni sui clienti in Shopify
...
## <a name="sync-customers" />Sincronizzare clienti
