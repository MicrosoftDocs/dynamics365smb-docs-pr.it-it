...
ms.author: edupont
---
# <a name="reconcile-payments-that-cannot-be-applied-automatically" />Riconciliare i pagamenti che non possono essere collegati automaticamente
...
## <a name="to-reconcile-payments-that-cannot-be-applied-automatically" />Per riconciliare i pagamenti che non possono essere collegati automaticamente
