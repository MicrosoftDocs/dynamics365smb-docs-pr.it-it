...
ms.author: edupont
---
# <a name="import-multiple-item-pictures" />Importare molteplici immagini articolo
...
## <a name="to-name-picture-files-by-the-item-names-and-prepare-the-zip-file" />Per denominare i file immagine con i nile degli articoli e prepare il file ZIP
...
## <a name="to-import-item-pictures" />Per importare immagini articolo
