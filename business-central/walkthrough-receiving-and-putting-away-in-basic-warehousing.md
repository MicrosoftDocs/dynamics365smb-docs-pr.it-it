...
---
# <a name="walkthrough-receiving-and-putting-away-in-basic-warehouse-configurations" />Procedura dettagliata: ricezione e stoccaggio nelle configurazioni di warehouse di base
...
## <a name="setting-up-the-location" />Impostazione dell'ubicazione

L'impostazione della pagina **Scheda ubicazione** definisce i flussi della warehouse della società.  

### <a name="to-set-up-the-location" />Per impostare l'ubicazione
...
## <a name="create-the-purchase-order" />Creare l'ordine di acquisto

Gli ordini di acquisto sono il tipo più comune di documenti origine in entrata.  

### <a name="to-create-the-purchase-order" />Per creare l'ordine di acquisto.
...
## <a name="receive-and-put-the-items-away" />Ricevere e stoccare gli articoli
...
### <a name="to-receive-and-put-the-items-away" />Per ricevere e stoccare gli articoli
