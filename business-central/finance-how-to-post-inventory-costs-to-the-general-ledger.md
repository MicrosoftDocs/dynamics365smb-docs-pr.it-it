...
ms.author: edupont
---
# <a name="reconcile-inventory-costs-with-the-general-ledger" />Riconciliare i costi di magazzino con la contabilità generale
...
## <a name="to-post-inventory-costs-manually" />Per registrare manualmente i costi di magazzino
...
## <a name="to-audit-the-reconciliation-between-the-inventory-ledger-and-the-general-ledger" />Per controllare la riconciliazione tra il movimento contabile di inventario e la contabilità generale
...
## <a name="reporting-costs-and-reconciling-with-the-general-ledger" />Creazione di report dei costi e riconciliazione con la contabilità generale
