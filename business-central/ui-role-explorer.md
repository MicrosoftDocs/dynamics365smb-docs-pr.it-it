...
# <a name="finding-pages-with-the-role-explorer" />Ricerca di pagine con Esplora ruoli
...
## <a name="open-the-role-explorer" />Aprire l'esploratore di ruoli
...
## <a name="navigate-features" />Navigare le caratteristiche
...
## <a name="search-for-features" />Cercare le caratteristiche
...
## <a name="explore-other-roles" />Esplora altri ruoli
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer" />Espandere e comprimere i nodi nell'esploratore di ruoli
