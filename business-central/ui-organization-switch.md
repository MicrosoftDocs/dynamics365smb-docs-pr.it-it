...
# <a name="switching-to-another-company-or-environment" />Passare a un'altra società o ambiente
...
## <a name="about-companies-and-environments" />Informazioni su società e ambienti
...
## <a name="features-for-switching-company-or-environment" />Funzionalità per passare a una società o un ambiente diverso
...
## <a name="use-the-company-switcher" />Usa il selettore di società
...
## <a name="use-the-app-launcher" />Usare l'icona di avvio delle app
...
-->
## <a name="use-my-settings" />Usare le Impostazioni personali
...
## <a name="use-company-hub" />Usare l'hub aziendale
