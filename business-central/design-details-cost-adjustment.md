...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Dettagli di progettazione: Rettifica costo
...
## <a name="detecting-the-adjustment" />Rilevazione della rettifica
...
### <a name="item-application-entry" />Mov. collegamento articoli
...
### <a name="average-cost-adjustment-entry-point" />Rettifica costo medio cod. spedizioni Intrastat
...
### <a name="order-level" />Livello di ordine
...
## <a name="manual-versus-automatic-cost-adjustment" />Rettifica costo automatica e rettifica costo manuale
...
## <a name="adjust-cost---item-entries-batch-job" />Processo batch Rettifica costo - Mov. art.
...
## <a name="automatic-cost-adjustment" />Rettifica costo automatica
