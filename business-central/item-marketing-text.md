...
# <a name="add-marketing-text-to-items"></a><a name="add-marketing-text-to-items"></a>Aggiungere del testo di marketing agli articoli
...
## <a name="create-ai-generated-marketing-text-preview-with-copilot"></a><a name="create-ai-generated-marketing-text-preview-with-copilot"></a><a name=copilot></a>Creare un testo di marketing generato dall'intelligenza artificiale (anteprima) con Copilot
...
### <a name="create-first-draft-with-copilot"></a><a name="create-first-draft-with-copilot"></a>Creare la prima bozza con Copilot
...
### <a name="review-edit-and-save-text"></a><a name="review-edit-and-save-text"></a>Rivedere, modificare e salvare il testo
...
### <a name="improve-and-tailor-text-suggestions"></a><a name="improve-and-tailor-text-suggestions"></a>Migliorare e personalizzare i suggerimenti di testo
...
## <a name="create-marketing-text-from-scratch"></a><a name="create-marketing-text-from-scratch"></a>Creare un testo di marketing da zero
