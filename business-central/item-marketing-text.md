...
# <a name="add-marketing-text-to-items" />Aggiungere del testo di marketing agli articoli
...
### <a name="create-first-draft-with-copilot" />Creare la prima bozza con Copilot
...
### <a name="review-edit-and-save-text" />Rivedere, modificare e salvare il testo
...
### <a name="improve-and-tailor-text-suggestions" />Migliorare e personalizzare i suggerimenti di testo
...
## <a name="create-marketing-text-from-scratch" />Creare un testo di marketing da zero
