...
ms.author: bholtorf
---
# <a name="create-production-boms" />Creare le distinte base di produzione
...
## <a name="to-create-a-production-bom" />Per creare una DB di produzione
...
## <a name="to-create-a-new-version-of-a-production-bom" />Per creare una nuova versione delle DB di produzione
...
## <a name="quantity-calculation-formula-on-production-boms" />Formula di calcolo della quantità nelle DB di produzione
