...
| **Conto costi WIP** |Conto WIP per il costo calcolato dei semilavorati per la commessa, corrispondente a un conto cespiti patrimoniali. | Costo collegato, Costi riconosciuti|
...
| **Conto costi comm. coll.** |Contropartita per il conto costi WIP, opposto del conto spesa negativa. Utilizzato quando **Metodo di registrazione WIP utilizzato** è impostato su *Commessa*. | Costi collegati, Costi riconosciuti|
| **Conto costi articolo collegati** |Uguale a  **Conto costi comm. coll.**, ma utilizzato quando **Metodo di registrazione WIP utilizzato** è impostato su *Mov. contabili commesse*.| |
| **Conto costi risorse collegati** |Uguale a  **Conto costi comm. coll.**, ma utilizzato quando **Metodo di registrazione WIP utilizzato** è impostato su *Mov. contabili commesse*.| |
| **Conto costi C/G collegati** |Uguale a  **Conto costi comm. coll.**, ma utilizzato quando **Metodo di registrazione WIP utilizzato** è impostato su *Mov. contabili commesse*.| |
| **Conto rettifica costi comm.** |Contropartita per il conto costi sospesi WIP, corrispondente a un conto spesa. | Costi sospesi|
...
| **Conto vendite commesse coll.** |Contropartita per il conto vendite fatturate WIP, che rappresenta un conto avere opposto. | Vendite collegate, Vendite riconosciute|
