...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories" />Preparare i report finanziari con i dati finanziari e le categorie di conti
...
## <a name="financial-reports" />Report finanziari
...
## <a name="gl-account-categories" />Categorie conto C/G
...
## <a name="create-a-new-financial-report" />Creare un nuovo report finanziario
...
### <a name="edit-a-column-definition" />Modificare una definizione di colonna
...
### <a name="create-a-column-that-calculates-percentages" />Creare una colonna per il calcolo delle percentuali
...
## <a name="set-up-financial-reports-with-overviews" />Impostare report finanziari con panoramiche
...
## <a name="comparing-accounting-periods-using-period-formulas" />Confronto dei periodi contabili con le formule periodo
...
## <a name="print-and-save-financial-reports" />Stampare e salvare i report finanziari
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document" />Pianificare un report finanziario o salvarlo come documento PDF, Word o Excel
...
## <a name="importing-or-exporting-financial-reports" />Importazione o esportazione dei report finanziari
...
### <a name="import-and-export-financial-reports" />Importare ed esportare report finanziari
...
## <a name="see-related-microsoft-training" />Vedi il relativo [training Microsoft](/training/modules/configure-financial-reports-dynamics-365-business-central/index).
