...
ms.author: edupont
---
# <a name="categorize-items" />Classificare gli articoli
...
## <a name="to-create-an-item-category" />Per creare una categoria articolo
...
## <a name="to-assign-an-item-category-to-an-item" />Per assegnare una categoria articolo a un articolo
