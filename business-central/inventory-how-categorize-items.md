...
ms.author: edupont
---
# <a name="categorize-items"></a><a name="categorize-items"></a>Classificare gli articoli
...
## <a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a>Per creare una categoria articolo
...
## <a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a>Per assegnare una categoria articolo a un articolo
