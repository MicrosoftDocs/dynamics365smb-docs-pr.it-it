...
ms.author: edupont
---
# <a name="delete-approval-workflows"></a><a name="delete-approval-workflows"></a>Eliminare i workflow di approvazione
...
## <a name="delete-a-workflow"></a><a name="delete-a-workflow"></a>Eliminare un flusso di lavoro
