...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Impostare aree di produzione e centri di lavoro
...
## <a name="to-set-up-a-work-center" />Per impostare un'area di produzione
...
## <a name="considerations-about-capacity" />Considerazioni sulla capacità
...
### <a name="run-time" />Tempo lavorazione
...
### <a name="setup-time" />Tempo di setup
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Area di produzione che elabora più ordini contemporaneamente
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Una risorsa efficiente può dedicare solo una parte della data del lavoro al lavoro produttivo
...
### <a name="consolidated-calendar" />Calendario consolidato
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Esempio: diversi centri di lavoro assegnati a un'area di produzione
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />Per impostare un centro lavoro o area di produzione con capacità-vincolata
