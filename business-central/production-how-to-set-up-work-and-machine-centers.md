...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a>Impostare aree di produzione e centri di lavoro
...
## <a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a>Per impostare un'area di produzione
...
## <a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a>Considerazioni sulla capacità
...
### <a name="run-time"></a><a name="run-time"></a>Tempo lavorazione
...
### <a name="setup-time"></a><a name="setup-time"></a>Tempo di setup
...
### <a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a>Area di produzione che elabora più ordini contemporaneamente
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a>Una risorsa efficiente può dedicare solo una parte della data del lavoro al lavoro produttivo
...
### <a name="consolidated-calendar"></a><a name="consolidated-calendar"></a>Calendario consolidato
...
### <a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a>Esempio: diversi centri di lavoro assegnati a un'area di produzione
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a>Per impostare un centro lavoro o area di produzione con capacità-vincolata
