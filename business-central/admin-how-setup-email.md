...
>
> "Non dispone dell'autorizzazione per accedere alla risorsa: https:\/ /graph.microsoft.com/.default. Contattare l'amministratore di sistema.".
>
> Il problema è causato dalle azioni associate nelle API dei documenti che inviano e-mail. Per ulteriori informazioni sulle azioni associate, vedi [Azioni associate](/dynamics365/business-central/dev-itpro/api-reference/v2.0/resources/dynamics_salesinvoice#bound-actions). 
>
...
|Microsoft Graph / Mail.Send.Shared|Delegato|Cassetta postale condivisa|
