...
ms.author: edupont
---
# <a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a>Impostare i calendari del reparto produzione
...
## <a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a>Per creare turni lavorativi
...
## <a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a>Per impostare un calendario reparto prod.
...
## <a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a>Per calcolare un calendario aree di produzione
...
## <a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a>Per registrare un'assenza dell'area di produzione
