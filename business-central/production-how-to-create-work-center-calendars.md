...
ms.author: edupont
---
# <a name="set-up-shop-calendars" />Impostare i calendari del reparto produzione
...
## <a name="to-create-work-shifts" />Per creare turni lavorativi
...
## <a name="to-set-up-a-shop-calendar" />Per impostare un calendario reparto prod.
...
## <a name="to-calculate-a-work-center-calendar" />Per calcolare un calendario aree di produzione
...
## <a name="to-record-work-center-absence" />Per registrare un'assenza dell'area di produzione
