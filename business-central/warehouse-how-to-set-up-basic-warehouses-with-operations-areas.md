...
ms.author: edupont
---
# <a name="set-up-basic-warehouses-with-operations-areas" />Impostare le warehouse di base con aree di operazioni
...
## <a name="to-enable-inventory-documents-for-internal-operation-activities" />Per abilitare i documenti di magazzino per le attività delle operazioni interne
...
## <a name="to-define-a-default-bin-structure-in-the-production-area" />Per definire una struttura di collocazione di default nell'area di produzione
...
## <a name="to-define-a-default-bin-structure-in-the-assembly-area" />Per definire una struttura di collocazione di default nell'area di assemblaggio
...
### <a name="to-set-up-that-an-inventory-movement-is-automatically-created-when-the-inventory-pick-for-the-assembly-item-is-created" />Per impostare la creazione automatica di un movimento di magazzino quando viene creato il prelievo magazzino per l'articolo di assemblaggio
...
### <a name="to-set-up-the-bin-in-the-assembly-area-where-components-are-placed-by-default-before-they-can-be-consumed-in-assembly" />Per impostare la collocazione nell'area di assemblaggio in cui i componenti vengono inseriti per default prima di poter essere consumati in fase di assemblaggio
...
### <a name="to-set-up-the-bin-in-the-assembly-area-where-finished-assembly-items-are-posted-to-when-they-are-assembled-to-stock" />Per impostare la collocazione nell'area di assemblaggio in cui gli articoli di assemblaggio completati sono registrati quando vengono assemblati per magazzino
...
### <a name="to-set-up-the-bin-where-finished-assembly-items-are-posted-to-when-they-are-assembled-to-a-linked-sales-order" />Per impostare la collocazione in cui gli articoli di assemblaggio completati sono registrati quando vengono assemblati per ordine di vendita collegato
...
## <a name="to-create-dedicated-component-bins" />Per creare collocazioni di componenti dedicate
