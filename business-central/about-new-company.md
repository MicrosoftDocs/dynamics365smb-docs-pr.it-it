...
---
# <a name="create-new-companies-in-includeprodshortincludesprodshortmd" />Creare nuove società in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="choose-the-right-template" />Scegliere il modello giusto
...
## <a name="copy-a-company" />Copiare una società
...
## <a name="set-up-the-company" />Impostare la società
...
## <a name="companies-and-environments" />Società e ambienti
...
## <a name="changing-a-companys-name" />Modificare il nome di una società
...
## <a name="add-contoso-coffee" />Aggiungere Contoso Coffee
