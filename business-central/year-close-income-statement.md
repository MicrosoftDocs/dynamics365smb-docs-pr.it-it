...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Chiusura del conto economico
...
## <a name="to-run-the-close-income-statement-batch-job" />Per eseguire il processo batch di chiusura del conto economico
...
## <a name="about-the-close-income-statement-batch-job" />Processo batch di chiusura del conto economico
