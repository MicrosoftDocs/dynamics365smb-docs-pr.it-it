...
ms.author: edupont
---
# <a name="select-a-check-layout"></a><a name="select-a-check-layout"></a>Selezionare un layout degli assegni
...
## <a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a>Per selezionare un layout degli assegni
...
## <a name="use-micr-and-security-fonts"></a><a name="use-micr-and-security-fonts"></a>Utilizzare i caratteri MICR e di sicurezza
...
### <a name="micr-e-13b-specifications"></a><a name="micr-e-13b-specifications"></a>Specifiche MICR E-13B
...
### <a name="delimiter-characters"></a><a name="delimiter-characters"></a>Caratteri delimitatori
...
### <a name="micr-cmc-7-specifications"></a><a name="micr-cmc-7-specifications"></a>Specifiche MICR CMC-7
...
### <a name="delimiter-characters-1"></a><a name="delimiter-characters-1"></a>Caratteri delimitatori
...
### <a name="secure-font-specifications"></a><a name="secure-font-specifications"></a>Specifiche dei caratteri di sicurezza
