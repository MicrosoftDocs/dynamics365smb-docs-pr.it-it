...
# Impostazione dei calcoli e dei metodi di registrazione per l'IVA
...
## Setup dell'IVA utilizzando la guida al setup assistito (consigliato)
...
### Abilitare o disabilitare la funzione Data IVA
...
## Impostare i numeri di partita IVA per il paese o l'area
...
2. Aprire il **conto G/L scheda** per il conto.  
...
3. Selezionare il gruppo di registrazione IVA Bus **.**  
...
2. Completa uno dei seguenti passaggi:  
    ...
    * Nella  **Articolo** scheda, espandi la scheda rapida  **Prezzo e registrazione**, quindi scegli  **Mostra altro** per visualizzare il campo  **Gruppo registrazione prodotto IVA** .  
...
2. Nella colonna  **Codice clausola IVA**, seleziona la clausola da utilizzare per ogni configurazione di registrazione IVA a cui si applica.  
...
## Utilizzare l'IVA intracomunitaria per il commercio tra i paesi/aree UE
...
[Impostare modelli di dichiarazione IVA e nomi di dichiarazione IVA](finance-how-setup-vat-statement.md)    
[Impostare l'imposta sul valore aggiunto non realizzata](finance-setup-unrealized-vat.md)    
...
[Verificare i numeri di registrazione IVA](finance-how-validate-vat-registration-number.md)    
[Funzionalità locale in Business Central](about-localization.md)    
[Dichiarazione IVA nella versione tedesca](LocalFunctionality/Germany/vat-reporting.md)    
[IVA belga](LocalFunctionality/Belgium/belgian-vat.md)    
[IVA italiana](LocalFunctionality/Italy/italian-vat.md)    
[Impostare le dichiarazioni IVA e ICP elettroniche nella versione olandese](LocalFunctionality/Netherlands/how-to-set-up-electronic-vat-and-icp-declarations.md)    
[Rapporti IVA nella versione spagnola](LocalFunctionality/Spain/vat-reports.md)    
[Impostare la pubblicazione dell'imposta sui beni e servizi nella versione australiana](LocalFunctionality/Australia/how-to-set-up-goods-and-service-tax-posting.md)    
[IVA nella versione ceca](LocalFunctionality/Czech/finance-vat.md)    
[Dichiarazione IVA nella versione norvegese](LocalFunctionality/Norway/norwegian-vat-reporting.md)    
