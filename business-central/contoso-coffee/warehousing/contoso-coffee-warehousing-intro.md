...
# <a name="introduction-to-contoso-coffee-warehousing" />Introduzione alla gestione magazzino Contoso Coffee
...
## <a name="set-up-contoso-coffee-warehousing-data" />Impostare i dati di magazzino Contoso Coffee
