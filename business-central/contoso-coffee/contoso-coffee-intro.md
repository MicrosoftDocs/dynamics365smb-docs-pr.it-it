...
# <a name="introduction-to-contoso-coffee-demo-data"></a><a name="introduction-to-contoso-coffee-demo-data"></a>Introduzione ai dati demo Contoso Coffee
...
## <a name="set-up-contoso-coffee-data"></a><a name="set-up-contoso-coffee-data"></a>Impostare i dati di Contoso Coffee
...
## <a name="manufacturing-scenarios"></a><a name="manufacturing-scenarios"></a>Scenari di produzione
...
## <a name="warehousing-scenarios"></a><a name="warehousing-scenarios"></a>Scenari di magazzino
