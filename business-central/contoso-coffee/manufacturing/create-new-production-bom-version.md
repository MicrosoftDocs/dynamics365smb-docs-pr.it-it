...
ms.author: andreipa
---
# <a name="walkthrough-create-a-new-production-bom-and-bom-version"></a><a name="walkthrough-create-a-new-production-bom-and-bom-version"></a>Procedura dettagliata: Creare una nuova DBA di produzione e la versione DBA
