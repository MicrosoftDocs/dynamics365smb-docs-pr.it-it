...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Dettagli di progettazione: Riconciliazione con la contabilità generale
...
## <a name="post-inventory-cost-to-gl-batch-job" />Processo batch Registra costo magazzino in C/G
...
## <a name="automatic-cost-posting" />Reg. automatica costi
...
## <a name="account-types" />Tipi conto
