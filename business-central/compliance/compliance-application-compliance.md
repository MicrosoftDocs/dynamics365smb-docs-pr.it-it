...
# <a name="application-compliance" />Conformità dell'applicazione
...
## <a name="data-privacy" />Privacy dei dati
...
## <a name="accounting-processes-and-controls-to-aid-compliance" />Processi e controlli contabili per agevolare la conformità
...
## <a name="enhance-people-practices-with-technology" />Migliorare le procedure delle persone con la tecnologia
...
## <a name="realize-the-benefits-of-an-integrated-business-management-solution" />Concretizzare i benefici di una soluzione di gestione aziendale integrata
...
## <a name="gain-control-of-critical-information-processes-and-reports" />Controllare processi, report e informazioni critiche
...
### <a name="manage-compliance-to-the-standards-that-matter" />Gestire la conformità agli standard pertinenti
...
### <a name="tailor-financial-reports-to-your-needs" />Adattare i report finanziari alle proprie esigenze
...
### <a name="improve-information-validity" />Migliorare la validità delle informazioni
...
### <a name="comply-quickly-with-discovery-requests-and-reporting-demands" />Conformarsi rapidamente alle richieste di individuazione e di report
...
### <a name="help-ensure-clear-audit-trails" />Garantire audit trail chiari
...
## <a name="compliance-and-local-functionality" />Conformità e funzionalità locale
