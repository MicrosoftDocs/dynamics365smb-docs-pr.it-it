...
---
# <a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a>Utilizzare i flussi di Power Automate in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a>Informazioni sui flussi Power Automate
...
## <a name="power-automate-features"></a><a name="power-automate-features"></a>Funzionalità di Power Automate
...
## <a name="run-instant-flows"></a><a name="run-instant-flows"></a>Eseguire flussi istantanei
...
## <a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a>Creare, modificare e gestire flussi
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/use-power-automate/)
