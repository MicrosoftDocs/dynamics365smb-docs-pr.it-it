...
ms.author: bholtorf
---
# <a name="work-with-responsibility-centers" />Utilizzare i centri di responsabilità
...
## <a name="to-set-up-a-responsibility-center" />Per impostare i centri di responsabilità
...
## <a name="to-assign-responsibility-centers-to-users" />Per assegnare i centri di responsabilità agli utenti
