...
ms.author: edupont
---
# <a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a>Impostazione di codici sorgente e causali per audit trail
...
## <a name="define-source-codes"></a><a name="define-source-codes"></a><a name="define-source-codes"></a>Definire i codici origine
...
### <a name="to-define-source-codes"></a><a name="to-define-source-codes"></a><a name="to-define-source-codes"></a>Per definire i codici origine
...
## <a name="change-source-codes"></a><a name="change-source-codes"></a><a name="change-source-codes"></a>Modificare i codici origine
...
### <a name="to-change-source-codes"></a><a name="to-change-source-codes"></a><a name="to-change-source-codes"></a>Per modificare i codici origine
...
## <a name="define-reason-codes"></a><a name="define-reason-codes"></a><a name="define-reason-codes"></a>Definire le causali
...
### <a name="to-set-up-reason-codes"></a><a name="to-set-up-reason-codes"></a><a name="to-set-up-reason-codes"></a>Per impostare le causali
...
### <a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a>Per assegnare causali alle definizioni di registrazioni
...
### <a name="to-use-reason-codes-on-sales-and-purchase-documents"></a><a name="to-use-reason-codes-on-sales-and-purchase-documents"></a><a name="to-use-reason-codes-on-sales-and-purchase-documents"></a>Per utilizzare le causali sui documenti di acquisto e vendita
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/paths/set-up-financial-management-dynamics-365-business-central/)
