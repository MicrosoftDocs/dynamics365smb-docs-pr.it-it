...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Impostazione di un programma di prestito articoli
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>Per impostare un articolo in prestito
