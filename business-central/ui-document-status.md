...
ms.author: bholtorf
---
# <a name="status-field-on-documents" />Campo stato nei documenti
...
## <a name="release-process" />Rilascia processo
...
### <a name="approval-procedures" />Procedure di approvazione
...
### <a name="warehouse-activities" />Attività di warehouse
...
## <a name="reopen-a-released-order" />Riaprire un ordine rilasciato
