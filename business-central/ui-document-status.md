...
ms.author: bholtorf
---
# <a name="status-field-on-documents"></a><a name="status-field-on-documents"></a>Campo stato nei documenti
...
## <a name="release-process"></a><a name="release-process"></a>Rilascia processo
...
### <a name="approval-procedures"></a><a name="approval-procedures"></a>Procedure di approvazione
...
### <a name="warehouse-activities"></a><a name="warehouse-activities"></a>Attività di warehouse
...
## <a name="reopen-a-released-order"></a><a name="reopen-a-released-order"></a>Riaprire un ordine rilasciato
