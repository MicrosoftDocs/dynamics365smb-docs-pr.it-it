...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-purchase-invoices" />Correggere o annullare le fatture di acquisto non pagate
...
## <a name="to-correct-a-posted-purchase-invoice" />Per correggere una fattura di acquisto registrata
...
## <a name="to-cancel-a-posted-purchase-invoice" />Per annullare una fattura di acquisto registrata
...
### <a name="partial-invoice-posting-also-supported" />Anche la registrazione parziale delle fatture è supportata
...
## <a name="see-related-microsoft-trainingtrainingmodulesreceive-invoice-dynamics-d-business-central" />Vedi il relativo [training Microsoft](/training/modules/receive-invoice-dynamics-d365-business-central/)
