...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a><a name="available-fonts"></a>Caratteri disponibili
...
## <a name="document-fonts"></a><a name="document-fonts"></a><a name="document-fonts"></a>Caratteri documento
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Caratteri per controlli
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Caratteri per i codici a barre
