...
ms.author: edupont
---
# <a name="available-fonts" />Caratteri disponibili
...
## <a name="document-fonts" />Caratteri documento
...
## <a name="fonts-for-checks" />Caratteri per controlli
...
## <a name="fonts-for-barcodes" />Caratteri per i codici a barre
