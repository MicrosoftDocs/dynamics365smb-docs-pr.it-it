...
ms.author: bholtorf
---
# <a name="service-price-management"></a><a name="service-price-management"></a>Gestione dei prezzi di assistenza
...
## <a name="service-price-adjustment-groups"></a><a name="service-price-adjustment-groups"></a>Gruppi di rettifica dei prezzi di assistenza
...
## <a name="service-price-groups"></a><a name="service-price-groups"></a>Gruppi di definizione dei prezzi di assistenza
...
## <a name="service-pricing"></a><a name="service-pricing"></a>Definizione dei prezzi di assistenza
...
## <a name="service-price-adjustment"></a><a name="service-price-adjustment"></a>Rettifica dei prezzi di assistenza
