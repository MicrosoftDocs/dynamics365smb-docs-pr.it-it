...
ms.author: bholtorf
---
# <a name="service-price-management" />Gestione dei prezzi di assistenza
...
## <a name="service-price-adjustment-groups" />Gruppi di rettifica dei prezzi di assistenza
...
## <a name="service-price-groups" />Gruppi di definizione dei prezzi di assistenza
...
## <a name="service-pricing" />Definizione dei prezzi di assistenza
...
## <a name="service-price-adjustment" />Rettifica dei prezzi di assistenza
