...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Riconciliare manualmente i pagamenti ai fornitori con la registrazioni pagamenti o dai movimenti contabili fornitori.
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />Per collegare un pagamento a uno o più movimenti contabili fornitori
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Per collegare una nota di credito a uno o più movimenti contabili fornitori
...
## <a name="to-apply-posted-vendor-ledger-entries" />Per collegare i movimenti contabili fornitori registrati
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />Per collegare movimenti contabili fornitori in valute diverse
...
## <a name="to-unapply-an-application-of-vendor-entries" />Per scollegare un collegamento di movimenti fornitori
