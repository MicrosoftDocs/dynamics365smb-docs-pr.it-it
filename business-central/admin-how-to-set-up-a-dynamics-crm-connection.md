...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse"></a><a name="connect-to-microsoft-dataverse"></a><a name="connect-to-microsoft-dataverse"></a>Connettersi a Microsoft Dataverse
...
## <a name="set-up-a-connection-to-"></a><a name="set-up-a-connection-to-"></a><a name="set-up-a-connection-to-"></a>Impostazione connessione a [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a><a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a><a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a>Utilizzare la guida al setup assistito Setup connessione a Dataverse
...
### <a name="to-create-or-maintain-the-connection-manually"></a><a name="to-create-or-maintain-the-connection-manually"></a><a name="to-create-or-maintain-the-connection-manually"></a>Per creare o gestire la connessione manualmente
...
## <a name="customize-the-match-based-coupling"></a><a name="customize-the-match-based-coupling"></a><a name="customize-the-match-based-coupling"></a>Personalizzare l'accoppiamento basato sulla corrispondenza
...
### <a name="view-the-results-of-the-coupling-job"></a><a name="view-the-results-of-the-coupling-job"></a><a name="view-the-results-of-the-coupling-job"></a>Visualizza i risultati del lavoro di accoppiamento
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a><a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a><a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a>Aggiornare le connessioni da Business Central Online per utilizzare l'autenticazione basata su certificato
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a><a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a><a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a>Per aggiornare la connessione di Business Central online per utilizzare l'autenticazione basata su certificato
...
## <a name="connecting-on-premises-versions"></a><a name="connecting-on-premises-versions"></a><a name="connecting-on-premises-versions"></a>Connessione alle versioni locali
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a><a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a><a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a>Per registrare un'applicazione in Azure AD per la connessione da Business Central a Dataverse
...
### <a name="to-disconnect-from-"></a><a name="to-disconnect-from-"></a><a name="to-disconnect-from-"></a>Per disconnettersi da [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
