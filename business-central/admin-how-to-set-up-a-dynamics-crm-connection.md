...
## Impostare una connessione a [!INCLUDE[cds_long_md](includes/cds_long_md.md)].
...
### Per registrare un'applicazione in Azure AD per la connessione da Business Central a Dataverse
