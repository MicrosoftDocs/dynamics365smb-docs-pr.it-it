...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding" />Impostare l'arrotondamento delle fatture
...
## <a name="set-up-general-ledger-accounts-for-invoice-rounding-differences" />Impostare i conti contabilità generale per le differenze di arrotondamento fattura
...
### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences" />Per impostare i conti contabilità generale per le differenze di arrotondamento fattura
...
## <a name="set-up-rounding-for-foreign-and-local-currencies" />Impostare l'arrotondamento per le valute locali ed estere
...
### <a name="to-set-up-rounding-for-foreign-currencies" />Per impostare l'arrotondamento per le valute estere
...
### <a name="to-set-up-rounding-for-your-local-currency" />Per impostare l'arrotondamento per la valuta locale
...
## <a name="activate-the-invoice-rounding-function" />Attivare la funzione di arrotondamento fatture
