...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding"></a><a name="set-up-invoice-rounding"></a><a name="set-up-invoice-rounding"></a>Impostare l'arrotondamento delle fatture
...
## <a name="set-up-rounding-for-foreign-and-local-currencies"></a><a name="set-up-rounding-for-foreign-and-local-currencies"></a><a name="set-up-rounding-for-foreign-and-local-currencies"></a>Impostare l'arrotondamento per le valute locali ed estere
...
### <a name="to-set-up-rounding-for-foreign-currencies"></a><a name="to-set-up-rounding-for-foreign-currencies"></a><a name="to-set-up-rounding-for-foreign-currencies"></a>Per impostare l'arrotondamento per le valute estere
...
### <a name="to-set-up-rounding-for-your-local-currency"></a><a name="to-set-up-rounding-for-your-local-currency"></a><a name="to-set-up-rounding-for-your-local-currency"></a>Per impostare l'arrotondamento per la valuta locale
...
## <a name="activate-the-invoice-rounding-function"></a><a name="activate-the-invoice-rounding-function"></a><a name="activate-the-invoice-rounding-function"></a>Attivare la funzione di arrotondamento fatture
