...
ms.author: edupont
---
# <a name="reverse-output-posting"></a><a name="reverse-output-posting"></a><a name="reverse-output-posting"></a>Stornare la registrazione dell'output
...
## <a name="to-reverse-an-output-posting"></a><a name="to-reverse-an-output-posting"></a><a name="to-reverse-an-output-posting"></a>Per stornare una registrazione di output
