...
ms.author: edupont
---
# <a name="view-load-on-work-and-machine-centers" />Visualizzare il carico in aree di produzione e centri di lavoro
...
## <a name="to-view-the-load-on-work-centers" />Per visualizzare il carico nelle aree di produzione
