...
ms.author: jswymer
---
# <a name="run-and-print-reports"></a><a name="run-and-print-reports"></a>Eseguire e stampare i report
...
## <a name="using-default-valuesmdashpredefined-settings"></a><a name="using-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Utilizzo dei valori predefiniti: impostazioni predefinite
...
## <a name="specifying-the-data-to-include-in-a-report"></a><a name="specifying-the-data-to-include-in-a-report"></a>Specificare la data da includere in un report
...
## <a name="previewing-a-report"></a><a name="previewing-a-report"></a>Anteprima di un report
...
### <a name="work-with-the-preview"></a><a name="work-with-the-preview"></a>Utilizzare l'anteprima
...
## <a name="saving-a-report-to-a-file"></a><a name="saving-a-report-to-a-file"></a>Salvataggio di un report in un file
...
## <a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a> Pianificazione dell'esecuzione posticipata o periodica di un report
...
### <a name="manage-scheduled-recurring-reports"></a><a name="manage-scheduled-recurring-reports"></a>Gestire i report ricorrenti programmati
...
## <a name="printing-a-report"></a><a name="printing-a-report"></a><a name="PrintReport"></a>Stampa di un report
...
### <a name="printer"></a><a name="printer"></a><a name="Printer"></a>Stampante
...
### <a name="printing-reports-in-thai"></a><a name="printing-reports-in-thai"></a>Stampa di report nella versione tailandese
...
## <a name="switching-the-report-layout"></a><a name="switching-the-report-layout"></a>Cambiare il layout di report
...
## <a name="change-language-and-format-of-numbers-dates-and-times"></a><a name="change-language-and-format-of-numbers-dates-and-times"></a>Cambiare la lingua e il formato di numeri, date e orari
...
## <a name="advanced-options"></a><a name="advanced-options"></a>Opzioni avanzate
