...
---
# <a name="run-and-print-reports-in-business-central"></a>Eseguire e stampare i report
...
## <a name="use-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Utilizzo dei valori predefiniti: impostazioni predefinite
...
## <a name="preview-a-report"></a>Anteprima di un report
...
## <a name="save-a-report-to-a-file"></a>Salvataggio di un report in un file
...
## <a name="schedule-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Pianificazione dell'esecuzione posticipata o periodica di un report
...
## <a name="print-a-report"></a><a name="PrintReport"></a>Stampa di un report
...
### <a name="print-reports-in-thai"></a>Stampa di report nella versione tailandese
