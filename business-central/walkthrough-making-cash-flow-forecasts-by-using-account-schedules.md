...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports" />Procedura dettagliata: Esecuzione di previsioni di flusso di cassa utilizzando i report finanziari
...
## <a name="setting-up-a-new-financial-report-name" />Impostazione di un nuovo nome del report finanziario
...
### <a name="set-up-a-new-financial-report-name" />Impostare un nuovo nome del report finanziario
...
## <a name="setting-up-row-definition-lines" />Impostazione delle righe di definizione di riga
...
### <a name="set-up-row-definition-lines" />Impostare le righe di definizione di riga
...
## <a name="setting-up-a-new-column-definition" />Impostazione di una nuova definizione di colonna
...
### <a name="set-up-a-new-column-definition" />Impostare una nuova definizione di colonna
...
## <a name="assigning-the-column-definition-to-the-financial-report-name" />Assegnazione della definizione di colonna al nome del report finanziario

Ken è ora pronto per assegnare la definizione di colonna al nome del report finanziario.  

### <a name="assign-the-column-definition-to-the-financial-report-name" />Assegnare la definizione di colonna al nome del report finanziario
...
## <a name="view-and-print-the-cash-flow-forecast" />Visualizzare e stampare la previsione del flusso di cassa
...
## <a name="see-related-microsoft-trainingtrainingmodulesforecast-cash-flow-dynamics-365-business-central" />Vedi il relativo [training Microsoft](/training/modules/forecast-cash-flow-dynamics-365-business-central/)
