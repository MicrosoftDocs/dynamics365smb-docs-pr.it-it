...
ms.author: edupont
---
# <a name="set-up-rules-for-automatic-application-of-payments"></a><a name="set-up-rules-for-automatic-application-of-payments"></a>Impostare le regole per il collegamento automatico dei pagamenti
...
## <a name="to-set-up-a-payment-application-rule"></a><a name="to-set-up-a-payment-application-rule"></a>Per impostare una regola di collegamento del pagamento
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/reconciliation-journals-dynamics-365-business-central/index)
