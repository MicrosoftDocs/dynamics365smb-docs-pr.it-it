...
---
# <a name="create-workflows-to-connect-tasks-in-business-processes" />Creare flussi di lavoro per connettere nei processi aziendali
...
## <a name="to-create-a-workflow" />Per creare un flusso di lavoro
...
## <a name="example-of-creating-a-new-workflow-using-existing-events" />Esempio di creazione di un nuovo flusso di lavoro utilizzando eventi esistenti
