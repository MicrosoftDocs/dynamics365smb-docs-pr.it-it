...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a>Imposta più tassi di interesse per il pagamento ritardato
...
## <a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a>Per impostare più tassi d'interesse
