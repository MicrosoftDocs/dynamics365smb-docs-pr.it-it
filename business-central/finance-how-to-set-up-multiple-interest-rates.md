...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment" />Imposta più tassi di interesse per il pagamento ritardato
...
## <a name="to-set-up-multiple-interest-rates" />Per impostare più tassi d'interesse
