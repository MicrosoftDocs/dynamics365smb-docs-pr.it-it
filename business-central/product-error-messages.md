...
Sfrutta l'esperienza di colleghi o esperti in materia per superare gli ostacoli e ridurre al minimo i tempi di inattività. Quando sei bloccato da un errore, puoi condividere facilmente i dettagli relativi all'errore quando ricevi assistenza. 
...
Abbiamo reso più semplice la comprensione e la risoluzione degli errori nella piattaforma e l'accesso agli stessi.
...
Le azioni nei messaggi di errore ti portano direttamente alla pagina in cui un campo causa l'errore. Non devi sprecare tempo per trovare personalmente la pagina o il campo. Devi semplicemente scegliere l'azione nel messaggio di errore e [!INCLUDE [prod_short](includes/prod_short.md)] accederà all'area appropriata per risolvere l'errore.
