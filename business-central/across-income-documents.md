...
ms.author: edupont
---
# <a name="incoming-documents"></a><a name="incoming-documents"></a><a name="incoming-documents"></a>Documenti in entrata
...
## <a name="usage-scenario"></a><a name="usage-scenario"></a><a name="usage-scenario"></a>Scenario di utilizzo
...
## <a name="incoming-document-features"></a><a name="incoming-document-features"></a><a name="incoming-document-features"></a>Funzionalità del documento in entrata
