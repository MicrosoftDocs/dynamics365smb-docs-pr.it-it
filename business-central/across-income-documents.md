...
ms.author: edupont
---
# <a name="incoming-documents" />Documenti in entrata
...
## <a name="usage-scenario" />Scenario di utilizzo
...
## <a name="incoming-document-features" />Funzionalità del documento in entrata
