...
ms.author: edupont
---
# <a name="add-extended-text" />Aggiungere testo esteso
...
## <a name="to-define-extended-text-for-an-description" />Per definire il testo esteso per una descrizione
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />Per aggiungere testo esteso di articoli in una riga di un ordine di vendita
