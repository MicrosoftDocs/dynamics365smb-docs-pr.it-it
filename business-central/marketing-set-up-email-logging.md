...
---
# <a name="track-email-message-exchanges-between-salespeople-and-contacts" />Tenere traccia degli scambi di messaggi e-mail tra venditori e contatti
...
## <a name="to-set-up-email-logging" />Per impostare la registrazione e-mail

### <a name="set-up-public-folders-and-rules-for-email-logging-in-exchange-online" />Impostare le cartelle pubbliche e le regole per il log delle e-mail in Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Quindi, connettersi a [!INCLUDE[prod_short](includes/prod_short.md)] con Exchange Online.

### <a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online" />Impostare una casella di posta condivisa e regole condivise per la registrazione della posta elettronica in Exchange Online
...
### <a name="add-a-user-account-for-members-of-the-shared-mailbox" />Aggiungere un account utente per i membri della cassetta postale condivisa
...
### <a name="allow-other-users-to-see-logged-emails" />Consentire ad altri utenti di vedere le e-mail registrate
...
## <a name="view-email-message-exchanges-in-the-interaction-log" />Visualizzazione degli scambi di messaggi e-mail nel log delle interazioni
...
## <a name="mailbox-and-folder-limits-in-exchange-online" />Limiti di cassette postali e cartelle in Exchange Online
...
## <a name="connect-on-premises-versions-to-microsoft-exchange" />Connettere le versioni locali a Microsoft Exchange
...
-->
## <a name="connect-to-exchange-online" />Connettersi a Exchange Online
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-exchange-online" />Per registrare un'applicazione in Azure AD per la connessione da Business Central a Exchange Online
...
### <a name="use-another-identity-and-access-management-service" />Utilizzare un altro servizio di gestione dell'identità e degli accessi
...
## <a name="to-start-logging-email" />Per avviare il log delle e-mail
...
## <a name="to-stop-logging-email" />Per interrompere il log delle e-mail
