...
# <a name="pick-for-production-assembly-or-projects-in-advanced-warehouse-configurations"></a>Scegli per produzione, assemblaggio o progetti in configurazioni di magazzino avanzate
...
## <a name="to-pick-items-for-a-production-order-assembly-order-or-project"></a>Per selezionare gli articoli per un ordine di produzione, un ordine di assemblaggio o un progetto
