...
ms.author: bholtorf
---
# <a name="pick-for-production-assembly-or-jobs-in-advanced-warehouse-configurations" />Prelevare per produzione, assemblaggio o commesse in configurazioni di warehouse avanzate
...
## <a name="to-create-pick-documents-in-bulk-with-the-pick-worksheet" />Per creare documenti di prelievo in blocco con i prospetti prelievi
...
## <a name="to-pick-items-for-a-productions-order-assembly-order-job" />Per prelevare articoli per un ordine di produzione, un ordine di assemblaggio, una commessa
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Consuntivazione dei componenti di produzione in una configurazione warehouse avanzata
