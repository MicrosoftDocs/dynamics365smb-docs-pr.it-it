...
## <a name="add-includeprodshortincludesprodshortmd-as-a-data-source-in-power-apps" />Aggiungere [!INCLUDE[prod_short](includes/prod_short.md)] come origine dati in Power Apps
...
## <a name="see-related-microsoft-trainingtrainingpathspower-apps-power-automate-business-central" />Vedi il relativo [training Microsoft](/training/paths/power-apps-power-automate-business-central/)
