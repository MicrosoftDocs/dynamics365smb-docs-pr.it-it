...
ms.author: bholtorf
---
# <a name="reconcile-payments-using-automatic-application" />Riconciliare i pagamenti utilizzando il collegamento automatico
...
## <a name="to-reconcile-payments-using-automatic-application" />Per riconciliare i pagamenti utilizzando il collegamento automatico
