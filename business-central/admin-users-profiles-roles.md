...
ms.search.form: 9171
---
# <a name="manage-user-profiles"></a><a name="manage-user-profiles"></a>Gestire profili utente
...
## <a name="page-customization"></a><a name="page-customization"></a>Personalizzazione delle pagine
...
## <a name="to-create-a-profile"></a><a name="to-create-a-profile"></a>Per creare un profilo
...
## <a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a>Per copiare un profilo
...
## <a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a>Per modificare un profilo
...
## <a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a>Per assegnare un profilo a un utente
...
## <a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a>Per definire le impostazioni utente per un profilo
...
## <a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a>Per attivare un profilo
...
## <a name="to-export-profiles"></a><a name="to-export-profiles"></a>Per esportare profili
...
## <a name="to-import-profiles"></a><a name="to-import-profiles"></a>Per importare profili
...
## <a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a>Per eliminare un profilo
...
## <a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a>Per eliminare tutte le personalizzazioni effettuate da un utente
...
## <a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a>Per eliminare le personalizzazioni per pagine specifiche
...
## <a name="managing-user-sessions"></a><a name="managing-user-sessions"></a>Gestione delle sessioni utente
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/users-security-dynamics-365-business-central/)
