...
ms.author: bholtorf
---
# <a name="work-with-vat-on-sales-and-purchases"></a><a name="work-with-vat-on-sales-and-purchases"></a>Utilizzare l'IVA nelle vendite e negli acquisti
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a><a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a>Calcolo e visualizzazione degli importi IVA nei documenti di vendita e di acquisto
...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts"></a><a name="including-or-excluding-vat-in-prices-and-line-amounts"></a>IVA inclusa e IVA esclusa in prezzi e importi riga
...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups"></a><a name="using-vat-business-posting-groups-and-customer-price-groups"></a>Utilizzo delle categorie registrazione business IVA e dei gruppi prezzi cliente
...
## <a name="working-with-vat-date"></a><a name="working-with-vat-date"></a>Utilizzo della Data IVA

### <a name="vat-date-in-documents"></a><a name="vat-date-in-documents"></a>Data IVA nei documenti
...
### <a name="modifying-the-vat-date-in-posted-entries"></a><a name="modifying-the-vat-date-in-posted-entries"></a>Modifica della data IVA nei movimenti registrati
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a><a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a>Correzione manuale degli importi IVA nei documenti di vendita e di acquisto
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents"></a>Per impostare il sistema per il movimento IVA manuale nei documenti di vendita
...
### <a name="to-adjust-vat-for-a-sales-document"></a><a name="to-adjust-vat-for-a-sales-document"></a>Per rettificare l'IVA per un documento di vendita
...
## <a name="calculating-vat-manually-using-journals"></a><a name="calculating-vat-manually-using-journals"></a>Calcolo manuale dell'IVA utilizzando le registrazioni
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals"></a>Per impostare il sistema per il movimento IVA manuale in una registrazione COGE
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals"></a>Per impostare il sistema per il movimento IVA manuale in una registrazione COGE
...
## <a name="posting-import-vat-with-purchase-invoices"></a><a name="posting-import-vat-with-purchase-invoices"></a>Registrare l'IVA da importazione con fatture di acquisto
...
### <a name="to-set-up-purchasing-for-posting-import-vat-invoices"></a><a name="to-set-up-purchasing-for-posting-import-vat-invoices"></a>Per impostare l'acquisto per registrare le fatture con IVA da importazione
...
## <a name="processing-certificates-of-supply"></a><a name="processing-certificates-of-supply"></a>Elaborare certificati di fornitura
...
### <a name="to-view-certificate-of-supply-details"></a><a name="to-view-certificate-of-supply-details"></a>Per visualizzare i dettagli del certificato di fornitura
...
### <a name="to-print-a-certificate-of-supply"></a><a name="to-print-a-certificate-of-supply"></a>Per stampare un certificato di fornitura
...
### <a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment"></a><a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment"></a>Per aggiornare lo stato di un certificato di fornitura per una spedizione
...
### <a name="to-update-the-status-of-a-group-of-certificates-of-supply"></a><a name="to-update-the-status-of-a-group-of-certificates-of-supply"></a>Per aggiornare lo stato di un gruppo di certificati di fornitura.
