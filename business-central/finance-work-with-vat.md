...
ms.author: bholtorf
---
# <a name="work-with-vat-on-sales-and-purchases" />Utilizzare l'IVA nelle vendite e negli acquisti
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents" />Calcolo e visualizzazione degli importi IVA nei documenti di vendita e di acquisto
...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts" />IVA inclusa e IVA esclusa in prezzi e importi riga
...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups" />Utilizzo delle categorie registrazione business IVA e dei gruppi prezzi cliente
...
## <a name="working-with-vat-date" />Utilizzo della Data IVA

### <a name="vat-date-in-documents" />Data IVA nei documenti
...
### <a name="modifying-the-vat-date-in-posted-entries" />Modifica della data IVA nei movimenti registrati
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents" />Correzione manuale degli importi IVA nei documenti di vendita e di acquisto
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents" />Per impostare il sistema per il movimento IVA manuale nei documenti di vendita
...
### <a name="to-adjust-vat-for-a-sales-document" />Per rettificare l'IVA per un documento di vendita
...
## <a name="calculating-vat-manually-using-journals" />Calcolo manuale dell'IVA utilizzando le registrazioni
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals" />Per impostare il sistema per il movimento IVA manuale in una registrazione COGE
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals" />Per impostare il sistema per il movimento IVA manuale in una registrazione COGE
...
## <a name="posting-import-vat-with-purchase-invoices" />Registrare l'IVA da importazione con fatture di acquisto
...
### <a name="to-set-up-purchasing-for-posting-import-vat-invoices" />Per impostare l'acquisto per registrare le fatture con IVA da importazione
...
### <a name="to-create-a-new-invoice-for-the-import-authority-vendor-once-you-have-completed-the-setup" />Per creare una nuova fattura per il fornitore dell'importazione competente dopo avere completato il setup
...
## <a name="processing-certificates-of-supply" />Elaborare certificati di fornitura
...
### <a name="to-view-certificate-of-supply-details" />Per visualizzare i dettagli del certificato di fornitura
...
### <a name="to-print-a-certificate-of-supply" />Per stampare un certificato di fornitura
...
### <a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment" />Per aggiornare lo stato di un certificato di fornitura per una spedizione
...
### <a name="to-update-the-status-of-a-group-of-certificates-of-supply" />Per aggiornare lo stato di un gruppo di certificati di fornitura.
