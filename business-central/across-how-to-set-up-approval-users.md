...
ms.author: edupont
---
# <a name="set-up-approval-users"></a><a name="set-up-approval-users"></a>Impostare gli utenti per l'approvazione
...
## <a name="to-set-up-an-approval-user"></a><a name="to-set-up-an-approval-user"></a>Per impostare un utente per l'approvazione
