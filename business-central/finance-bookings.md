...
ms.author: edupont
---
# <a name="bulk-invoicing-for-microsoft-bookings-in-"></a><a name="bulk-invoicing-for-microsoft-bookings-in-"></a><a name="bulk-invoicing-for-microsoft-bookings-in-"></a>Fatturazione in blocco per Microsoft Bookings in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="connect-to-bookings"></a><a name="connect-to-bookings"></a><a name="connect-to-bookings"></a>Connessione a Bookings
...
## <a name="invoice-appointments"></a><a name="invoice-appointments"></a><a name="invoice-appointments"></a>Fattura appuntamenti
