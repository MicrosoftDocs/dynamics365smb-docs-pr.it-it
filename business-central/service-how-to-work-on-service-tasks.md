...
ms.author: edupont
---
# <a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a>Utilizzare i compiti di assistenza
...
## <a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a>Per utilizzare un compito di assistenza
...
## <a name="to-register-service-operations"></a><a name="to-register-service-operations"></a><a name="to-register-service-operations"></a>Per registrare le operazioni di assistenza
...
## <a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a>Per registrare i pezzi di ricambio
...
## <a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a>Per registrare i pezzi di ricambio da un ordine di assistenza
...
## <a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a>Per sostituire un articolo in assistenza o un componente dell'articolo in assistenza
...
## <a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a>Per modificare il tempo di risposta per una riga di articolo in assistenza
...
## <a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a>Per registrare i codici di guasto/risoluzione
