...
ms.author: jswymer
---
# <a name="managing-database-access-intent" />Gestione dell'intento di accesso al database
...
## <a name="to-change-the-database-access-intent" />Per modificare l'intento di accesso al database
