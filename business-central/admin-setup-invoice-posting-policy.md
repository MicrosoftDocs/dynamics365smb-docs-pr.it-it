...
# <a name="define-an-invoice-posting-policy-for-users" />Definire un criterio di registrazione delle fatture per gli utenti
...
## <a name="to-specify-a-posting-policy" />Per specificare un criterio di registrazione
...
## <a name="effect-on-documents" />Effetto sui documenti
