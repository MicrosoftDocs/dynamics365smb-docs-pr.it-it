...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Visualizzazione di blocchi di database
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>Per visualizzare i blocchi di database
