...
---
# <a name="record-consumption-or-usage-for-jobs" />Registrare il consumo o l'utilizzo per le commesse
...
## <a name="to-record-usage-for-a-job-planning-line-of-type-budget" />Per registrare l'utilizzo per una riga di pianificazione commessa di tipo Budget
...
## <a name="to-create-job-journal-lines-manually" />Per creare le righe delle registrazioni delle commesse manualmente
...
## <a name="to-view-job-usage-estimates-and-post-updates" />Per visualizzare le stime di utilizzo della commessa e gli aggiornamenti della registrazione
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-job" />Creare inventario e warehouse per le righe di pianificazione per una commessa
...
## <a name="to-review-planning-lines-for-a-job-ledger-entry" />Per esaminare le righe di pianificazione per un movimento contabile commessa
