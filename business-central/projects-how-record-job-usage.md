...
---
# <a name="record-consumption-or-usage-for-projects"></a>Registrare il consumo o l'utilizzo per le commesse
...
## <a name="to-record-usage-for-a-project-planning-line-of-type-budget"></a>Per registrare l'utilizzo per una riga di pianificazione commessa di tipo Budget
...
## <a name="to-create-project-journal-lines-manually"></a>Per creare le righe delle registrazioni delle commesse manualmente
...
## <a name="to-view-project-usage-estimates-and-post-updates"></a>Per visualizzare le stime di utilizzo della commessa e gli aggiornamenti della registrazione
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-project"></a>Creare inventario e warehouse per le righe di pianificazione per una commessa
...
## <a name="to-review-planning-lines-for-a-project-ledger-entry"></a>Per esaminare le righe di pianificazione per un movimento contabile commessa
