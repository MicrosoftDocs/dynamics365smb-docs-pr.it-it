...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a>Impostare righe di ciclo standard
...
## <a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a>Per impostare un task standard
...
## <a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a>Per aggiungere un task standard a un'operazione
