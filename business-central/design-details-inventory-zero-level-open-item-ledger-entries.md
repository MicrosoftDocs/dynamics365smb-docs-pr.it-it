...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Dettagli di progettazione: Problema noto di collegamento articoli
...
## <a name="symptoms-of-the-issue" />Indizi del problema
...
## <a name="basics-of-item-application" />Nozioni di base del collegamento articoli
...
### <a name="quantity-application" />Collegamento della quantità
...
### <a name="cost-application" />Collegamento costo
...
## <a name="illustration-of-a-basic-cost-flow" />Illustrazione di un flusso dei costi di base
...
## <a name="reasons-for-the-issue" />Motivi del problema
...
## <a name="identifying-the-issue" />Identificazione del problema
...
## <a name="workaround-for-the-issue" />Soluzione alternativa per il problema
