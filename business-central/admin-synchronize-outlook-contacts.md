...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook" />Sincronizzare i contatti di Business Central con i contatti di Microsoft Outlook
...
## <a name="set-up-synchronization" />Impostare la sincronizzazione
...
### <a name="automate-synchronization" />Automazione della sincronizzazione
...
## <a name="synchronize-contacts" />Sincronizzare i contatti
