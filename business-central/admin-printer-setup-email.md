...
---
# <a name="set-up-email-printers"></a><a name="set-up-email-printers"></a>Impostare le stampanti con indirizzo e-mail
...
## <a name="add-an-email-printer"></a><a name="add-an-email-printer"></a>Aggiungi una stampante e-mail
