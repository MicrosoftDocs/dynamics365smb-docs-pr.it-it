...
ms.author: jswymer
---
# <a name="working-with-microsoft-excel-layouts" />Usare i layout di Microsoft Excel
...
## <a name="why-use-excel-layouts" />Perché usare i layout di Excel?
...
## <a name="understanding-excel-layouts" />Informazioni sui layout di Excel
