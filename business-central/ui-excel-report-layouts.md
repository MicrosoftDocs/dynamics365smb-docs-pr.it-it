---
title: Utilizzare i layout di Excel
...
ms.reviewer: jswymer
---
# Utilizzare i layout di Microsoft Excel
...
> [!TIP]
> Con il setup di integrazione di OneDrive, quando si esegue un report con un layout di Excel, il file della cartella di lavoro di Excel viene copiato in OneDrive e quindi aperto in Excel online. Per ulteriori informazioni, vedi [Salvare cartelle di lavoro e file di report di Excel in OneDrive](./across-onedrive-overview.md#save-excel-workbooks-and-report-files-in-onedrive)
...
## Vedere anche
[Creazione di un report di layout Excel (documentazione per sviluppatori)](/dynamics365/business-central/dev-itpro/developer/devenv-howto-excel-report-layout?toc=/dynamics365/business-central/toc.json)  
[Gestione dei layout di report](ui-manage-report-layouts.md)  
[Modificare il layout del report corrente](ui-how-change-layout-currently-used-report.md)  
[Importare ed esportare un layout di report o documento personalizzato (legacy)](ui-how-import-and-export-report-layout.md)  
