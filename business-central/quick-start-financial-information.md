...
# <a name="financial-information-quick-start" />Inizio rapido su Informazioni finanziarie
...
## <a name="set-up-the-chart-of-accounts" />Impostare un piano dei conti
...
### <a name="add-an-account-to-the-chart-of-accounts" />Aggiungi un account al piano dei conti
...
### <a name="get-an-overview-of-the-chart-of-accounts" />Ottieni una panoramica del piano dei conti
...
## <a name="see-related-training-at-microsoft-learnlearnpathsset-up-financial-management-dynamics--business-central" />Vedi le informazioni relative al training in [Microsoft Learn](/learn/paths/set-up-financial-management-dynamics-365-business-central/).
