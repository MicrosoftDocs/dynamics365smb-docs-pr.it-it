...
# <a name="financial-information-quick-start"></a><a name="financial-information-quick-start"></a>Inizio rapido su Informazioni finanziarie
...
## <a name="set-up-the-chart-of-accounts"></a><a name="set-up-the-chart-of-accounts"></a>Impostare un piano dei conti
...
### <a name="add-an-account-to-the-chart-of-accounts"></a><a name="add-an-account-to-the-chart-of-accounts"></a>Aggiungi un account al piano dei conti
...
### <a name="get-an-overview-of-the-chart-of-accounts"></a><a name="get-an-overview-of-the-chart-of-accounts"></a>Ottieni una panoramica del piano dei conti
...
## <a name="set-up-bank-accounts"></a><a name="set-up-bank-accounts"></a>Impostare i conti correnti bancari
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Vedi le informazioni relative al training in [Microsoft Learn](/learn/paths/set-up-financial-management-dynamics-365-business-central/).
