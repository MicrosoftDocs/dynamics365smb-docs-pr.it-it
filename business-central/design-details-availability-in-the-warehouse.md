...
---
# <a name="design-details-availability-in-the-warehouse" />Dettagli di progettazione: Disponibilità nella warehouse
...
## <a name="bin-content-and-reservations" />Contenuto collocazione e impegni
...
## <a name="quantity-available-to-pick" />Quantità disponibile per il prelievo
...
### <a name="calculating-the-quantity-available-to-pick" />Calcolo della quantità disponibile da prelevare
...
## <a name="quantity-available-to-reserve" />Quantità disponibile da impegnare
...
### <a name="calculating-the-quantity-available-to-reserve" />Calcolo della quantità disponibile da impegnare
