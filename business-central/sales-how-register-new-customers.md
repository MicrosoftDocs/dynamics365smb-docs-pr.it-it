...
ms.author: edupont
---
# <a name="register-new-customers"></a><a name="register-new-customers"></a>Registrare nuovi clienti
...
## <a name="adding-new-customers"></a><a name="adding-new-customers"></a>Aggiunta di nuovi clienti
...
### <a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a>Per creare una nuova scheda cliente
...
### <a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a>Per salvare la scheda cliente come modello
...
## <a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a>Eliminazione di schede cliente
...
## <a name="managing-credit-limits"></a><a name="managing-credit-limits"></a>Gestione dei limiti di credito
...
### <a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a>Per specificare gli avvisi sui limiti di credito
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/trade-master-data-dynamics-365-business-central/).
