...
## <a name="add-new-customers"></a>Aggiunta di nuovi clienti
...
## <a name="delete-customer-cards"></a>Eliminazione di schede cliente
...
## <a name="manage-credit-limits"></a>Gestione dei limiti di credito
