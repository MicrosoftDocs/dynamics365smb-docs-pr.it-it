...
ms.author: jswymer
---
# <a name="close-accounting-periods"></a><a name="close-accounting-periods"></a>Chiudere periodi contabili

Al termine di un anno fiscale, è necessario chiudere i periodi di cui è costituito.

## <a name="to-close-accounting-periods"></a><a name="to-close-accounting-periods"></a>Per chiudere periodi contabili
