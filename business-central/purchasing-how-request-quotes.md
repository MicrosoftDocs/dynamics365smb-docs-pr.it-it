...
ms.author: edupont
---
# <a name="request-quotes" />Richiedere le offerte
...
## <a name="create-a-purchase-quote" />Creare un'offerta di acquisto
...
## <a name="convert-a-purchase-quote-to-a-purchase-order" />Convertire un'offerta di acquisto in un ordine di acquisto
...
## <a name="see-related-microsoft-trainingtrainingmodulescreate-purchase-documents-dynamics--business-central" />Vedi il relativo [training Microsoft](/training/modules/create-purchase-documents-dynamics-365-business-central/).
