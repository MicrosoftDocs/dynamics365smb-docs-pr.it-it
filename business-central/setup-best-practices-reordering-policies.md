---
title: 'Impostare le procedure consigliate: riordino dei criteri | Microsoft Docs'
...
Una delle migliori basi per la selezione di un metodo di riordino è la classificazione ABC dell'articolo. Quando utilizzi la classificazione ABC, gestisci gli articoli in base a tre classi. La classe utilizzata dipende dal valore e dal volume dell'articolo rispetto allo stock totale. La tabella seguente mostra la distribuzione di valore-volume delle tre classi.
