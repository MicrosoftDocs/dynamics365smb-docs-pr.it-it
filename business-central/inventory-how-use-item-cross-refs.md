...
ms.author: edupont
---
# <a name="use-item-references" />Utilizzare i riferimenti dell'elemento
...
## <a name="to-start-using-item-references" />Per iniziare a usare i riferimenti agli elementi
...
## <a name="to-set-up-an-item-reference" />Per impostare un riferimento articolo
...
## <a name="to-enter-a-vendors-item-description-on-a-document" />Per immettere la descrizione articolo di un fornitore in un documento
