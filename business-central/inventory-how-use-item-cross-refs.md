...
ms.author: edupont
---
# <a name="use-item-references"></a><a name="use-item-references"></a><a name="use-item-references"></a>Utilizzare i riferimenti dell'elemento
...
## <a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a>Per iniziare a usare i riferimenti agli elementi
...
## <a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a>Per impostare un riferimento articolo
...
## <a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a>Per immettere la descrizione articolo di un fornitore in un documento
