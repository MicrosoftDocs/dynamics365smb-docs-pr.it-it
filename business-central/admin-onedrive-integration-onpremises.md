...
ms.author: jswymer
---
# <a name="configuring-onedrive-integration-with-business-central-on-premises" />Configurazione dell'integrazione di OneDrive con Business Central in locale
...
## <a name="set-up-the-onedrive-connection-in-version--and-later" />Impostare la connessione OneDrive nella versione 21 e successive
...
### <a name="run-onedrive-setup" />Eseguire Setup OneDrive
...
## <a name="set-up-the-connection-in-includeprodshortincludesprodshortmd-version--and-" />Impostare la connessione in [!INCLUDE[prod_short](includes/prod_short.md)] nella versione 19 e 20
...
## <a name="after-upgrade-to-version-" />Dopo l'aggiornamento alla versione 21
...
## <a name="switching-from-legacy-sharepoint-to-new-onedrive-integration" />Passaggio da SharePoint legacy alla nuova integrazione OneDrive
...
#### <a name="how-the-changes-affect-the-integration" />Come le modifiche influiscono sull'integrazione
...
### <a name="run-onedrive-setup-to-switch-to-the-new-onedrive-integration" />Eseguire il setup OneDrive per passare alla nuova integrazione OneDrive
