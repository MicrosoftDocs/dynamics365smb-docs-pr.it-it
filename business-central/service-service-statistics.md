...
# <a name="viewing-service-statistics"></a><a name="viewing-service-statistics"></a>Visualizzazione delle statistiche relative all'assistenza
...
## <a name="viewing-statistics-for-service-orders"></a><a name="viewing-statistics-for-service-orders"></a>Visualizzazione delle statistiche relative a ordini di assistenza
...
### <a name="view-totals-for-a-service-order"></a><a name="view-totals-for-a-service-order"></a>Visualizzare i totali per un ordine di assistenza
...
### <a name="view-shipping-information"></a><a name="view-shipping-information"></a>Visualizzare le informazioni di spedizione
...
### <a name="view-order-details"></a><a name="view-order-details"></a>Visualizzare i dettagli dell'ordine
...
### <a name="analyze-service-order-lines"></a><a name="analyze-service-order-lines"></a>Analizzare le righe dell'ordine di assistenza
...
### <a name="view-customer-information"></a><a name="view-customer-information"></a>Visualizzare le informazioni sui clienti
...
## <a name="viewing-service-item-statistics"></a><a name="viewing-service-item-statistics"></a>Visualizzazione delle statistiche relative agli articoli in assistenza
...
## <a name="use-trendscapes"></a><a name="use-trendscapes"></a>Utilizzare Trendscape
...
## <a name="viewing-gains-and-losses-on-contracts"></a><a name="viewing-gains-and-losses-on-contracts"></a>Visualizzazione di profitti e perdite nei contratti
...
## <a name="viewing-statistics-for-posted-service-documents"></a><a name="viewing-statistics-for-posted-service-documents"></a>Visualizzazione di statistiche per documenti di assistenza registrati
...
### <a name="posted-service-shipment-statistics"></a><a name="posted-service-shipment-statistics"></a>Statistiche relative alle spedizioni di assistenza registrate
...
### <a name="posted-service-invoice-statistics"></a><a name="posted-service-invoice-statistics"></a>Statistiche relative alle fatture di assistenza registrate
...
### <a name="posted-service-credit-memo-statistics"></a><a name="posted-service-credit-memo-statistics"></a>Statistiche relative alle note di credito di assistenza registrate
