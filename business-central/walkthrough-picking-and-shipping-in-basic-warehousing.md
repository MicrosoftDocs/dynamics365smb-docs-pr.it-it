...
---
# <a name="walkthrough-picking-and-shipping-in-basic-warehouse-configurations" />Procedura dettagliata: prelievo e spedizione nelle configurazioni della warehouse di base
...
### <a name="setting-up-the-bin-codes" />Impostazione dei codici collocazione

Una volta impostata la posizione, è necessario aggiungere due contenitori.

#### <a name="to-setup-the-bin-codes" />Per impostare i codici collocazione

1. Scegliere l'azione **Collocazioni**.
2. Crea due contenitori, con i codici *S-01-0001* e *S-01-0002*.

### <a name="making-yourself-a-warehouse-employee-at-location-south" />Diventare un impiegato warehouse presso l'ubicazione SUD

Per utilizzare questa funzionalità, devi aggiungerti all'ubicazione come lavoratore warehouse. 

#### <a name="to-make-yourself-a-warehouse-employee" />Per diventare un impiegato warehouse
...
## <a name="creating-the-sales-order" />Creazione dell'ordine di vendita
...
## <a name="picking-and-shipping-items" />Prelievo e spedizione articoli
...
### <a name="to-pick-and-ship-items" />Per prelevare gli articoli e procedere alla spedizione
