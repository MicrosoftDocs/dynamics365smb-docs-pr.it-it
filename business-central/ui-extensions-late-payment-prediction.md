...
ms.author: bholtorf
---
# <a name="the-late-payment-prediction-extension" />Estensione Previsione pagamento ritardato
...
## <a name="viewing-all-payment-predictions" />Visualizzare tutte le previsioni di pagamento
...
## <a name="viewing-a-payment-prediction-for-a-specific-sales-document" />Visualizzazione di una previsione di pagamento per un documento di vendita specifico
...
## <a name="design-details" />Dettagli di progettazione
...
### <a name="data-required-to-train-and-evaluate-the-model" />Dati obbligatori per il training e la valutazione del modello
...
### <a name="standard-model-and-my-model" />Modello standard e modello personale
...
#### <a name="to-train-and-use-your-model" />Per eseguire il training del modello ed utilizzarlo
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-late-payment-prediction" /><a name="AnchorText"> </a>Creare e utilizzare il proprio servizio Web predittivo per la previsione di pagamento ritardato
...
## <a name="see-related-microsoft-trainingtrainingmodulespredict-late-payments-sales-documents" />Vedi il relativo [training Microsoft](/training/modules/predict-late-payments-sales-documents/)
