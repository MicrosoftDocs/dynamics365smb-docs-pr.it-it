...
ms.author: edupont
---
# <a name="about-production-orders" />Informazioni sugli ordini di produzione
...
## <a name="production-order-creation" />Creazione di ordini di produzione
...
## <a name="limitations-on-production-order-creation" />Limiti sulla creazione degli ordini di produzione
...
## <a name="production-order-status" />Stato dell'ordine di produzione
...
### <a name="simulated-production-order" />Ordine di produzione simulato
...
### <a name="planned-production-order" />Ordine di produzione pianificato
...
### <a name="firm-planned-production-order" />Ordine di produzione confermato
...
### <a name="released-production-order" />Ordine di produzione rilasciato
...
### <a name="finished-production-order" />Ordine di produzione chiuso
...
## <a name="production-order-execution" />Esecuzione degli ordini di produzione
...
### <a name="material-consumption" />Consumo dei materiali
...
### <a name="production-output" />Output di produzione
...
### <a name="posting-consumption-and-output" />Registrazione di consumo e output
...
### <a name="production-journal" />Registrazioni di produzione
