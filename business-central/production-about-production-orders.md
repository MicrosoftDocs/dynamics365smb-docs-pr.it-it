...
## Limiti sulla creazione di ordini di produzione  
...
- Non influisce sulla pianificazione degli ordini. La pianificazione (MPS e MRP) non considera e non è influenzata dagli ordini di produzione simulati. Un ordine di produzione simulato, inoltre, non può essere utilizzato come modello, in quanto non è più disponibile quando se ne modifica lo stato.  
...
### Ordine di produzione pianificato confermato  
...
## Esecuzione di ordini di produzione  
