...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Impostare le definizioni di scambio dati
...
## <a name="create-a-data-exchange-definition" />Creare la definizione di scambio di dati
...
## <a name="transformation-rules" />Regole di trasformazione
...
### <a name="tip-for-developers-example-of-the-custom-option" />Suggerimento per gli sviluppatori: esempio dell'opzione Personalizzato
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />Esportare una definizione di scambio di dati come file XML per l'utilizzo da parte di altri utenti
...
## <a name="import-an-existing-data-exchange-definition" />Importare una definizione di scambio di dati esistente
