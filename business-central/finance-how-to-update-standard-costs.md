...
ms.author: edupont
---
# <a name="update-standard-costs"></a><a name="update-standard-costs"></a>Aggiornare i costi standard
...
## <a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a>Per aggiornare i costi standard
