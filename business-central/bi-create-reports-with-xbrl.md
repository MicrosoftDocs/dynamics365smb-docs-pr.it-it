...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Creare report con XBRL
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>Componenti di XBRL
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Livelli di tassonomie
...
## <a name="linkbases"></a><a name="linkbases"></a>Basi collegamento
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>Impostare righe XBRL
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Importare una tassonomia XBRL
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Aggiornare una tassonomia XBRL
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Vedi le informazioni relative al training in [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
