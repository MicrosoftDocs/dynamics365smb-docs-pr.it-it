...
## <a name="what-data-is-migrated" />Quali dati vengono migrati?

I seguenti dati vengono migrati per ogni entità:

### <a name="customers" />Clienti
...
### <a name="chart-of-accounts" />Piano dei conti
...
## <a name="file-size-requirements" />Requisiti per le dimensioni di file
...
## <a name="to-migrate-data" />Per migrare i dati
...
## <a name="viewing-the-status-of-the-migration" />Visualizzazione dello stato della migrazione
...
## <a name="how-to-avoid-double-posting" />Come evitare la doppia registrazione
...
## <a name="correcting-errors" />Correzione degli errori
...
## <a name="verifying-data-after-migrating" />Verifica dei dati dopo la migrazione
...
## <a name="stopping-data-migration" />Interruzione della migrazione dei dati
