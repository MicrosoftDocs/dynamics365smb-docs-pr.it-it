...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>Estensione di migrazione dati C5
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>Quali dati vengono migrati?

I seguenti dati vengono migrati per ogni entità:

### <a name="customers"></a><a name="customers"></a><a name="customers"></a>Clienti
...
### <a name="vendors"></a><a name="vendors"></a><a name="vendors"></a>Fornitori
...
### <a name="chart-of-accounts"></a><a name="chart-of-accounts"></a><a name="chart-of-accounts"></a>Piano dei conti
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a><a name="file-size-requirements"></a>Requisiti per le dimensioni di file
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a><a name="to-migrate-data"></a>Per migrare i dati
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Visualizzazione dello stato della migrazione
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>Come evitare la doppia registrazione
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a><a name="correcting-errors"></a>Correzione degli errori
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Verifica dei dati dopo la migrazione
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Interruzione della migrazione dei dati
