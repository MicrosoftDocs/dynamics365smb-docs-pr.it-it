...
ms.author: edupont
---
# <a name="collect-payments-with-sepa-direct-debit" />Riscuotere pagamenti con addebito diretto SEPA
...
## <a name="setting-up-sepa-direct-debit" />Impostare gli addebiti diretti SEPA
...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit" />Per impostare il conto bancario per l'addebito diretto SEPA
...
### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit" />Per impostare il metodo di pagamento del cliente per l'addebito diretto SEPA
...
#### <a name="to-set-up-the-direct-debit-mandate-that-represents-the-customer-agreement" />Per impostare il mandato di addebito diretto che rappresenta l'accordo con il cliente
...
## <a name="creating-sepa-direct-debit-collection-entries-and-export-to-a-bank-file" />Creare movimenti riscossione addebiti diretti SEPA ed esportarli in un file della banca
...
### <a name="to-create-a-direct-debit-collection" />Per creare una riscossione di addebiti diretti
...
### <a name="to-export-a-direct-debit-collection-entry-to-a-bank-file" />Per esportare un movimento riscossione di addebiti diretti in un file della banca
...
### <a name="to-reject-a-direct-debit-collection-entry" />Per rifiutare un movimento riscossione di addebiti diretti
...
### <a name="to-close-a-direct-debit-collection" />Per chiudere una riscossione di addebiti diretti
...
## <a name="posting-sepa-direct-debit-payment-receipts" />Registrare ricevute di pagamento di addebiti diretti SEPA
...
### <a name="to-post-a-direct-debit-payment-receipt-from-the-direct-debit-collections-page" />Per registrare una ricevuta di pagamento con addebito diretto dalla pagina Riscossioni di addebiti diretti
