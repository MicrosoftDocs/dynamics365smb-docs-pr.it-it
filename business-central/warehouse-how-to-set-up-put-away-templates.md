...
ms.author: edupont
---
# <a name="set-up-put-away-templates" />Impostare i modelli di stoccaggio
...
## <a name="to-set-up-put-away-templates" />Per impostare i modelli di stoccaggio
...
## <a name="see-related-microsoft-trainingtrainingmodulesput-away-templates" />Vedi il relativo [training Microsoft](/training/modules/put-away-templates/)
