...
ms.author: edupont
---
# <a name="print-the-picking-list" />Stampare la lista prelievo
...
## <a name="to-print-a-picking-list-from-a-sales-order" />Per stampare una lista prelievo da un ordine di vendita
