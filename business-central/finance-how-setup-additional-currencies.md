...
ms.author: edupont
---
# <a name="set-up-an-additional-reporting-currency"></a><a name="set-up-an-additional-reporting-currency"></a>Impostare una valuta contabile addizionale
...
## <a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a><a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a>Visualizzazione di report e importi nella valuta addizionale
...
## <a name="setting-up-an-additional-reporting-currency"></a><a name="setting-up-an-additional-reporting-currency"></a>Impostare una valuta contabile addizionale
...
### <a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments"></a><a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments"></a>Per specificare i conti C/G per la registrazione delle rettifiche tasso di cambio.
...
### <a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a><a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a>Per specificare il metodo della rettifica tasso di cambio per tutti i conti C/G
...
### <a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a><a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a>Per specificare il metodo di rettifica del tasso di cambio per i movimenti IVA
...
### <a name="to-activate-the-additional-reporting-currency"></a><a name="to-activate-the-additional-reporting-currency"></a>Per attivare la valuta contabile addizionale
