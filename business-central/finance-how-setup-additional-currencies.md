...
ms.author: edupont
---
# <a name="set-up-an-additional-reporting-currency" />Impostare una valuta contabile addizionale
...
## <a name="displaying-reports-and-amounts-in-the-additional-reporting-currency" />Visualizzazione di report e importi nella valuta addizionale
...
## <a name="adjusting-exchange-rates" />Rettifica di tassi di cambio
...
## <a name="setting-up-an-additional-reporting-currency" />Impostare una valuta contabile addizionale
...
### <a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments" />Per specificare i conti C/G per la registrazione delle rettifiche tasso di cambio.
...
### <a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts" />Per specificare il metodo della rettifica tasso di cambio per tutti i conti C/G
...
### <a name="to-specify-exchange-rate-adjustment-method-for-vat-entries" />Per specificare il metodo di rettifica del tasso di cambio per i movimenti IVA
...
### <a name="to-activate-the-additional-reporting-currency" />Per attivare la valuta contabile addizionale
