...
ms.author: edupont
---
# <a name="add-companies-to-your-company-hub"></a><a name="add-companies-to-your-company-hub"></a><a name="add-companies-to-your-company-hub"></a>Aggiungere società all'hub aziendale
...
## <a name="environment-links"></a><a name="environment-links"></a><a name="environment-links"></a>Collegamenti ambiente
...
## <a name="load-companies"></a><a name="load-companies"></a><a name="load-companies"></a>Caricare le società
