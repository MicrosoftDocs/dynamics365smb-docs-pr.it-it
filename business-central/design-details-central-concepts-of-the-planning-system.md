...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Dettagli di progettazione: Concetti centrali del sistema di pianificazione
...
## <a name="planning-parameters" />Parametri di pianificazione
...
## <a name="planning-starting-date" />Pianificazione della data di inizio
...
## <a name="dynamic-order-tracking-pegging" />Tracciabilità dinamica dell'ordine (pegging)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Tracciabilità dinamica dell'ordine rispetto al sistema di pianificazione
...
## <a name="sequence-and-priority-in-planning" />Sequenza e priorità nella pianificazione
...
### <a name="item-priority--low-level-code" />Priorità articolo / Codice ultimo livello
...
#### <a name="optimizing-performance-for-low-level-calculations" />Ottimizzazione delle prestazioni per calcoli del codice di ultimo livello
...
### <a name="locations--transfer-level-priority" />Ubicazioni/priorità a livello di trasferimento
...
### <a name="order-priority" />Priorità ordini
...
## <a name="demand-forecasts-and-blanket-orders" />Previsioni della domanda e ordini programmati
...
## <a name="planning-assignment" />Pianificazione assegnazione
...
## <a name="item-dimensions" />Dimensioni articolo
...
## <a name="item-attributes" />Attributi articolo
...
### <a name="specific-attributes" />Attributi specifici
...
### <a name="non-specific-attributes" />Attributi non specifici
...
## <a name="order-to-order-links" />Collegamenti ordine su ordine
...
## <a name="reservations" />Prenotazioni
...
## <a name="error-logs" />Registri errore
...
## <a name="planning-flexibility" />Flessibilità pianificazione
...
## <a name="order-planning" />Pianificazione ordini
...
## <a name="finite-loading" />Carico finito
