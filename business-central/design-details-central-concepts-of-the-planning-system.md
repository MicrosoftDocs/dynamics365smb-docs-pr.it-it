...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Dettagli di progettazione: Concetti centrali del sistema di pianificazione
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a>Parametri di pianificazione
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a>Pianificazione della data di inizio
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Tracciabilità dinamica dell'ordine (pegging)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Tracciabilità dinamica dell'ordine rispetto al sistema di pianificazione
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Sequenza e priorità nella pianificazione
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Priorità articolo / Codice ultimo livello
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Ottimizzazione delle prestazioni per calcoli del codice di ultimo livello
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Ubicazioni/priorità a livello di trasferimento
...
### <a name="order-priority"></a><a name="order-priority"></a>Priorità ordini
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Previsioni della domanda e ordini programmati
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a>Pianificazione assegnazione
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a>Dimensioni articolo
...
## <a name="item-attributes"></a><a name="item-attributes"></a>Attributi articolo
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a>Attributi specifici
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Attributi non specifici
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a>Collegamenti ordine su ordine
...
## <a name="reservations"></a><a name="reservations"></a>Prenotazioni
...
## <a name="warnings"></a><a name="warnings"></a>Avvisi
...
### <a name="emergency"></a><a name="emergency"></a>Emergenza
...
### <a name="exception"></a><a name="exception"></a>Eccezione
...
### <a name="attention"></a><a name="attention"></a>Attenzione
...
## <a name="error-logs"></a><a name="error-logs"></a>Registri errore
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a>Flessibilità pianificazione
...
## <a name="order-planning"></a><a name="order-planning"></a>Pianificazione ordini
...
## <a name="finite-loading"></a><a name="finite-loading"></a>Carico finito
