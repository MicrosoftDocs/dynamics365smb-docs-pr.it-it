...
5. Condividi le stampanti con gli utenti.
    ...
    > [!TIP]
    > Puoi sempre aggiungere o rimuovere gli utenti in un secondo momento. Per ulteriori informazioni, consulta la pagina  [Configurazione delle autorizzazioni utente per la stampante Condividi](/universal-print/reference/portal/share-printers#configure-user-permissions-for-a-printer-share).
...
6. Abilita la conversione dei documenti.
    ...
    Per ulteriori informazioni, consulta la [Panoramica sulla conversione dei documenti](/universal-print/reference/portal/settings#2-document-conversion).
