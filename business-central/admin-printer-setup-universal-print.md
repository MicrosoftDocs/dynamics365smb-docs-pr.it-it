...
# <a name="set-up-universal-print-printers" />Impostare le stampanti di Stampa universale
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure" />Configurazione di Stampa universale e delle stampanti in Microsoft Azure
...
## <a name="add-printers-in-business-central-online" />Aggiungere le stampanti in Business Central online
...
## <a name="add-printers-in-business-central-on-premises" />Aggiungere le stampanti in Business Central locale
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time" />Connessione a Stampa universale per la prima volta
...
## <a name="common-problems-and-resolutions" />Problemi comuni e soluzioni
...
### <a name="you-dont-have-access-to-the-printer-your-printer" />Non si dispone dell'accesso alla stampante \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you" />Errore durante il recupero delle stampanti condivise.
