...
ms.author: jswymer
---
# <a name="entering-data"></a><a name="entering-data"></a><a name="entering-data"></a>Immissione di dati
...
## <a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a>Utilizzare i campi modificabili
...
### <a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a>Modifica di un valore di campo
...
## <a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a>Tasti di scelta rapida
...
## <a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="QuickEntry"></a>Accelerazione dell'immissione di dati utilizzando Accesso rapido
...
### <a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a>Funzionamento di Accesso rapido
...
#### <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="tips-and-tricks"></a>Suggerimenti e trucchi
...
### <a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a>Come modificare i campi Accesso rapido
...
## <a name="mandatory-fields"></a><a name="mandatory-fields"></a><a name="mandatory-fields"></a>Campi obbligatori
...
## <a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a>Trovare dati durante la digitazione
...
## <a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a>Copiare e incollare campi e righe
...
## <a name="filtering-line-items"></a><a name="filtering-line-items"></a><a name="filtering-line-items"></a>Filtri delle voci
...
## <a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="Focus"></a>Spostamento dello stato attivo sulle voci
...
### <a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a>Attivare/disattivare lo stato attivo
...
## <a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a>Multitasking in più pagine
...
## <a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a>Immettere quantità mediante calcolo
...
## <a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a>Immettere numeri negativi
...
## <a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a>Immissione di date e ore
...
### <a name="entering-dates"></a><a name="entering-dates"></a><a name="entering-dates"></a>Immissione di date
...
## <a name="entering-times"></a><a name="entering-times"></a><a name="entering-times"></a>Immissione di ore
...
## <a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a>Immissione di date e ore combinate

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration"></a><a name="entering-duration"></a><a name="entering-duration"></a>Immissione della durata
...
## <a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="decimal"></a>Impostazione del separatore decimale usato dalle tastiere numeriche
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/explore-modify-info-dynamics-365-business-central/)
