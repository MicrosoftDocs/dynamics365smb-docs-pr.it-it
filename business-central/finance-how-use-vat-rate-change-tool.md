...
# <a name="managing-vat-rate-changes" />Gestione delle variazioni dell'aliquota IVA
...
## <a name="changing-vat-rates" />Modifica delle aliquote IVA
...
## <a name="the-vat-rate-change-tool" />Strumento di modifica dell'aliquota IVA
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations" />Informazioni sulle limitazioni e sul processo di conversione dell'aliquota IVA
...
### <a name="to-prepare-vat-rate-change-conversions" />Per preparare conversioni di modifica dell'aliquota IVA
...
### <a name="to-set-up-the-vat-rate-change-tool" />Per impostare lo strumento di modifica dell'aliquota IVA
...
### <a name="to-set-up-product-posting-group-conversion" />Per impostare la conversione delle categorie di registrazione prodotti
...
### <a name="to-perform-vat-rate-change-conversion" />Per eseguire la conversione della modifica dell'aliquota IVA
...
## <a name="see-related-microsoft-trainingtrainingmodulesrate-change-dynamics--business-central" />Vedi il relativo [training Microsoft](/training/modules/rate-change-dynamics-365-business-central/)
