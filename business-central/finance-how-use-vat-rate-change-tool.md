...
# <a name="managing-vat-rate-changes"></a><a name="managing-vat-rate-changes"></a><a name="managing-vat-rate-changes"></a>Gestione delle variazioni dell'aliquota IVA
...
## <a name="changing-vat-rates"></a><a name="changing-vat-rates"></a><a name="changing-vat-rates"></a>Modifica delle aliquote IVA
...
## <a name="the-vat-rate-change-tool"></a><a name="the-vat-rate-change-tool"></a><a name="the-vat-rate-change-tool"></a>Strumento di modifica dell'aliquota IVA
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations"></a><a name="understanding-the-vat-rate-conversion-process-and-limitations"></a><a name="understanding-the-vat-rate-conversion-process-and-limitations"></a>Informazioni sulle limitazioni e sul processo di conversione dell'aliquota IVA
...
### <a name="to-prepare-vat-rate-change-conversions"></a><a name="to-prepare-vat-rate-change-conversions"></a><a name="to-prepare-vat-rate-change-conversions"></a>Per preparare conversioni di modifica dell'aliquota IVA
...
### <a name="to-set-up-the-vat-rate-change-tool"></a><a name="to-set-up-the-vat-rate-change-tool"></a><a name="to-set-up-the-vat-rate-change-tool"></a>Per impostare lo strumento di modifica dell'aliquota IVA
...
### <a name="to-set-up-product-posting-group-conversion"></a><a name="to-set-up-product-posting-group-conversion"></a><a name="to-set-up-product-posting-group-conversion"></a>Per impostare la conversione delle categorie di registrazione prodotti
...
### <a name="to-perform-vat-rate-change-conversion"></a><a name="to-perform-vat-rate-change-conversion"></a><a name="to-perform-vat-rate-change-conversion"></a>Per eseguire la conversione della modifica dell'aliquota IVA
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/rate-change-dynamics-365-business-central/)
