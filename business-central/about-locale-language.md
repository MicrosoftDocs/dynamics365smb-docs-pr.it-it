...
ms.author: edupont
---
# <a name="changing-language-and-region" />Modifica di lingua e area geografica
...
## <a name="changing-your-region-setting" />Cambiare l'impostazione della regione
...
## <a name="changing-the-region-setting-for-customers-contacts-and-vendors" />Cambiare l'impostazione della regione per clienti, contatti e fornitori
...
## <a name="application-version" />Versione applicazione
...
### <a name="how-do-i-change-the-language-of-the-microsoft-learn-site" />Come cambio la lingua del sito di Microsoft Learn?
