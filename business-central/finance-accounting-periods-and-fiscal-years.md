...
ms.author: bholtorf
---
# <a name="work-with-accounting-periods-and-fiscal-years" />Utilizzare periodi contabili e anni fiscali
...
## <a name="creating-a-new-fiscal-year" />Creazione di un nuovo anno fiscale

Puoi creare periodi contabili in blocco manualmente o utilizzando il processo batch **Crea anno fiscale**.

### <a name="how-to-create-accounting-periods-in-bulk" />Creazione di periodi contabili in blocco
...
### <a name="how-to-create-accounting-periods-manually" />Creazione manuale di periodi contabili
...
## <a name="closing-a-fiscal-year" />Chiusura di un anno fiscale
...
## <a name="posting-entries-to-a-closed-fiscal-year" />Registrazione di movimenti in un anno fiscale chiuso
