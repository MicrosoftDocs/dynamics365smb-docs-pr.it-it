...
ms.author: edupont
---
# <a name="setting-up-purchasing"></a><a name="setting-up-purchasing"></a>Impostazioni acquisti
...
## <a name="purchases-and-payables-setup"></a><a name="purchases-and-payables-setup"></a>Setup contabilità fornitori
...
### <a name="general-settings"></a><a name="general-settings"></a>Impostazioni generali
...
### <a name="number-series-settings"></a><a name="number-series-settings"></a>Impostazioni delle numerazioni
...
## <a name="exact-cost-reversing"></a><a name="exact-cost-reversing"></a>Storno esatto costo
...
## <a name="more-purchasing-setups"></a><a name="more-purchasing-setups"></a>Altre impostazioni di acquisto
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Vedi le informazioni relative al training in [Microsoft Learn](/learn/paths/trade-get-started-dynamics-365-business-central/).
