...
ms.author: edupont
---
# <a name="enable-application-of-ledger-entries-in-different-currencies" />Abilitare il collegamento dei movimenti contabili fornitore in valute diverse
...
## <a name="to-enable-application-of-vendor-ledger-entries-in-different-currencies" />Per abilitare il collegamento dei movimenti contabili fornitore in valute diverse
...
## <a name="to-set-up-gl-accounts-for-currency-application-rounding-differences" />Per impostare i conti C/G per le differenze di arrotondamento di applicazione delle valute
...
## <a name="see-related-microsoft-trainingtrainingmodulesprocess-foreign-currency-payments-dynamics--business-central" />Vedi il relativo [training Microsoft](/training/modules/process-foreign-currency-payments-dynamics-365-business-central/)
