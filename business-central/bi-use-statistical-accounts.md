...
---
# <a name="analyze-data-with-statistical-accounts"></a><a name="analyze-data-with-statistical-accounts"></a>Analizzare i dati con i conti statistici
...
## <a name="set-up-a-statistical-account"></a><a name="set-up-a-statistical-account"></a>Impostare un conto statistico
...
## <a name="post-amounts-to-a-statistical-account"></a><a name="post-amounts-to-a-statistical-account"></a>Registrare gli importi in un conto statistico
...
## <a name="verify-statistical-account-amounts"></a><a name="verify-statistical-account-amounts"></a>Verificare gli importi in un conto statistico
...
## <a name="include-the-statistical-account-in-a-financial-report"></a><a name="include-the-statistical-account-in-a-financial-report"></a>Includere il conto statistico in un report finanziario
