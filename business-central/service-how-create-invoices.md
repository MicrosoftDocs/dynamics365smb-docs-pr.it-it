...
ms.author: bholtorf
---
# <a name="create-service-invoices-or-credit-memos" />Creare fatture o note di credito di assistenza
...
## <a name="to-invoice-several-service-contracts" />Per fatturare più contratti di assistenza
...
## <a name="to-invoice-a-service-contract-from-the-service-contract-page" />Per fatturare un contratto di assistenza dalla pagina Contratto assistenza
...
## <a name="to-post-an-invoice-from-a-service-order" />Per registrare una fattura da un ordine di assistenza
...
## <a name="to-create-a-service-invoice-manually" />Per creare una fattura di assistenza manualmente
...
## <a name="to-create-an-invoice-that-combines-posted-shipment-lines-from-one-or-more-service-orders" />Per creare una fattura che combina le righe di spedizione registrate da uno o più ordini di assistenza
...
## <a name="to-create-a-service-credit-memo" />Per creare una nota di credito di assistenza
