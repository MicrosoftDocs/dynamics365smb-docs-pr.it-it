...
---
# <a name="the-service-declaration-extension"></a><a name="the-service-declaration-extension"></a><a name="the-service-declaration-extension"></a>L'estensione Dichiarazione di servizio
...
## <a name="enable-the-service-declaration-extension"></a><a name="enable-the-service-declaration-extension"></a><a name="enable-the-service-declaration-extension"></a>Abilitare l'estensione Dichiarazione di servizio
...
## <a name="set-up-the-service-declaration-extension"></a><a name="set-up-the-service-declaration-extension"></a><a name="set-up-the-service-declaration-extension"></a>Configurare l'estensione Dichiarazione di servizio

È possibile impostare l'estensione manualmente o utilizzando un file di report in Definizioni di scambio dati.

### <a name="to-set-up-service-declaration-manually"></a><a name="to-set-up-service-declaration-manually"></a><a name="to-set-up-service-declaration-manually"></a>Per configurare Dichiarazione di servizio manualmente
...
### <a name="set-up-a-reporting-file"></a><a name="set-up-a-reporting-file"></a><a name="set-up-a-reporting-file"></a>Impostare un file di report
...
### <a name="items"></a><a name="items"></a><a name="items"></a>Articoli
...
### <a name="resources"></a><a name="resources"></a><a name="resources"></a>Risorse
...
### <a name="item-charges"></a><a name="item-charges"></a><a name="item-charges"></a>Addebiti articoli
...
## <a name="create-new-service-declaration"></a><a name="create-new-service-declaration"></a><a name="create-new-service-declaration"></a>Creare una nuova dichiarazione di servizio
...
## <a name="modify-a-service-declaration"></a><a name="modify-a-service-declaration"></a><a name="modify-a-service-declaration"></a>Modifica una dichiarazione di servizio
...
## <a name="overview-the-service-declaration-lines"></a><a name="overview-the-service-declaration-lines"></a><a name="overview-the-service-declaration-lines"></a>Panoramica delle righe della dichiarazione di servizio
...
## <a name="report-service-declaration-in-a-file"></a><a name="report-service-declaration-in-a-file"></a><a name="report-service-declaration-in-a-file"></a>Indica la dichiarazione di servizio in un file
...
## <a name="other-considerations"></a><a name="other-considerations"></a><a name="other-considerations"></a>Altre considerazioni
...
### <a name="grouping-lines"></a><a name="grouping-lines"></a><a name="grouping-lines"></a>Raggruppamento di righe
...
### <a name="using-services-in-document-lines"></a><a name="using-services-in-document-lines"></a><a name="using-services-in-document-lines"></a>Utilizzo dei servizi nelle righe del documento
