...
---
# <a name="the-service-declaration-extension" />L'estensione Dichiarazione di servizio
...
## <a name="enable-the-service-declaration-extension" />Abilitare l'estensione Dichiarazione di servizio
...
## <a name="set-up-the-service-declaration-extension" />Configurare l'estensione Dichiarazione di servizio

È possibile impostare l'estensione manualmente o utilizzando un file di report in Definizioni di scambio dati.

### <a name="to-set-up-service-declaration-manually" />Per configurare Dichiarazione di servizio manualmente
...
### <a name="set-up-a-reporting-file" />Impostare un file di report
...
### <a name="item-charges" />Addebiti articoli
...
## <a name="create-new-service-declaration" />Creare una nuova dichiarazione di servizio
...
## <a name="modify-a-service-declaration" />Modifica una dichiarazione di servizio
...
## <a name="overview-the-service-declaration-lines" />Panoramica delle righe della dichiarazione di servizio
...
## <a name="report-service-declaration-in-a-file" />Indica la dichiarazione di servizio in un file
...
## <a name="other-considerations" />Altre considerazioni
...
### <a name="grouping-lines" />Raggruppamento di righe
...
### <a name="using-services-in-document-lines" />Utilizzo dei servizi nelle righe del documento
