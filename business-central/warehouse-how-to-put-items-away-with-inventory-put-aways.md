...
---
# <a name="put-items-away-with-inventory-put-aways" />Eseguire lo stoccaggio con Stoccaggi Magazzino
...
## <a name="to-create-an-inventory-put-away-from-the-source-document" />Per creare uno stoccaggio magazzino dal documento origine
...
## <a name="to-create-multiple-inventory-put-aways-with-a-batch-job" />Per creare più stoccaggi in magazzino utilizzando un processo batch
...
## <a name="to-create-the-put-away-in-two-steps" />Per creare lo stoccaggio in due passaggi

### <a name="to-request-an-inventory-put-away-by-releasing-the-source-document" />Per richiedere uno stoccaggio magazzino emettendo il documento di origine
...
### <a name="to-create-an-inventory-put-away-based-on-the-source-document" />Per creare uno stoccaggio in magazzino in base al documento origine
...
## <a name="to-record-the-inventory-put-away" />Per registrare lo stoccaggio magazzino
