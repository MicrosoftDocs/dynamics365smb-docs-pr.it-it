...
ms.author: jswymer
---
# <a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a>Utilizzare le app [!INCLUDE [prod_short](includes/prod_short.md)] in Power BI
...
## <a name="get-ready"></a><a name="get-ready"></a><a name="get-ready"></a>Preparazione
...
## <a name="install-a--app-in-power-bi"></a><a name="install-a--app-in-power-bi"></a><a name="install-a--app-in-power-bi"></a>Installare un'app [!INCLUDE[prod_short](includes/prod_short.md)] in Power BI
...
## <a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a>Connettere l'app [!INCLUDE[prod_short](includes/prod_short.md)] ai dati
...
## <a name="fixing-problems"></a><a name="fixing-problems"></a><a name="fixing-problems"></a>Risolvere i problemi
...
### <a name="you-dont-have-a-power-bi-account"></a><a name="you-dont-have-a-power-bi-account"></a><a name="you-dont-have-a-power-bi-account"></a>Non si dispone di un account Power BI
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Messaggio: Non sono presenti report abilitati. Scegliere Seleziona report per visualizzare un elenco di report che è possibile visualizzare.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a>È necessaria una licenza Power BI Pro per installare l'app [!INCLUDE[prod_short](includes/prod_short.md)] in Power BI
...
### <a name="cant-sign-in"></a><a name="cant-sign-in"></a><a name="cant-sign-in"></a>Impossibile accedere
...
### <a name="incorrect-company-name"></a><a name="incorrect-company-name"></a><a name="incorrect-company-name"></a>Nome della società non corretto
...
### <a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a>Nessuna riga corrispondente alla chiave nella tabella
...
### <a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a>Dati storici mancanti
...
### <a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a>Visualizzazione unicamente dei dati di una singola società
...
### <a name="what-now"></a><a name="what-now"></a><a name="what-now"></a>Operazioni successive
