...
ms.author: edupont
---
# <a name="manage-budgets-for-fixed-assets" />Gestione dei budget per i cespiti
...
## <a name="to-budget-the-acquisition-cost-of-a-fixed-asset" />Per prevedere i costi di acquisto di un cespite
...
## <a name="to-budget-the-disposal-of-a-fixed-asset" />Per prevedere la cessione di un cespite
...
## <a name="to-view-projected-disposal-values" />Per visualizzare i valori di cessione previsti
...
## <a name="to-budget-depreciation" />Per prevedere l'ammortamento
