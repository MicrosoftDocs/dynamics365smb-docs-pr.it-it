...
ms.author: jswymer
---
# <a name="process-sales-opportunities" />Elaborare le opportunità di vendita
...
## <a name="to-view-opportunities" />Per visualizzare le opportunità
...
## <a name="to-close-opportunities" />Per chiudere le opportunità
...
## <a name="to-create-quotes-for-opportunities" />Per creare offerte per opportunità
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities" />Per creare ordini di vendita per opportunità
...
## <a name="to-delete-opportunities" />Per rimuovere opportunità
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages" />Per spostare un'opportunità nelle fasi ciclo di vendita
