...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a><a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a>Data di registrazione nella registrazione del valore di aggiustamento rispetto alla registrazione di origine
...
## <a name="revaluation-scenario"></a><a name="revaluation-scenario"></a>Scenario di rivalutazione
...
### <a name="to-test-the-scenario"></a><a name="to-test-the-scenario"></a>Per verificare lo scenario:
...
### <a name="conclusion"></a><a name="conclusion"></a>Conclusione
...
## <a name="item-charge-scenario"></a><a name="item-charge-scenario"></a>Scenario di addebito dell'articolo
...
### <a name="to-test-the-scenario-1"></a><a name="to-test-the-scenario-1"></a>Per testare lo scenario
