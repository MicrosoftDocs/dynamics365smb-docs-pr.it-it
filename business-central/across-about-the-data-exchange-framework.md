...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework"></a><a name="about-the-data-exchange-framework"></a><a name="about-the-data-exchange-framework"></a>Informazioni sul framework di scambio dei dati
...
## <a name="electronic-documents"></a><a name="electronic-documents"></a><a name="electronic-documents"></a>Documenti elettronici
...
## <a name="bank-files"></a><a name="bank-files"></a><a name="bank-files"></a>File della banca
...
## <a name="currency-exchange-rates"></a><a name="currency-exchange-rates"></a><a name="currency-exchange-rates"></a>Tassi di cambio valuta
