...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework" />Informazioni sul framework di scambio dei dati
...
## <a name="electronic-documents" />Documenti elettronici
...
## <a name="bank-files" />File della banca
...
## <a name="currency-exchange-rates" />Tassi di cambio valuta
