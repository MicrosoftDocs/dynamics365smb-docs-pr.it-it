...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions"></a><a name="use-xml-schemas-to-prepare-data-exchange-definitions"></a>Utilizzare gli schemi XML per preparare le definizioni di scambio dati
...
## <a name="to-load-an-xml-schema-file"></a><a name="to-load-an-xml-schema-file"></a>Per caricare un file di schema XML
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema"></a><a name="to-select-or-clear-nodes-in-an-xml-schema"></a>Per selezionare o rimuovere i nodi in uno schema XML
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema"></a><a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema"></a>Per generare una definizione di scambio di dati basata su uno schema XML
