...
# <a name="business-central-access-with-microsoft-365-licenses"></a><a name="business-central-access-with-microsoft-365-licenses"></a><a name="business-central-access-with-microsoft-365-licenses"></a>Accesso a Business Central con licenze Microsoft 365
...
## <a name="why-enable-access-with-microsoft-365-licenses"></a><a name="why-enable-access-with-microsoft-365-licenses"></a><a name="why-enable-access-with-microsoft-365-licenses"></a>Perché abilitare l'accesso con le licenze Microsoft 365
...
## <a name="use-rights"></a><a name="use-rights"></a><a name="use-rights"></a>Diritti di utilizzo
...
 
### <a name="client-access"></a><a name="client-access"></a><a name="client-access"></a>Accesso client
...
### <a name="data-access"></a><a name="data-access"></a><a name="data-access"></a>Accesso ai dati
...
### <a name="use-of-objects"></a><a name="use-of-objects"></a><a name="use-of-objects"></a>Uso di oggetti
...
## <a name="simplified-user-interface"></a><a name="simplified-user-interface"></a><a name="simplified-user-interface"></a>Interfaccia utente semplificata
...
### <a name="requirements-to-enable-access"></a><a name="requirements-to-enable-access"></a><a name="requirements-to-enable-access"></a>Requisiti per abilitare l'accesso
...
### <a name="requirements-for-individual-users-to-access-data-in-teams"></a><a name="requirements-for-individual-users-to-access-data-in-teams"></a><a name="requirements-for-individual-users-to-access-data-in-teams"></a>Requisiti per i singoli utenti per accedere ai dati in Teams
