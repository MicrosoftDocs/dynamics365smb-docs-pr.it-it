...
# <a name="business-central-access-with-microsoft-365-licenses" />Accesso a Business Central con licenze Microsoft 365
...
## <a name="why-enable-access-with-microsoft-365-licenses" />Perché abilitare l'accesso con le licenze Microsoft 365
...
## <a name="use-rights" />Diritti di utilizzo
...
 
### <a name="client-access" />Accesso client
...
### <a name="data-access" />Accesso ai dati
...
### <a name="use-of-objects" />Uso di oggetti
...
## <a name="simplified-user-interface" />Interfaccia utente semplificata
...
### <a name="requirements-to-enable-access" />Requisiti per abilitare l'accesso
...
### <a name="requirements-for-individual-users-to-access-data-in-teams" />Requisiti per i singoli utenti per accedere ai dati in Teams
