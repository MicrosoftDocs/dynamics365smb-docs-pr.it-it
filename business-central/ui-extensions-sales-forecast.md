...
# <a name="the-sales-and-inventory-forecast-extension" />Estensione Previsione vendite e magazzino
...
## <a name="setting-up-forecasting" />Impostazione delle previsioni
...
## <a name="use-the-forecasts" />Usare le previsioni
...
### <a name="data-required-for-forecast" />Dati richiesti per la previsione
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Creare e utilizzare il proprio servizio Web predittivo per le previsioni di magazzino e vendite
