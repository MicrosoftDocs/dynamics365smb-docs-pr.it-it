...
# <a name="the-sales-and-inventory-forecast-extension"></a><a name="the-sales-and-inventory-forecast-extension"></a>Estensione Previsione vendite e magazzino
...
## <a name="setting-up-forecasting"></a><a name="setting-up-forecasting"></a>Impostazione delle previsioni
...
## <a name="use-the-forecasts"></a><a name="use-the-forecasts"></a>Usare le previsioni
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/use-sales-inventory-forecast-extension/)
