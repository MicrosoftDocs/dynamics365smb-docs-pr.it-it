...
# <a name="searching-for-customers-vendors-and-other-contacts-from-microsoft-teams" />Ricerca di clienti, fornitori e altri contatti da Microsoft Teams
...
## <a name="look-up-contacts-from-the-command-box" />Cerca i contatti dalla casella di comando
...
## <a name="look-up-contacts-from-the-message-compose-box" />Cerca i contatti dalla casella di composizione del messaggio
...
### <a name="heres-another-way" />Ecco un altro modo
...
## <a name="viewing-contact-card-details" />Visualizzazione dei dettagli della scheda del contatto
