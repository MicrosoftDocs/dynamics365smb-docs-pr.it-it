...
ms.author: edupont
---
# <a name="make-sales-quotes"></a><a name="make-sales-quotes"></a>Creare offerte di vendita
...
## <a name="to-create-a-sales-quote"></a><a name="to-create-a-sales-quote"></a>Per creare un'offerta di vendita
