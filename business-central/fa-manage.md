...
ms.author: edupont
---
# <a name="managing-fixed-assets"></a><a name="managing-fixed-assets"></a>Gestione dei cespiti
...
## <a name="video-overview"></a><a name="video-overview"></a>Video di panoramica

Il video seguente illustra le nozioni di base dei cespiti.

> [!Video https://www.microsoft.com/en-us/videoplayer/embed/RE4AegS?rel=0]

## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/paths/manage-fixed-assets-transactions/)
