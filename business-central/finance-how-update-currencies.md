...
4. Mappare i campi dal file XML alla tabella dei tassi di cambio nel campo di origine.
5. Applica tutte le regole di trasformazione necessarie.
6. Attivare il pulsante **Abilitato** per attivare per abilitare il servizio.
...
[Imposta valute](finance-set-up-currencies.md)    
[Imposta una valuta di reporting aggiuntiva](finance-how-setup-additional-currencies.md)    
