...
ms.author: edupont
---
# <a name="use-item-charges-to-account-for-additional-trade-costs"></a><a name="use-item-charges-to-account-for-additional-trade-costs"></a><a name="use-item-charges-to-account-for-additional-trade-costs"></a>Utilizzare gli addebiti articolo al conto per i costi aggiuntivi commerciali
...
## <a name="to-set-up-item-charge-numbers"></a><a name="to-set-up-item-charge-numbers"></a><a name="to-set-up-item-charge-numbers"></a>Per impostare i numeri di addebito articolo
...
## <a name="handle-item-charges-for-partial-receipts"></a><a name="handle-item-charges-for-partial-receipts"></a><a name="handle-item-charges-for-partial-receipts"></a>Gestire gli addebiti articolo per le ricevute parziali
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/post-purchase-item-charges-dynamics-365-business-central/)
