...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central"></a><a name="sharing-business-data-from-business-central"></a>Condivisione dei dati aziendali da Business Central
...
## <a name="copying-a-link"></a><a name="copying-a-link"></a>Copia di un collegamento
...
### <a name="modify-the-page-link"></a><a name="modify-the-page-link"></a>Modificare il collegamento alla pagina
...
### <a name="about-filtered-lists"></a><a name="about-filtered-lists"></a>Informazioni sugli elenchi filtrati
...
## <a name="sharing-to-teams"></a><a name="sharing-to-teams"></a>Condivisione in Teams
...
## <a name="sharing-through-onedrive"></a><a name="sharing-through-onedrive"></a>Condivisione tramite OneDrive
...
## <a name="opening-in-excel"></a><a name="opening-in-excel"></a>Apertura in Excel
...
## <a name="sharing-rows-or-tables"></a><a name="sharing-rows-or-tables"></a>Condivisione di righe o tabelle
